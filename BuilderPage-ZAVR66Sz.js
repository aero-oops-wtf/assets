...
`,Ja=`# Aero HTML Slides Style Guide
...
`,el=`# aero-ai: calling Gemini from inside an aero page
...
})();<\/script>`;function so(e,t){const n=al+il+sl+(t!=null&&t.screenshot?ll:"")+cl,r=e.match(/<head[^>]*>/i);if(!r)return n+e;const o=r.index+r[0].length;return e.slice(0,o)+n+e.slice(o)}var ul=Object.defineProperty,Xn=(e,t)=>ul(e,"name",{value:t,configurable:!0});function _n(e,t){if(typeof e=="function")return e(t);e!=null&&(e.current=t)}Xn(_n,"setRef");function jo(...e){return t=>{let n=!1;const r=e.map(o=>{const i=_n(o,t);return!n&&typeof i=="function"&&(n=!0),i});if(n)return()=>{for(let o=0;o<r.length;o++){const i=r[o];typeof i=="function"?i():_n(e[o],null)}}}}Xn(jo,"composeRefs");function q(...e){return s.useCallback(jo(...e),e)}Xn(q,"useComposedRefs");var dl=Object.defineProperty,me=(e,t)=>dl(e,"name",{value:t,configurable:!0});function fl(e,t){const n=s.createContext(t);n.displayName=e+"Context";const r=me(i=>{const{children:l,...c}=i,u=s.useMemo(()=>c,Object.values(c));return a.jsx(n.Provider,{value:u,children:l})},"Provider");r.displayName=e+"Provider";function o(i,l={}){const{optional:c=!1}=l,u=s.useContext(n);if(u)return u;if(t!==void 0)return t;if(!c)throw new Error(`\`${i}\` must be used within \`${e}\``)}return me(o,"useContext"),[r,o]}me(fl,"createContext");function _e(e,t=[]){let n=[];function r(i,l){const c=s.createContext(l);c.displayName=i+"Context";const u=n.length;n=[...n,l];const f=me(h=>{var S;const{scope:p,children:v,...m}=h,b=((S=p==null?void 0:p[e])==null?void 0:S[u])||c,w=s.useMemo(()=>m,Object.values(m));return a.jsx(b.Provider,{value:w,children:v})},"Provider");f.displayName=i+"Provider";function g(h,p,v={}){var S;const{optional:m=!1}=v,b=((S=p==null?void 0:p[e])==null?void 0:S[u])||c,w=s.useContext(b);if(w)return w;if(l!==void 0)return l;if(!m)throw new Error(`\`${h}\` must be used within \`${i}\``)}return me(g,"useContext"),[f,g]}me(r,"createContext");const o=me(()=>{const i=n.map(l=>s.createContext(l));return me(function(c){const u=(c==null?void 0:c[e])||i;return s.useMemo(()=>({[`__scope${e}`]:{...c,[e]:u}}),[c,u])},"useScope")},"createScope");return o.scopeName=e,[r,No(o,...t)]}me(_e,"createContextScope");function No(...e){const t=e[0];if(e.length===1)return t;const n=me(()=>{const r=e.map(o=>({useScope:o(),scopeName:o.scopeName}));return me(function(i){const l=r.reduce((c,{useScope:u,scopeName:f})=>{const h=u(i)[`__scope${f}`];return{...c,...h}},{});return s.useMemo(()=>({[`__scope${t.scopeName}`]:l}),[l])},"useComposedScopes")},"createScope");return n.scopeName=t.scopeName,n}me(No,"composeContextScopes");var hl=globalThis!=null&&globalThis.document?s.useLayoutEffect:()=>{},pl=globalThis!=null&&globalThis.document?s.useLayoutEffect:()=>{},ml=Object.defineProperty,gl=(e,t)=>ml(e,"name",{value:t,configurable:!0}),ao=qe[" useEffectEvent ".trim().toString()],lo=qe[" useInsertionEffect ".trim().toString()];function Do(e){if(typeof ao=="function")return ao(e);const t=s.useRef(()=>{throw new Error("Cannot call an event handler while rendering.")});return typeof lo=="function"?lo(()=>{t.current=e}):pl(()=>{t.current=e}),s.useMemo(()=>((...n)=>{var r;return(r=t.current)==null?void 0:r.call(t,...n)}),[])}gl(Do,"useEffectEvent");var vl=Object.defineProperty,Nt=(e,t)=>vl(e,"name",{value:t,configurable:!0}),bl=qe[" useInsertionEffect ".trim().toString()]||hl;function Qn({prop:e,defaultProp:t,onChange:n=Nt(()=>{},"onChange"),caller:r}){const[o,i,l]=_o({defaultProp:t,onChange:n}),c=e!==void 0,u=c?e:o,f=s.useCallback(g=>{var h;if(c){const p=Lo(g)?g(e):g;p!==e&&((h=l.current)==null||h.call(l,p))}else i(g)},[c,e,i,l]);return[u,f]}Nt(Qn,"useControllableState");function _o({defaultProp:e,onChange:t}){const[n,r]=s.useState(e),o=s.useRef(n),i=s.useRef(t);return bl(()=>{i.current=t},[t]),s.useEffect(()=>{var l;o.current!==n&&((l=i.current)==null||l.call(i,n),o.current=n)},[n,o]),[n,r,i]}Nt(_o,"useUncontrolledState");function Lo(e){return typeof e=="function"}Nt(Lo,"isFunction");var co=Symbol("RADIX:SYNC_STATE");function yl(e,t,n,r){const{prop:o,defaultProp:i,onChange:l,caller:c}=t,u=o!==void 0,f=Do(l),g=[{...n,state:i}];r&&g.push(r);const[h,p]=s.useReducer((w,S)=>{if(S.type===co)return{...w,state:S.state};const y=e(w,S);return u&&!Object.is(y.state,w.state)&&f(y.state),y},...g),v=h.state,m=s.useRef(v);s.useEffect(()=>{m.current!==v&&(m.current=v,u||f(v))},[v,m,u]);const b=s.useMemo(()=>o!==void 0?{...h,state:o}:h,[h,o]);return s.useEffect(()=>{u&&!Object.is(o,h.state)&&p({type:co,state:o})},[o,h.state,u]),[b,p]}Nt(yl,"useControllableStateReducer");var wl=Object.defineProperty,be=(e,t)=>wl(e,"name",{value:t,configurable:!0});function Oo(e){const t=s.forwardRef((n,r)=>{let{children:o,...i}=n,l=null,c=!1;const u=[];Ln(o)&&typeof Kt=="function"&&(o=Kt(o._payload)),s.Children.forEach(o,p=>{var v;if(Uo(p)){c=!0;const m=p;let b="child"in m.props?m.props.child:m.props.children;Ln(b)&&typeof Kt=="function"&&(b=Kt(b._payload)),l=kl(m,b),u.push((v=l==null?void 0:l.props)==null?void 0:v.children)}else u.push(p)}),l?l=s.cloneElement(l,void 0,u):!c&&s.Children.count(o)===1&&s.isValidElement(o)&&(l=o);const f=l?Bo(l):void 0,g=q(r,f);if(!l){if(o||o===0)throw new Error(c?El(e):Cl(e));return o}const h=$o(i,l.props??{});return l.type!==s.Fragment&&(h.ref=r?g:f),s.cloneElement(l,h)});return t.displayName=`${e}.Slot`,t}be(Oo,"createSlot");var Fo=Symbol.for("radix.slottable");function xl(e){const t=be(n=>"child"in n?n.children(n.child):n.children,"Slottable");return t.displayName=`${e}.Slottable`,t.__radixId=Fo,t}be(xl,"createSlottable");var kl=be((e,t)=>{if("child"in e.props){const n=e.props.child;return s.isValidElement(n)?s.cloneElement(n,void 0,e.props.children(n.props.children)):null}return s.isValidElement(t)?t:null},"getSlottableElementFromSlottable");function $o(e,t){const n={...t};for(const r in t){const o=e[r],i=t[r];/^on[A-Z]/.test(r)?o&&i?n[r]=(...c)=>{const u=i(...c);return o(...c),u}:o&&(n[r]=o):r==="style"?n[r]={...o,...i}:r==="className"&&(n[r]=[o,i].filter(Boolean).join(" "))}return{...e,...n}}be($o,"mergeProps");function Bo(e){var r,o;let t=(r=Object.getOwnPropertyDescriptor(e.props,"ref"))==null?void 0:r.get,n=t&&"isReactWarning"in t&&t.isReactWarning;return n?e.ref:(t=(o=Object.getOwnPropertyDescriptor(e,"ref"))==null?void 0:o.get,n=t&&"isReactWarning"in t&&t.isReactWarning,n?e.props.ref:e.props.ref||e.ref)}be(Bo,"getElementRef");function Uo(e){return s.isValidElement(e)&&typeof e.type=="function"&&"__radixId"in e.type&&e.type.__radixId===Fo}be(Uo,"isSlottable");var Sl=Symbol.for("react.lazy");function Ln(e){return e!=null&&typeof e=="object"&&"$$typeof"in e&&e.$$typeof===Sl&&"_payload"in e&&Ho(e._payload)}be(Ln,"isLazyComponent");function Ho(e){return typeof e=="object"&&e!==null&&"then"in e}be(Ho,"isPromiseLike");var Cl=be(e=>`${e} failed to slot onto its children. Expected a single React element child or \`Slottable\`.`,"createSlotError"),El=be(e=>`${e} failed to slot onto its \`Slottable\`. Expected \`Slottable\` to receive a single React element child.`,"createSlottableError"),Kt=qe[" use ".trim().toString()],Rl=Object.defineProperty,Pl=(e,t)=>Rl(e,"name",{value:t,configurable:!0}),Il=["a","button","div","form","h2","h3","img","input","label","li","nav","ol","p","select","span","svg","ul"],Re=Il.reduce((e,t)=>{const n=Oo(`Primitive.${t}`),r=s.forwardRef((o,i)=>{const{asChild:l,...c}=o,u=l?n:t;return typeof window<"u"&&(window[Symbol.for("radix-ui")]=!0),a.jsx(u,{...c,ref:i})});return r.displayName=`Primitive.${t}`,{...e,[t]:r}},{});function Zn(e,t){e&&Co.flushSync(()=>e.dispatchEvent(t))}Pl(Zn,"dispatchDiscreteCustomEvent");var Tl=Object.defineProperty,ye=(e,t)=>Tl(e,"name",{value:t,configurable:!0});function pt(e){const t=s.forwardRef((n,r)=>{let{children:o,...i}=n,l=null,c=!1;const u=[];On(o)&&typeof Yt=="function"&&(o=Yt(o._payload)),s.Children.forEach(o,p=>{var v;if(Wo(p)){c=!0;const m=p;let b="child"in m.props?m.props.child:m.props.children;On(b)&&typeof Yt=="function"&&(b=Yt(b._payload)),l=Ml(m,b),u.push((v=l==null?void 0:l.props)==null?void 0:v.children)}else u.push(p)}),l?l=s.cloneElement(l,void 0,u):!c&&s.Children.count(o)===1&&s.isValidElement(o)&&(l=o);const f=l?Go(l):void 0,g=q(r,f);if(!l){if(o||o===0)throw new Error(c?Dl(e):Nl(e));return o}const h=Vo(i,l.props??{});return l.type!==s.Fragment&&(h.ref=r?g:f),s.cloneElement(l,h)});return t.displayName=`${e}.Slot`,t}ye(pt,"createSlot");var zo=Symbol.for("radix.slottable");function Al(e){const t=ye(n=>"child"in n?n.children(n.child):n.children,"Slottable");return t.displayName=`${e}.Slottable`,t.__radixId=zo,t}ye(Al,"createSlottable");var Ml=ye((e,t)=>{if("child"in e.props){const n=e.props.child;return s.isValidElement(n)?s.cloneElement(n,void 0,e.props.children(n.props.children)):null}return s.isValidElement(t)?t:null},"getSlottableElementFromSlottable");function Vo(e,t){const n={...t};for(const r in t){const o=e[r],i=t[r];/^on[A-Z]/.test(r)?o&&i?n[r]=(...c)=>{const u=i(...c);return o(...c),u}:o&&(n[r]=o):r==="style"?n[r]={...o,...i}:r==="className"&&(n[r]=[o,i].filter(Boolean).join(" "))}return{...e,...n}}ye(Vo,"mergeProps");function Go(e){var r,o;let t=(r=Object.getOwnPropertyDescriptor(e.props,"ref"))==null?void 0:r.get,n=t&&"isReactWarning"in t&&t.isReactWarning;return n?e.ref:(t=(o=Object.getOwnPropertyDescriptor(e,"ref"))==null?void 0:o.get,n=t&&"isReactWarning"in t&&t.isReactWarning,n?e.props.ref:e.props.ref||e.ref)}ye(Go,"getElementRef");function Wo(e){return s.isValidElement(e)&&typeof e.type=="function"&&"__radixId"in e.type&&e.type.__radixId===zo}ye(Wo,"isSlottable");var jl=Symbol.for("react.lazy");function On(e){return e!=null&&typeof e=="object"&&"$$typeof"in e&&e.$$typeof===jl&&"_payload"in e&&qo(e._payload)}ye(On,"isLazyComponent");function qo(e){return typeof e=="object"&&e!==null&&"then"in e}ye(qo,"isPromiseLike");var Nl=ye(e=>`${e} failed to slot onto its children. Expected a single React element child or \`Slottable\`.`,"createSlotError"),Dl=ye(e=>`${e} failed to slot onto its \`Slottable\`. Expected \`Slottable\` to receive a single React element child.`,"createSlottableError"),Yt=qe[" use ".trim().toString()],_l=Object.defineProperty,ne=(e,t)=>_l(e,"name",{value:t,configurable:!0});function Ko(e){const t=e+"CollectionProvider",[n,r]=_e(t),[o,i]=n(t,{collectionRef:{current:null},itemMap:new Map}),l=ne(b=>{const{scope:w,children:S}=b,y=s.useRef(null),x=s.useRef(new Map).current;return a.jsx(o,{scope:w,itemMap:x,collectionRef:y,children:S})},"CollectionProvider");l.displayName=t;const c=e+"CollectionSlot",u=pt(c),f=s.forwardRef((b,w)=>{const{scope:S,children:y}=b,x=i(c,S),k=q(w,x.collectionRef);return a.jsx(u,{ref:k,children:y})});f.displayName=c;const g=e+"CollectionItemSlot",h="data-radix-collection-item",p=pt(g),v=s.forwardRef((b,w)=>{const{scope:S,children:y,...x}=b,k=s.useRef(null),R=q(w,k),P=i(g,S);return s.useEffect(()=>(P.itemMap.set(k,{ref:k,...x}),()=>void P.itemMap.delete(k))),a.jsx(p,{[h]:"",ref:R,children:y})});v.displayName=g;function m(b){const w=i(e+"CollectionConsumer",b);return s.useCallback(()=>{const y=w.collectionRef.current;if(!y)return[];const x=Array.from(y.querySelectorAll(`[${h}]`));return Array.from(w.itemMap.values()).sort((P,M)=>x.indexOf(P.ref.current)-x.indexOf(M.ref.current))},[w.collectionRef,w.itemMap])}return ne(m,"useCollection"),[{Provider:l,Slot:f,ItemSlot:v},m,r]}ne(Ko,"createCollection");var uo=new WeakMap,X,he,In=(he=class extends Map{constructor(n){super(n);Sn(this,X);It(this,X,[...super.keys()]),uo.set(this,!0)}set(n,r){return uo.get(this)&&(this.has(n)?$(this,X)[$(this,X).indexOf(n)]=n:$(this,X).push(n)),super.set(n,r),this}insert(n,r,o){const i=this.has(r),l=$(this,X).length,c=Jn(n);let u=c>=0?c:l+c;const f=u<0||u>=l?-1:u;if(f===this.size||i&&f===this.size-1||f===-1)return this.set(r,o),this;const g=this.size+(i?0:1);c<0&&u++;const h=[...$(this,X)];let p,v=!1;for(let m=u;m<g;m++)if(u===m){let b=h[m];h[m]===r&&(b=h[m+1]),i&&this.delete(r),p=this.get(b),this.set(r,o)}else{!v&&h[m-1]===r&&(v=!0);const b=h[v?m:m-1],w=p;p=this.get(b),this.delete(b),this.set(b,w)}return this}with(n,r,o){const i=new he(this);return i.insert(n,r,o),i}before(n){const r=$(this,X).indexOf(n)-1;if(!(r<0))return this.entryAt(r)}setBefore(n,r,o){const i=$(this,X).indexOf(n);return i===-1?this:this.insert(i,r,o)}after(n){let r=$(this,X).indexOf(n);if(r=r===-1||r===this.size-1?-1:r+1,r!==-1)return this.entryAt(r)}setAfter(n,r,o){const i=$(this,X).indexOf(n);return i===-1?this:this.insert(i+1,r,o)}first(){return this.entryAt(0)}last(){return this.entryAt(-1)}clear(){return It(this,X,[]),super.clear()}delete(n){const r=super.delete(n);return r&&$(this,X).splice($(this,X).indexOf(n),1),r}deleteAt(n){const r=this.keyAt(n);return r!==void 0?this.delete(r):!1}at(n){const r=Zt($(this,X),n);if(r!==void 0)return this.get(r)}entryAt(n){const r=Zt($(this,X),n);if(r!==void 0)return[r,this.get(r)]}indexOf(n){return $(this,X).indexOf(n)}keyAt(n){return Zt($(this,X),n)}from(n,r){const o=this.indexOf(n);if(o===-1)return;let i=o+r;return i<0&&(i=0),i>=this.size&&(i=this.size-1),this.at(i)}keyFrom(n,r){const o=this.indexOf(n);if(o===-1)return;let i=o+r;return i<0&&(i=0),i>=this.size&&(i=this.size-1),this.keyAt(i)}find(n,r){let o=0;for(const i of this){if(Reflect.apply(n,r,[i,o,this]))return i;o++}}findIndex(n,r){let o=0;for(const i of this){if(Reflect.apply(n,r,[i,o,this]))return o;o++}return-1}filter(n,r){const o=[];let i=0;for(const l of this)Reflect.apply(n,r,[l,i,this])&&o.push(l),i++;return new he(o)}map(n,r){const o=[];let i=0;for(const l of this)o.push([l[0],Reflect.apply(n,r,[l,i,this])]),i++;return new he(o)}reduce(...n){const[r,o]=n;let i=0,l=o??this.at(0);for(const c of this)i===0&&n.length===1?l=c:l=Reflect.apply(r,this,[l,c,i,this]),i++;return l}reduceRight(...n){const[r,o]=n;let i=o??this.at(-1);for(let l=this.size-1;l>=0;l--){const c=this.at(l);l===this.size-1&&n.length===1?i=c:i=Reflect.apply(r,this,[i,c,l,this])}return i}toSorted(n){const r=[...this.entries()].sort(n);return new he(r)}toReversed(){const n=new he;for(let r=this.size-1;r>=0;r--){const o=this.keyAt(r),i=this.get(o);n.set(o,i)}return n}toSpliced(...n){const r=[...this.entries()];return r.splice(...n),new he(r)}slice(n,r){const o=new he;let i=this.size-1;if(n===void 0)return o;n<0&&(n=n+this.size),r!==void 0&&r>0&&(i=r-1);for(let l=n;l<=i;l++){const c=this.keyAt(l),u=this.get(c);o.set(c,u)}return o}every(n,r){let o=0;for(const i of this){if(!Reflect.apply(n,r,[i,o,this]))return!1;o++}return!0}some(n,r){let o=0;for(const i of this){if(Reflect.apply(n,r,[i,o,this]))return!0;o++}return!1}},X=new WeakMap,ne(he,"OrderedDict"),he);function Zt(e,t){if("at"in Array.prototype)return Array.prototype.at.call(e,t);const n=Yo(e,t);return n===-1?void 0:e[n]}ne(Zt,"at");function Yo(e,t){const n=e.length,r=Jn(t),o=r>=0?r:n+r;return o<0||o>=n?-1:o}ne(Yo,"toSafeIndex");function Jn(e){return e!==e||e===0?0:Math.trunc(e)}ne(Jn,"toSafeInteger");function Ll(e){const t=e+"CollectionProvider",[n,r]=_e(t),[o,i]=n(t,{collectionElement:null,collectionRef:{current:null},collectionRefObject:{current:null},itemMap:new In,setItemMap:ne(()=>{},"setItemMap")}),l=ne(({state:x,...k})=>x?a.jsx(u,{...k,state:x}):a.jsx(c,{...k}),"CollectionProvider");l.displayName=t;const c=ne(x=>{const k=w();return a.jsx(u,{...x,state:k})},"CollectionInit");c.displayName=t+"Init";const u=ne(x=>{const{scope:k,children:R,state:P}=x,M=s.useRef(null),[I,T]=s.useState(null),K=q(M,T),[z,j]=P;return s.useEffect(()=>{if(!I)return;const O=Zo(()=>{});return O.observe(I,{childList:!0,subtree:!0}),()=>{O.disconnect()}},[I]),a.jsx(o,{scope:k,itemMap:z,setItemMap:j,collectionRef:K,collectionRefObject:M,collectionElement:I,children:R})},"CollectionProviderImpl");u.displayName=t+"Impl";const f=e+"CollectionSlot",g=pt(f),h=s.forwardRef((x,k)=>{const{scope:R,children:P}=x,M=i(f,R),I=q(k,M.collectionRef);return a.jsx(g,{ref:I,children:P})});h.displayName=f;const p=e+"CollectionItemSlot",v="data-radix-collection-item",m=pt(p),b=s.forwardRef((x,k)=>{const{scope:R,children:P,...M}=x,I=s.useRef(null),[T,K]=s.useState(null),z=q(k,I,K),j=i(p,R),{setItemMap:O}=j,G=s.useRef(M);Xo(G.current,M)||(G.current=M);const Z=G.current;return s.useEffect(()=>{const le=Z;return O(N=>T?N.has(T)?N.set(T,{...le,element:T}).toSorted(Fn):(N.set(T,{...le,element:T}),N.toSorted(Fn)):N),()=>{O(N=>!T||!N.has(T)?N:(N.delete(T),new In(N)))}},[T,Z,O]),a.jsx(m,{[v]:"",ref:z,children:P})});b.displayName=p;function w(){return s.useState(new In)}ne(w,"useInitCollection");function S(x){const{itemMap:k}=i(e+"CollectionConsumer",x);return k}return ne(S,"useCollection"),[{Provider:l,Slot:h,ItemSlot:b},{createCollectionScope:r,useCollection:S,useInitCollection:w}]}ne(Ll,"createCollection");function Xo(e,t){if(e===t)return!0;if(typeof e!="object"||typeof t!="object"||e==null||t==null)return!1;const n=Object.keys(e),r=Object.keys(t);if(n.length!==r.length)return!1;for(const o of n)if(!Object.prototype.hasOwnProperty.call(t,o)||e[o]!==t[o])return!1;return!0}ne(Xo,"shallowEqual");function Qo(e,t){return!!(t.compareDocumentPosition(e)&Node.DOCUMENT_POSITION_PRECEDING)}ne(Qo,"isElementPreceding");function Fn(e,t){return!e[1].element||!t[1].element?0:Qo(e[1].element,t[1].element)?-1:1}ne(Fn,"sortByDocumentPosition");function Zo(e){return new MutationObserver(n=>{for(const r of n)if(r.type==="childList"){e();return}})}ne(Zo,"getChildListObserver");var Ol=Object.defineProperty,Fl=(e,t)=>Ol(e,"name",{value:t,configurable:!0}),$l=s.createContext(void 0);function Jo(e){const t=s.useContext($l);return e||t||"ltr"}Fl(Jo,"useDirection");var Bl=Object.defineProperty,Ul=(e,t)=>Bl(e,"name",{value:t,configurable:!0});function We(e){const t=s.useRef(e);return s.useEffect(()=>{t.current=e}),s.useMemo(()=>((...n)=>{var r;return(r=t.current)==null?void 0:r.call(t,...n)}),[])}Ul(We,"useCallbackRef");var Hl=Object.defineProperty,te=(e,t)=>Hl(e,"name",{value:t,configurable:!0}),$n="dismissableLayer.update",zl="dismissableLayer.pointerDownOutside",Vl="dismissableLayer.focusOutside",fo,ei=s.createContext({layers:new Set,layersWithOutsidePointerEventsDisabled:new Set,branches:new Set,dismissableSurfaces:new Set}),Gl=s.forwardRef(te(function(t,n){const{disableOutsidePointerEvents:r=!1,deferPointerDownOutside:o=!1,onEscapeKeyDown:i,onPointerDownOutside:l,onFocusOutside:c,onInteractOutside:u,onDismiss:f,...g}=t,h=s.useContext(ei),[p,v]=s.useState(null),m=(p==null?void 0:p.ownerDocument)??(globalThis==null?void 0:globalThis.document),[,b]=s.useState({}),w=q(n,v),S=Array.from(h.layers),[y]=[...h.layersWithOutsidePointerEventsDisabled].slice(-1),x=y?S.indexOf(y):-1,k=p?S.indexOf(p):-1,R=h.layersWithOutsidePointerEventsDisabled.size>0,P=k>=x,M=s.useRef(!1),I=ti(j=>{l==null||l(j),u==null||u(j),j.defaultPrevented||f==null||f()},{ownerDocument:m,deferPointerDownOutside:o,isDeferredPointerDownOutsideRef:M,dismissableSurfaces:h.dismissableSurfaces,shouldHandlePointerDownOutside:s.useCallback(j=>{if(!(j instanceof Node))return!1;const O=[...h.branches].some(G=>G.contains(j));return P&&!O},[h.branches,P])}),T=ni(j=>{if(o&&M.current)return;const O=j.target;[...h.branches].some(Z=>Z.contains(O))||(c==null||c(j),u==null||u(j),j.defaultPrevented||f==null||f())},m),K=p?k===S.length-1:!1,z=We(j=>{j.key==="Escape"&&(i==null||i(j),!j.defaultPrevented&&f&&(j.preventDefault(),f()))});return s.useEffect(()=>{if(K)return m.addEventListener("keydown",z,{capture:!0}),()=>m.removeEventListener("keydown",z,{capture:!0})},[m,K,z]),s.useEffect(()=>{if(p)return r&&(h.layersWithOutsidePointerEventsDisabled.size===0&&(fo=m.body.style.pointerEvents,m.body.style.pointerEvents="none"),h.layersWithOutsidePointerEventsDisabled.add(p)),h.layers.add(p),Bn(),()=>{r&&(h.layersWithOutsidePointerEventsDisabled.delete(p),h.layersWithOutsidePointerEventsDisabled.size===0&&(m.body.style.pointerEvents=fo))}},[p,m,r,h]),s.useEffect(()=>()=>{p&&(h.layers.delete(p),h.layersWithOutsidePointerEventsDisabled.delete(p),Bn())},[p,h]),s.useEffect(()=>{const j=te(()=>b({}),"handleUpdate");return document.addEventListener($n,j),()=>document.removeEventListener($n,j)},[]),a.jsx(Re.div,{...g,ref:w,style:{pointerEvents:R?P?"auto":"none":void 0,...t.style},onFocusCapture:U(t.onFocusCapture,T.onFocusCapture),onBlurCapture:U(t.onBlurCapture,T.onBlurCapture),onPointerDownCapture:U(t.onPointerDownCapture,I.onPointerDownCapture)})},"DismissableLayer"));function Wl(){const e=s.useContext(ei),[t,n]=s.useState(null);return s.useEffect(()=>{if(t)return e.dismissableSurfaces.add(t),()=>{e.dismissableSurfaces.delete(t)}},[t,e.dismissableSurfaces]),n}te(Wl,"useDismissableLayerSurface");var ql=te(()=>!0,"IS_TRUE");function ti(e,t){const{ownerDocument:n=globalThis==null?void 0:globalThis.document,deferPointerDownOutside:r=!1,isDeferredPointerDownOutsideRef:o,dismissableSurfaces:i,shouldHandlePointerDownOutside:l=ql}=t,c=We(e),u=s.useRef(!1),f=s.useRef(!1),g=s.useRef(new Map),h=s.useRef(()=>{});return s.useEffect(()=>{function p(){f.current=!1,o.current=!1,g.current.clear()}te(p,"resetOutsideInteraction");function v(){return Array.from(g.current.values()).some(Boolean)}te(v,"isOutsideInteractionIntercepted");function m(x){if(!f.current)return;const k=x.target;k instanceof Node&&[...i].some(P=>P.contains(k))||g.current.set(x.type,!0),x.type==="click"&&window.setTimeout(()=>{f.current&&h.current()},0)}te(m,"handleInteractionCapture");function b(x){f.current&&g.current.set(x.type,!1)}te(b,"handleInteractionBubble");const w=te(x=>{if(x.target&&!u.current){let k=function(){n.removeEventListener("click",h.current);const P=v();p(),P||er(zl,c,R,{discrete:!0})};if(te(k,"handleAndDispatchPointerDownOutsideEvent"),!l(x.target)){n.removeEventListener("click",h.current),p(),u.current=!1;return}const R={originalEvent:x};f.current=!0,o.current=r&&x.button===0,g.current.clear(),!r||x.button!==0?k():(n.removeEventListener("click",h.current),h.current=k,n.addEventListener("click",h.current,{once:!0}))}else n.removeEventListener("click",h.current),p();u.current=!1},"handlePointerDown"),S=["pointerup","mousedown","mouseup","touchstart","touchend","click"];for(const x of S)n.addEventListener(x,m,!0),n.addEventListener(x,b);const y=window.setTimeout(()=>{n.addEventListener("pointerdown",w)},0);return()=>{window.clearTimeout(y),n.removeEventListener("pointerdown",w),n.removeEventListener("click",h.current);for(const x of S)n.removeEventListener(x,m,!0),n.removeEventListener(x,b)}},[n,c,r,o,i,l]),{onPointerDownCapture:te(()=>u.current=!0,"onPointerDownCapture")}}te(ti,"usePointerDownOutside");function ni(e,t=globalThis==null?void 0:globalThis.document){const n=We(e),r=s.useRef(!1);return s.useEffect(()=>{const o=te(i=>{i.target&&!r.current&&er(Vl,n,{originalEvent:i},{discrete:!1})},"handleFocus");return t.addEventListener("focusin",o),()=>t.removeEventListener("focusin",o)},[t,n]),{onFocusCapture:te(()=>r.current=!0,"onFocusCapture"),onBlurCapture:te(()=>r.current=!1,"onBlurCapture")}}te(ni,"useFocusOutside");function Bn(){const e=new CustomEvent($n);document.dispatchEvent(e)}te(Bn,"dispatchUpdate");function er(e,t,n,{discrete:r}){const o=n.originalEvent.target,i=new CustomEvent(e,{bubbles:!1,cancelable:!0,detail:n});t&&o.addEventListener(e,t,{once:!0}),r?Zn(o,i):o.dispatchEvent(i)}te(er,"handleAndDispatchCustomEvent");var Kl=Object.defineProperty,tr=(e,t)=>Kl(e,"name",{value:t,configurable:!0}),Xt=0,Ee=null;function Yl(e){return nr(),e.children}tr(Yl,"FocusGuards");function nr(){s.useEffect(()=>{Ee||(Ee={start:Un(),end:Un()});const{start:e,end:t}=Ee;return document.body.firstElementChild!==e&&document.body.insertAdjacentElement("afterbegin",e),document.body.lastElementChild!==t&&document.body.insertAdjacentElement("beforeend",t),Xt++,()=>{Xt===1&&(Ee==null||Ee.start.remove(),Ee==null||Ee.end.remove(),Ee=null),Xt=Math.max(0,Xt-1)}},[])}tr(nr,"useFocusGuards");function Un(){const e=document.createElement("span");return e.setAttribute("data-radix-focus-guard",""),e.tabIndex=0,e.style.outline="none",e.style.opacity="0",e.style.position="fixed",e.style.pointerEvents="none",e}tr(Un,"createFocusGuard");var Xl=Object.defineProperty,ce=(e,t)=>Xl(e,"name",{value:t,configurable:!0}),Tn="focusScope.autoFocusOnMount",An="focusScope.autoFocusOnUnmount",ho={bubbles:!1,cancelable:!0},Ql=s.forwardRef(ce(function(t,n){const{loop:r=!1,trapped:o=!1,onMountAutoFocus:i,onUnmountAutoFocus:l,...c}=t,[u,f]=s.useState(null),g=We(i),h=We(l),p=s.useRef(null),v=q(n,f),m=s.useRef({paused:!1,pause(){this.paused=!0},resume(){this.paused=!1}}).current;s.useEffect(()=>{if(o){let w=function(k){if(m.paused||!u)return;const R=k.target;u.contains(R)?p.current=R:Ne(p.current,{select:!0})},S=function(k){if(m.paused||!u)return;const R=k.relatedTarget;R!==null&&(u.contains(R)||Ne(p.current,{select:!0}))},y=function(k){if(document.activeElement===document.body)for(const P of k)P.removedNodes.length>0&&Ne(u)};ce(w,"handleFocusIn"),ce(S,"handleFocusOut"),ce(y,"handleMutations"),document.addEventListener("focusin",w),document.addEventListener("focusout",S);const x=new MutationObserver(y);return u&&x.observe(u,{childList:!0,subtree:!0}),()=>{document.removeEventListener("focusin",w),document.removeEventListener("focusout",S),x.disconnect()}}},[o,u,m.paused]),s.useEffect(()=>{if(u){po.add(m);const w=document.activeElement;if(!u.contains(w)){const y=new CustomEvent(Tn,ho);u.addEventListener(Tn,g),u.dispatchEvent(y),y.defaultPrevented||(ri(li(rr(u)),{select:!0}),document.activeElement===w&&Ne(u))}return()=>{u.removeEventListener(Tn,g),setTimeout(()=>{const y=new CustomEvent(An,ho);u.addEventListener(An,h),u.dispatchEvent(y),y.defaultPrevented||Ne(w??document.body,{select:!0}),u.removeEventListener(An,h),po.remove(m)},0)}}},[u,g,h,m]);const b=s.useCallback(w=>{if(!r&&!o||m.paused)return;const S=w.key==="Tab"&&!w.altKey&&!w.ctrlKey&&!w.metaKey,y=document.activeElement;if(S&&y){const x=w.currentTarget,[k,R]=oi(x);k&&R?!w.shiftKey&&y===R?(w.preventDefault(),r&&Ne(k,{select:!0})):w.shiftKey&&y===k&&(w.preventDefault(),r&&Ne(R,{select:!0})):y===x&&w.preventDefault()}},[r,o,m.paused]);return a.jsx(Re.div,{tabIndex:-1,...c,ref:v,onKeyDown:b})},"FocusScope"));function ri(e,{select:t=!1}={}){const n=document.activeElement;for(const r of e)if(Ne(r,{select:t}),document.activeElement!==n)return}ce(ri,"focusFirst");function oi(e){const t=rr(e),n=Hn(t,e),r=Hn(t.reverse(),e);return[n,r]}ce(oi,"getTabbableEdges");function rr(e){const t=[],n=document.createTreeWalker(e,NodeFilter.SHOW_ELEMENT,{acceptNode:ce(r=>{const o=r.tagName==="INPUT"&&r.type==="hidden";return r.disabled||r.hidden||o?NodeFilter.FILTER_SKIP:r.tabIndex>=0?NodeFilter.FILTER_ACCEPT:NodeFilter.FILTER_SKIP},"acceptNode")});for(;n.nextNode();)t.push(n.currentNode);return t}ce(rr,"getTabbableCandidates");function Hn(e,t){const n=typeof t.checkVisibility=="function"&&t.checkVisibility({checkVisibilityCSS:!0});for(const r of e)if(!(n?!r.checkVisibility({checkVisibilityCSS:!0}):ii(r,{upTo:t})))return r}ce(Hn,"findVisible");function ii(e,{upTo:t}){if(getComputedStyle(e).visibility==="hidden")return!0;for(;e;){if(t!==void 0&&e===t)return!1;if(getComputedStyle(e).display==="none")return!0;e=e.parentElement}return!1}ce(ii,"isHidden");function si(e){return e instanceof HTMLInputElement&&"select"in e}ce(si,"isSelectableInput");function Ne(e,{select:t=!1}={}){if(e&&e.focus){const n=document.activeElement;e.focus({preventScroll:!0}),e!==n&&si(e)&&t&&e.select()}}ce(Ne,"focus");var po=ai();function ai(){let e=[];return{add(t){const n=e[0];t!==n&&(n==null||n.pause()),e=zn(e,t),e.unshift(t)},remove(t){var n;e=zn(e,t),(n=e[0])==null||n.resume()}}}ce(ai,"createFocusScopesStack");function zn(e,t){const n=[...e],r=n.indexOf(t);return r!==-1&&n.splice(r,1),n}ce(zn,"arrayRemove");function li(e){return e.filter(t=>t.tagName!=="A")}ce(li,"removeLinks");var Zl=globalThis!=null&&globalThis.document?s.useLayoutEffect:()=>{},Jl=Object.defineProperty,ec=(e,t)=>Jl(e,"name",{value:t,configurable:!0}),tc=qe[" useId ".trim().toString()]||(()=>{}),nc=0;function nn(e){const[t,n]=s.useState(tc());return Zl(()=>{e||n(r=>r??String(nc++))},[e]),e||(t?`radix-${t}`:"")}ec(nn,"useId");var Jt=globalThis!=null&&globalThis.document?s.useLayoutEffect:()=>{},rc=Object.defineProperty,oc=(e,t)=>rc(e,"name",{value:t,configurable:!0});function ci(e){const[t,n]=s.useState(void 0);return Jt(()=>{if(e){n({width:e.offsetWidth,height:e.offsetHeight});const r=new ResizeObserver(o=>{if(!Array.isArray(o)||!o.length)return;const i=o[0];let l,c;if("borderBoxSize"in i){const u=i.borderBoxSize,f=Array.isArray(u)?u[0]:u;l=f.inlineSize,c=f.blockSize}else l=e.offsetWidth,c=e.offsetHeight;n({width:l,height:c})});return r.observe(e,{box:"border-box"}),()=>r.unobserve(e)}else n(void 0)},[e]),t}oc(ci,"useSize");var ic=Object.defineProperty,Ve=(e,t)=>ic(e,"name",{value:t,configurable:!0}),ui="Popper",[di,fi]=_e(ui),[sc,hi]=di(ui),ac=Ve(e=>{const{__scopePopper:t,children:n}=e,[r,o]=s.useState(null),[i,l]=s.useState(void 0);return a.jsx(sc,{scope:t,anchor:r,onAnchorChange:o,placementState:i,setPlacementState:l,children:n})},"Popper"),lc="PopperAnchor",cc=s.forwardRef(Ve(function(t,n){const{__scopePopper:r,virtualRef:o,...i}=t,l=hi(lc,r),c=s.useRef(null),u=l.onAnchorChange,f=s.useCallback(b=>{c.current=b,b&&u(b)},[u]),g=q(n,f),h=s.useRef(null);s.useEffect(()=>{if(!o)return;const b=h.current;h.current=o.current,b!==h.current&&u(h.current)});const p=l.placementState&&on(l.placementState),v=p==null?void 0:p[0],m=p==null?void 0:p[1];return o?null:a.jsx(Re.div,{"data-radix-popper-side":v,"data-radix-popper-align":m,...i,ref:g})},"PopperAnchor")),pi="PopperContent",[uc,wd]=di(pi),dc=s.forwardRef(Ve(function(t,n){var Oe,se,Ie,vt,ot,it,bt;const{__scopePopper:r,side:o="bottom",sideOffset:i=0,align:l="center",alignOffset:c=0,arrowPadding:u=0,avoidCollisions:f=!0,collisionBoundary:g=[],collisionPadding:h=0,sticky:p="partial",hideWhenDetached:v=!1,updatePositionStrategy:m="optimized",onPlaced:b,...w}=t,S=hi(pi,r),[y,x]=s.useState(null),k=q(n,x),[R,P]=s.useState(null),M=ci(R),I=(M==null?void 0:M.width)??0,T=(M==null?void 0:M.height)??0,K=o+(l!=="center"?"-"+l:""),z=typeof h=="number"?h:{top:0,right:0,bottom:0,left:0,...h},j=Array.isArray(g)?g:[g],O=j.length>0,G={padding:z,boundary:j.filter(mi),altBoundary:O},{refs:Z,floatingStyles:le,placement:N,isPositioned:xe,middlewareData:L}=js({strategy:"fixed",placement:K,whileElementsMounted:Ve((...Se)=>Bs(...Se,{animationFrame:m==="always"}),"whileElementsMounted"),elements:{reference:S.anchor},middleware:[Ns({mainAxis:i+T,alignmentAxis:c}),f&&Ds({mainAxis:!0,crossAxis:!1,limiter:p==="partial"?_s():void 0,...G}),f&&Ls({...G}),Os({...G,apply:Ve(({elements:Se,rects:_t,availableWidth:ln,availableHeight:yt})=>{const{width:wt,height:cn}=_t.reference,Ke=Se.floating.style;Ke.setProperty("--radix-popper-available-width",`${ln}px`),Ke.setProperty("--radix-popper-available-height",`${yt}px`),Ke.setProperty("--radix-popper-anchor-width",`${wt}px`),Ke.setProperty("--radix-popper-anchor-height",`${cn}px`)},"apply")}),R&&Fs({element:R,padding:u}),fc({arrowWidth:I,arrowHeight:T}),v&&$s({strategy:"referenceHidden",...G,boundary:O?G.boundary:void 0})]}),A=S.setPlacementState;Jt(()=>(A(N),()=>{A(void 0)}),[N,A]);const[J,ie]=on(N),Y=We(b);Jt(()=>{xe&&(Y==null||Y())},[xe,Y]);const Le=(Oe=L.arrow)==null?void 0:Oe.x,Pe=(se=L.arrow)==null?void 0:se.y,ue=((Ie=L.arrow)==null?void 0:Ie.centerOffset)!==0,[ke,fe]=s.useState();return Jt(()=>{y&&fe(window.getComputedStyle(y).zIndex)},[y]),a.jsx("div",{ref:Z.setFloating,"data-radix-popper-content-wrapper":"",style:{...le,transform:xe?le.transform:"translate(0, -200%)",minWidth:"max-content",zIndex:ke,"--radix-popper-transform-origin":[(vt=L.transformOrigin)==null?void 0:vt.x,(ot=L.transformOrigin)==null?void 0:ot.y].join(" "),...((it=L.hide)==null?void 0:it.referenceHidden)&&{visibility:"hidden",pointerEvents:"none"}},dir:t.dir,children:a.jsx(uc,{scope:r,placedSide:J,placedAlign:ie,onArrowChange:P,arrowX:Le,arrowY:Pe,shouldHideArrow:ue,children:a.jsx(Re.div,{"data-side":J,"data-align":ie,...w,ref:k,style:{...w.style,animation:xe?(bt=w.style)==null?void 0:bt.animation:"none"}})})})},"PopperContent"));function mi(e){return e!==null}Ve(mi,"isNotNull");var fc=Ve(e=>({name:"transformOrigin",options:e,fn(t){var w,S,y;const{placement:n,rects:r,middlewareData:o}=t,l=((w=o.arrow)==null?void 0:w.centerOffset)!==0,c=l?0:e.arrowWidth,u=l?0:e.arrowHeight,[f,g]=on(n),h={start:"0%",center:"50%",end:"100%"}[g],p=(((S=o.arrow)==null?void 0:S.x)??0)+c/2,v=(((y=o.arrow)==null?void 0:y.y)??0)+u/2;let m="",b="";return f==="bottom"?(m=l?h:`${p}px`,b=`${-u}px`):f==="top"?(m=l?h:`${p}px`,b=`${r.floating.height+u}px`):f==="right"?(m=`${-u}px`,b=l?h:`${v}px`):f==="left"&&(m=`${r.floating.width+u}px`,b=l?h:`${v}px`),{data:{x:m,y:b}}}}),"transformOrigin");function on(e){const[t,n="center"]=e.split("-");return[t,n]}Ve(on,"getSideAndAlignFromPlacement");var hc=ac,pc=cc,mc=dc,gc=globalThis!=null&&globalThis.document?s.useLayoutEffect:()=>{},vc=Object.defineProperty,bc=(e,t)=>vc(e,"name",{value:t,configurable:!0}),yc=s.forwardRef(bc(function(t,n){var u;const{container:r,...o}=t,[i,l]=s.useState(!1);gc(()=>l(!0),[]);const c=r||i&&((u=globalThis==null?void 0:globalThis.document)==null?void 0:u.body);return c?Co.createPortal(a.jsx(Re.div,{...o,ref:n}),c):null},"Portal")),mo=globalThis!=null&&globalThis.document?s.useLayoutEffect:()=>{},wc=Object.defineProperty,De=(e,t)=>wc(e,"name",{value:t,configurable:!0});function gi(e,t){return s.useReducer((n,r)=>t[n][r]??n,e)}De(gi,"useStateMachine");var or=De(e=>{const{present:t,children:n}=e,r=vi(t),o=typeof n=="function"?n({present:r.isPresent}):s.Children.only(n),i=bi(r.ref,yi(o));return typeof n=="function"||r.isPresent?s.cloneElement(o,{ref:i}):null},"Presence");function vi(e){const[t,n]=s.useState(),r=s.useRef(null),o=s.useRef(e),i=s.useRef("none"),l=s.useRef(void 0),c=e?"mounted":"unmounted",[u,f]=gi(c,{mounted:{UNMOUNT:"unmounted",ANIMATION_OUT:"unmountSuspended"},unmountSuspended:{MOUNT:"mounted",ANIMATION_END:"unmounted"},unmounted:{MOUNT:"mounted"}});return s.useEffect(()=>{u==="mounted"?(i.current=l.current??ft(r.current),l.current=void 0):i.current="none"},[u]),mo(()=>{const g=r.current,h=o.current;if(h!==e){const v=i.current,m=ft(g);e?(l.current=m,f("MOUNT")):m==="none"||(g==null?void 0:g.display)==="none"?f("UNMOUNT"):f(h&&v!==m?"ANIMATION_OUT":"UNMOUNT"),o.current=e}},[e,f]),mo(()=>{if(t){let g;const h=t.ownerDocument.defaultView??window,p=De(m=>{const w=ft(r.current).includes(CSS.escape(m.animationName));if(m.target===t&&w&&(f("ANIMATION_END"),!o.current)){const S=t.style.animationFillMode;t.style.animationFillMode="forwards",g=h.setTimeout(()=>{t.style.animationFillMode==="forwards"&&(t.style.animationFillMode=S)})}},"handleAnimationEnd"),v=De(m=>{m.target===t&&(i.current=ft(r.current))},"handleAnimationStart");return t.addEventListener("animationstart",v),t.addEventListener("animationcancel",p),t.addEventListener("animationend",p),()=>{h.clearTimeout(g),t.removeEventListener("animationstart",v),t.removeEventListener("animationcancel",p),t.removeEventListener("animationend",p)}}else f("ANIMATION_END")},[t,f]),{isPresent:["mounted","unmountSuspended"].includes(u),ref:s.useCallback(g=>{if(g){const h=getComputedStyle(g);r.current=h,l.current=ft(h)}else r.current=null;n(g)},[])}}De(vi,"usePresence");function Vn(e,t){if(typeof e=="function")return e(t);e!=null&&(e.current=t)}De(Vn,"setRef");function bi(...e){const t=s.useRef(e);return t.current=e,s.useCallback(n=>{const r=t.current;let o=!1;const i=r.map(l=>{const c=Vn(l,n);return!o&&typeof c=="function"&&(o=!0),c});if(o)return()=>{for(let l=0;l<i.length;l++){const c=i[l];typeof c=="function"?c():Vn(r[l],null)}}},[])}De(bi,"useStableComposedRefs");function ft(e){return(e==null?void 0:e.animationName)||"none"}De(ft,"getAnimationName");function yi(e){var r,o;let t=(r=Object.getOwnPropertyDescriptor(e.props,"ref"))==null?void 0:r.get,n=t&&"isReactWarning"in t&&t.isReactWarning;return n?e.ref:(t=(o=Object.getOwnPropertyDescriptor(e,"ref"))==null?void 0:o.get,n=t&&"isReactWarning"in t&&t.isReactWarning,n?e.props.ref:e.props.ref||e.ref)}De(yi,"getElementRef");var xc=Object.defineProperty,we=(e,t)=>xc(e,"name",{value:t,configurable:!0});function Mt(e){const t=s.forwardRef((n,r)=>{let{children:o,...i}=n,l=null,c=!1;const u=[];Gn(o)&&typeof Qt=="function"&&(o=Qt(o._payload)),s.Children.forEach(o,p=>{var v;if(Si(p)){c=!0;const m=p;let b="child"in m.props?m.props.child:m.props.children;Gn(b)&&typeof Qt=="function"&&(b=Qt(b._payload)),l=Sc(m,b),u.push((v=l==null?void 0:l.props)==null?void 0:v.children)}else u.push(p)}),l?l=s.cloneElement(l,void 0,u):!c&&s.Children.count(o)===1&&s.isValidElement(o)&&(l=o);const f=l?ki(l):void 0,g=q(r,f);if(!l){if(o||o===0)throw new Error(c?Rc(e):Ec(e));return o}const h=xi(i,l.props??{});return l.type!==s.Fragment&&(h.ref=r?g:f),s.cloneElement(l,h)});return t.displayName=`${e}.Slot`,t}we(Mt,"createSlot");var wi=Symbol.for("radix.slottable");function kc(e){const t=we(n=>"child"in n?n.children(n.child):n.children,"Slottable");return t.displayName=`${e}.Slottable`,t.__radixId=wi,t}we(kc,"createSlottable");var Sc=we((e,t)=>{if("child"in e.props){const n=e.props.child;return s.isValidElement(n)?s.cloneElement(n,void 0,e.props.children(n.props.children)):null}return s.isValidElement(t)?t:null},"getSlottableElementFromSlottable");function xi(e,t){const n={...t};for(const r in t){const o=e[r],i=t[r];/^on[A-Z]/.test(r)?o&&i?n[r]=(...c)=>{const u=i(...c);return o(...c),u}:o&&(n[r]=o):r==="style"?n[r]={...o,...i}:r==="className"&&(n[r]=[o,i].filter(Boolean).join(" "))}return{...e,...n}}we(xi,"mergeProps");function ki(e){var r,o;let t=(r=Object.getOwnPropertyDescriptor(e.props,"ref"))==null?void 0:r.get,n=t&&"isReactWarning"in t&&t.isReactWarning;return n?e.ref:(t=(o=Object.getOwnPropertyDescriptor(e,"ref"))==null?void 0:o.get,n=t&&"isReactWarning"in t&&t.isReactWarning,n?e.props.ref:e.props.ref||e.ref)}we(ki,"getElementRef");function Si(e){return s.isValidElement(e)&&typeof e.type=="function"&&"__radixId"in e.type&&e.type.__radixId===wi}we(Si,"isSlottable");var Cc=Symbol.for("react.lazy");function Gn(e){return e!=null&&typeof e=="object"&&"$$typeof"in e&&e.$$typeof===Cc&&"_payload"in e&&Ci(e._payload)}we(Gn,"isLazyComponent");function Ci(e){return typeof e=="object"&&e!==null&&"then"in e}we(Ci,"isPromiseLike");var Ec=we(e=>`${e} failed to slot onto its children. Expected a single React element child or \`Slottable\`.`,"createSlotError"),Rc=we(e=>`${e} failed to slot onto its \`Slottable\`. Expected \`Slottable\` to receive a single React element child.`,"createSlottableError"),Qt=qe[" use ".trim().toString()],Pc=Object.defineProperty,re=(e,t)=>Pc(e,"name",{value:t,configurable:!0});function Ei(e){const t=e+"CollectionProvider",[n,r]=_e(t),[o,i]=n(t,{collectionRef:{current:null},itemMap:new Map}),l=re(b=>{const{scope:w,children:S}=b,y=s.useRef(null),x=s.useRef(new Map).current;return a.jsx(o,{scope:w,itemMap:x,collectionRef:y,children:S})},"CollectionProvider");l.displayName=t;const c=e+"CollectionSlot",u=Mt(c),f=s.forwardRef((b,w)=>{const{scope:S,children:y}=b,x=i(c,S),k=q(w,x.collectionRef);return a.jsx(u,{ref:k,children:y})});f.displayName=c;const g=e+"CollectionItemSlot",h="data-radix-collection-item",p=Mt(g),v=s.forwardRef((b,w)=>{const{scope:S,children:y,...x}=b,k=s.useRef(null),R=q(w,k),P=i(g,S);return s.useEffect(()=>(P.itemMap.set(k,{ref:k,...x}),()=>void P.itemMap.delete(k))),a.jsx(p,{[h]:"",ref:R,children:y})});v.displayName=g;function m(b){const w=i(e+"CollectionConsumer",b);return s.useCallback(()=>{const y=w.collectionRef.current;if(!y)return[];const x=Array.from(y.querySelectorAll(`[${h}]`));return Array.from(w.itemMap.values()).sort((P,M)=>x.indexOf(P.ref.current)-x.indexOf(M.ref.current))},[w.collectionRef,w.itemMap])}return re(m,"useCollection"),[{Provider:l,Slot:f,ItemSlot:v},m,r]}re(Ei,"createCollection");var go=new WeakMap,Q,pe,Mn=(pe=class extends Map{constructor(n){super(n);Sn(this,Q);It(this,Q,[...super.keys()]),go.set(this,!0)}set(n,r){return go.get(this)&&(this.has(n)?$(this,Q)[$(this,Q).indexOf(n)]=n:$(this,Q).push(n)),super.set(n,r),this}insert(n,r,o){const i=this.has(r),l=$(this,Q).length,c=ir(n);let u=c>=0?c:l+c;const f=u<0||u>=l?-1:u;if(f===this.size||i&&f===this.size-1||f===-1)return this.set(r,o),this;const g=this.size+(i?0:1);c<0&&u++;const h=[...$(this,Q)];let p,v=!1;for(let m=u;m<g;m++)if(u===m){let b=h[m];h[m]===r&&(b=h[m+1]),i&&this.delete(r),p=this.get(b),this.set(r,o)}else{!v&&h[m-1]===r&&(v=!0);const b=h[v?m:m-1],w=p;p=this.get(b),this.delete(b),this.set(b,w)}return this}with(n,r,o){const i=new pe(this);return i.insert(n,r,o),i}before(n){const r=$(this,Q).indexOf(n)-1;if(!(r<0))return this.entryAt(r)}setBefore(n,r,o){const i=$(this,Q).indexOf(n);return i===-1?this:this.insert(i,r,o)}after(n){let r=$(this,Q).indexOf(n);if(r=r===-1||r===this.size-1?-1:r+1,r!==-1)return this.entryAt(r)}setAfter(n,r,o){const i=$(this,Q).indexOf(n);return i===-1?this:this.insert(i+1,r,o)}first(){return this.entryAt(0)}last(){return this.entryAt(-1)}clear(){return It(this,Q,[]),super.clear()}delete(n){const r=super.delete(n);return r&&$(this,Q).splice($(this,Q).indexOf(n),1),r}deleteAt(n){const r=this.keyAt(n);return r!==void 0?this.delete(r):!1}at(n){const r=en($(this,Q),n);if(r!==void 0)return this.get(r)}entryAt(n){const r=en($(this,Q),n);if(r!==void 0)return[r,this.get(r)]}indexOf(n){return $(this,Q).indexOf(n)}keyAt(n){return en($(this,Q),n)}from(n,r){const o=this.indexOf(n);if(o===-1)return;let i=o+r;return i<0&&(i=0),i>=this.size&&(i=this.size-1),this.at(i)}keyFrom(n,r){const o=this.indexOf(n);if(o===-1)return;let i=o+r;return i<0&&(i=0),i>=this.size&&(i=this.size-1),this.keyAt(i)}find(n,r){let o=0;for(const i of this){if(Reflect.apply(n,r,[i,o,this]))return i;o++}}findIndex(n,r){let o=0;for(const i of this){if(Reflect.apply(n,r,[i,o,this]))return o;o++}return-1}filter(n,r){const o=[];let i=0;for(const l of this)Reflect.apply(n,r,[l,i,this])&&o.push(l),i++;return new pe(o)}map(n,r){const o=[];let i=0;for(const l of this)o.push([l[0],Reflect.apply(n,r,[l,i,this])]),i++;return new pe(o)}reduce(...n){const[r,o]=n;let i=0,l=o??this.at(0);for(const c of this)i===0&&n.length===1?l=c:l=Reflect.apply(r,this,[l,c,i,this]),i++;return l}reduceRight(...n){const[r,o]=n;let i=o??this.at(-1);for(let l=this.size-1;l>=0;l--){const c=this.at(l);l===this.size-1&&n.length===1?i=c:i=Reflect.apply(r,this,[i,c,l,this])}return i}toSorted(n){const r=[...this.entries()].sort(n);return new pe(r)}toReversed(){const n=new pe;for(let r=this.size-1;r>=0;r--){const o=this.keyAt(r),i=this.get(o);n.set(o,i)}return n}toSpliced(...n){const r=[...this.entries()];return r.splice(...n),new pe(r)}slice(n,r){const o=new pe;let i=this.size-1;if(n===void 0)return o;n<0&&(n=n+this.size),r!==void 0&&r>0&&(i=r-1);for(let l=n;l<=i;l++){const c=this.keyAt(l),u=this.get(c);o.set(c,u)}return o}every(n,r){let o=0;for(const i of this){if(!Reflect.apply(n,r,[i,o,this]))return!1;o++}return!0}some(n,r){let o=0;for(const i of this){if(Reflect.apply(n,r,[i,o,this]))return!0;o++}return!1}},Q=new WeakMap,re(pe,"OrderedDict"),pe);function en(e,t){if("at"in Array.prototype)return Array.prototype.at.call(e,t);const n=Ri(e,t);return n===-1?void 0:e[n]}re(en,"at");function Ri(e,t){const n=e.length,r=ir(t),o=r>=0?r:n+r;return o<0||o>=n?-1:o}re(Ri,"toSafeIndex");function ir(e){return e!==e||e===0?0:Math.trunc(e)}re(ir,"toSafeInteger");function Ic(e){const t=e+"CollectionProvider",[n,r]=_e(t),[o,i]=n(t,{collectionElement:null,collectionRef:{current:null},collectionRefObject:{current:null},itemMap:new Mn,setItemMap:re(()=>{},"setItemMap")}),l=re(({state:x,...k})=>x?a.jsx(u,{...k,state:x}):a.jsx(c,{...k}),"CollectionProvider");l.displayName=t;const c=re(x=>{const k=w();return a.jsx(u,{...x,state:k})},"CollectionInit");c.displayName=t+"Init";const u=re(x=>{const{scope:k,children:R,state:P}=x,M=s.useRef(null),[I,T]=s.useState(null),K=q(M,T),[z,j]=P;return s.useEffect(()=>{if(!I)return;const O=Ti(()=>{});return O.observe(I,{childList:!0,subtree:!0}),()=>{O.disconnect()}},[I]),a.jsx(o,{scope:k,itemMap:z,setItemMap:j,collectionRef:K,collectionRefObject:M,collectionElement:I,children:R})},"CollectionProviderImpl");u.displayName=t+"Impl";const f=e+"CollectionSlot",g=Mt(f),h=s.forwardRef((x,k)=>{const{scope:R,children:P}=x,M=i(f,R),I=q(k,M.collectionRef);return a.jsx(g,{ref:I,children:P})});h.displayName=f;const p=e+"CollectionItemSlot",v="data-radix-collection-item",m=Mt(p),b=s.forwardRef((x,k)=>{const{scope:R,children:P,...M}=x,I=s.useRef(null),[T,K]=s.useState(null),z=q(k,I,K),j=i(p,R),{setItemMap:O}=j,G=s.useRef(M);Pi(G.current,M)||(G.current=M);const Z=G.current;return s.useEffect(()=>{const le=Z;return O(N=>T?N.has(T)?N.set(T,{...le,element:T}).toSorted(Wn):(N.set(T,{...le,element:T}),N.toSorted(Wn)):N),()=>{O(N=>!T||!N.has(T)?N:(N.delete(T),new Mn(N)))}},[T,Z,O]),a.jsx(m,{[v]:"",ref:z,children:P})});b.displayName=p;function w(){return s.useState(new Mn)}re(w,"useInitCollection");function S(x){const{itemMap:k}=i(e+"CollectionConsumer",x);return k}return re(S,"useCollection"),[{Provider:l,Slot:h,ItemSlot:b},{createCollectionScope:r,useCollection:S,useInitCollection:w}]}re(Ic,"createCollection");function Pi(e,t){if(e===t)return!0;if(typeof e!="object"||typeof t!="object"||e==null||t==null)return!1;const n=Object.keys(e),r=Object.keys(t);if(n.length!==r.length)return!1;for(const o of n)if(!Object.prototype.hasOwnProperty.call(t,o)||e[o]!==t[o])return!1;return!0}re(Pi,"shallowEqual");function Ii(e,t){return!!(t.compareDocumentPosition(e)&Node.DOCUMENT_POSITION_PRECEDING)}re(Ii,"isElementPreceding");function Wn(e,t){return!e[1].element||!t[1].element?0:Ii(e[1].element,t[1].element)?-1:1}re(Wn,"sortByDocumentPosition");function Ti(e){return new MutationObserver(n=>{for(const r of n)if(r.type==="childList"){e();return}})}re(Ti,"getChildListObserver");var Tc=Object.defineProperty,Ac=(e,t)=>Tc(e,"name",{value:t,configurable:!0});function Ai(e){const t=s.useRef(e);return s.useEffect(()=>{t.current=e}),s.useMemo(()=>((...n)=>{var r;return(r=t.current)==null?void 0:r.call(t,...n)}),[])}Ac(Ai,"useCallbackRef");var Mc=Object.defineProperty,jc=(e,t)=>Mc(e,"name",{value:t,configurable:!0}),Nc=s.createContext(void 0);function Mi(e){const t=s.useContext(Nc);return e||t||"ltr"}jc(Mi,"useDirection");var Dc=globalThis!=null&&globalThis.document?s.useLayoutEffect:()=>{},_c=Object.defineProperty,sr=(e,t)=>_c(e,"name",{value:t,configurable:!0}),jn=!1;function ji(){const[e,t]=s.useState(jn);return s.useEffect(()=>{jn||(jn=!0,t(!0))},[]),e}sr(ji,"useIsHydrated");var Ni=qe[" useSyncExternalStore ".trim().toString()];function Di(){return()=>{}}sr(Di,"subscribe");function _i(){return Ni(Di,()=>!0,()=>!1)}sr(_i,"useIsHydratedModern");var Lc=typeof Ni=="function"?_i:ji,Oc=Object.defineProperty,nt=(e,t)=>Oc(e,"name",{value:t,configurable:!0}),Nn="rovingFocusGroup.onEntryFocus",Fc={bubbles:!1,cancelable:!0},sn="RovingFocusGroup",[qn,Li,$c]=Ei(sn),[Bc,Oi]=_e(sn,[$c]),[Uc,Hc]=Bc(sn),zc=s.forwardRef(nt(function(t,n){return a.jsx(qn.Provider,{scope:t.__scopeRovingFocusGroup,children:a.jsx(qn.Slot,{scope:t.__scopeRovingFocusGroup,children:a.jsx(Vc,{...t,ref:n})})})},"RovingFocusGroup")),Vc=s.forwardRef(nt(function(t,n){const{__scopeRovingFocusGroup:r,orientation:o,loop:i=!1,dir:l,currentTabStopId:c,defaultCurrentTabStopId:u,onCurrentTabStopIdChange:f,onEntryFocus:g,preventScrollOnEntryFocus:h=!1,...p}=t,v=s.useRef(null),m=q(n,v),b=Mi(l),[w,S]=Qn({prop:c,defaultProp:u??null,onChange:f,caller:sn}),[y,x]=s.useState(!1),k=Ai(g),R=Li(r),P=s.useRef(!1),[M,I]=s.useState(0);return s.useEffect(()=>{const T=v.current;if(T)return T.addEventListener(Nn,k),()=>T.removeEventListener(Nn,k)},[k]),a.jsx(Uc,{scope:r,orientation:o,dir:b,loop:i,currentTabStopId:w,onItemFocus:s.useCallback(T=>S(T),[S]),onItemShiftTab:s.useCallback(()=>x(!0),[]),onFocusableItemAdd:s.useCallback(()=>I(T=>T+1),[]),onFocusableItemRemove:s.useCallback(()=>I(T=>T-1),[]),children:a.jsx(Re.div,{tabIndex:y||M===0?-1:0,"data-orientation":o,...p,ref:m,style:{outline:"none",...t.style},onMouseDown:U(t.onMouseDown,()=>{P.current=!0}),onFocus:U(t.onFocus,T=>{const K=!P.current;if(T.target===T.currentTarget&&K&&!y){const z=new CustomEvent(Nn,Fc);if(T.currentTarget.dispatchEvent(z),!z.defaultPrevented){const j=R().filter(N=>N.focusable),O=j.find(N=>N.active),G=j.find(N=>N.id===w),le=[O,G,...j].filter(Boolean).map(N=>N.ref.current);ar(le,h)}}P.current=!1}),onBlur:U(t.onBlur,()=>x(!1))})})},"RovingFocusGroupImpl")),Gc="RovingFocusGroupItem",Wc=s.forwardRef(nt(function(t,n){const{__scopeRovingFocusGroup:r,focusable:o=!0,active:i=!1,tabStopId:l,children:c,...u}=t,f=nn(),g=l||f,h=Hc(Gc,r),p=h.currentTabStopId===g,v=Li(r),{onFocusableItemAdd:m,onFocusableItemRemove:b,currentTabStopId:w}=h,S=Lc();return Dc(()=>{if(!(!S||!o))return m(),()=>b()},[S,o,m,b]),s.useEffect(()=>{if(!(S||!o))return m(),()=>b()},[S,o,m,b]),a.jsx(qn.ItemSlot,{scope:r,id:g,focusable:o,active:i,children:a.jsx(Re.span,{tabIndex:p?0:-1,"data-orientation":h.orientation,...u,ref:n,onMouseDown:U(t.onMouseDown,y=>{o?h.onItemFocus(g):y.preventDefault()}),onFocus:U(t.onFocus,()=>h.onItemFocus(g)),onKeyDown:U(t.onKeyDown,y=>{if(y.key==="Tab"&&y.shiftKey){h.onItemShiftTab();return}if(y.target!==y.currentTarget)return;const x=$i(y,h.orientation,h.dir);if(x!==void 0){if(y.metaKey||y.ctrlKey||y.altKey||y.shiftKey)return;y.preventDefault();let R=v().filter(P=>P.focusable).map(P=>P.ref.current);if(x==="last")R.reverse();else if(x==="prev"||x==="next"){x==="prev"&&R.reverse();const P=R.indexOf(y.currentTarget);R=h.loop?Bi(R,P+1):R.slice(P+1)}setTimeout(()=>ar(R))}}),children:typeof c=="function"?c({isCurrentTabStop:p,hasTabStop:w!=null}):c})})},"RovingFocusGroupItem")),qc={ArrowLeft:"prev",ArrowUp:"prev",ArrowRight:"next",ArrowDown:"next",PageUp:"first",Home:"first",PageDown:"last",End:"last"};function Fi(e,t){return t!=="rtl"?e:e==="ArrowLeft"?"ArrowRight":e==="ArrowRight"?"ArrowLeft":e}nt(Fi,"getDirectionAwareKey");function $i(e,t,n){const r=Fi(e.key,n);if(!(t==="vertical"&&["ArrowLeft","ArrowRight"].includes(r))&&!(t==="horizontal"&&["ArrowUp","ArrowDown"].includes(r)))return qc[r]}nt($i,"getFocusIntent");function ar(e,t=!1){const n=document.activeElement;for(const r of e)if(r===n||(r.focus({preventScroll:t}),document.activeElement!==n))return}nt(ar,"focusFirst");function Bi(e,t){return e.map((n,r)=>e[(t+r)%e.length])}nt(Bi,"wrapArray");var Kc=zc,Yc=Wc,Xc=Object.defineProperty,H=(e,t)=>Xc(e,"name",{value:t,configurable:!0}),Qc=["Enter"," "],Zc=["ArrowDown","PageUp","Home"],Ui=["ArrowUp","PageDown","End"],Jc=[...Zc,...Ui],an="Menu",[Kn,eu,tu]=Ko(an),[rt,Hi]=_e(an,[tu,fi,Oi]),lr=fi(),zi=Oi(),[nu,Dt]=rt(an),[ru,cr]=rt(an),ou=H(e=>{const{__scopeMenu:t,open:n=!1,children:r,dir:o,onOpenChange:i,modal:l=!0}=e,c=lr(t),[u,f]=s.useState(null),g=s.useRef(!1),h=We(i),p=Jo(o);return s.useEffect(()=>{const v=H(()=>{g.current=!0,document.addEventListener("pointerdown",m,{capture:!0,once:!0}),document.addEventListener("pointermove",m,{capture:!0,once:!0})},"handleKeyDown"),m=H(()=>g.current=!1,"handlePointer");return document.addEventListener("keydown",v,{capture:!0}),()=>{document.removeEventListener("keydown",v,{capture:!0}),document.removeEventListener("pointerdown",m,{capture:!0}),document.removeEventListener("pointermove",m,{capture:!0})}},[]),s.useEffect(()=>{if(!n)return;const v=H(()=>h(!1),"handleBlur");return window.addEventListener("blur",v),()=>window.removeEventListener("blur",v)},[n,h]),a.jsx(hc,{...c,children:a.jsx(nu,{scope:t,open:n,onOpenChange:h,content:u,onContentChange:f,children:a.jsx(ru,{scope:t,onClose:s.useCallback(()=>h(!1),[h]),isUsingKeyboardRef:g,dir:p,modal:l,children:r})})})},"Menu"),iu=s.forwardRef(H(function(t,n){const{__scopeMenu:r,...o}=t,i=lr(r);return a.jsx(pc,{...i,...o,ref:n})},"MenuAnchor")),Vi="MenuPortal",[su,au]=rt(Vi,{forceMount:void 0}),lu=H(e=>{const{__scopeMenu:t,forceMount:n,children:r,container:o}=e,i=Dt(Vi,t);return a.jsx(su,{scope:t,forceMount:n,children:a.jsx(or,{present:n||i.open,children:a.jsx(yc,{asChild:!0,container:o,children:r})})})},"MenuPortal"),Ge="MenuContent",[cu,Gi]=rt(Ge),uu=s.forwardRef(H(function(t,n){const r=au(Ge,t.__scopeMenu),{forceMount:o=r.forceMount,...i}=t,l=Dt(Ge,t.__scopeMenu),c=cr(Ge,t.__scopeMenu);return a.jsx(Kn.Provider,{scope:t.__scopeMenu,children:a.jsx(or,{present:o||l.open,children:a.jsx(Kn.Slot,{scope:t.__scopeMenu,children:c.modal?a.jsx(du,{...i,ref:n}):a.jsx(fu,{...i,ref:n})})})})},"MenuContent")),du=s.forwardRef(H(function(t,n){const r=Dt(Ge,t.__scopeMenu),o=s.useRef(null),i=q(n,o);return s.useEffect(()=>{const l=o.current;if(l)return La(l)},[]),a.jsx(Wi,{...t,ref:i,trapFocus:r.open,disableOutsidePointerEvents:r.open,disableOutsideScroll:!0,onFocusOutside:U(t.onFocusOutside,l=>l.preventDefault(),{checkForDefaultPrevented:!1}),onDismiss:()=>r.onOpenChange(!1)})},"MenuRootContentModal")),fu=s.forwardRef(H(function(t,n){const r=Dt(Ge,t.__scopeMenu);return a.jsx(Wi,{...t,ref:n,trapFocus:!1,disableOutsidePointerEvents:!1,disableOutsideScroll:!1,onDismiss:()=>r.onOpenChange(!1)})},"MenuRootContentNonModal")),hu=pt("MenuContent.ScrollLock"),Wi=s.forwardRef(H(function(t,n){const{__scopeMenu:r,loop:o=!1,trapFocus:i,onOpenAutoFocus:l,onCloseAutoFocus:c,disableOutsidePointerEvents:u,onEntryFocus:f,onEscapeKeyDown:g,onPointerDownOutside:h,onFocusOutside:p,onInteractOutside:v,onDismiss:m,disableOutsideScroll:b,...w}=t,S=Dt(Ge,r),y=cr(Ge,r),x=lr(r),k=zi(r),R=eu(r),[P,M]=s.useState(null),I=s.useRef(null),T=q(n,I,S.onContentChange),K=s.useRef(0),z=s.useRef(""),j=s.useRef(0),O=s.useRef(null),G=s.useRef("right"),Z=s.useRef(0),le=b?Oa:s.Fragment,N=b?{as:hu,allowPinchZoom:!0}:void 0,xe=H(A=>{var fe,Oe;const J=z.current+A,ie=R().filter(se=>!se.disabled),Y=document.activeElement,Le=(fe=ie.find(se=>se.ref.current===Y))==null?void 0:fe.textValue,Pe=ie.map(se=>se.textValue),ue=Qi(Pe,J,Le),ke=(Oe=ie.find(se=>se.textValue===ue))==null?void 0:Oe.ref.current;H((function se(Ie){z.current=Ie,window.clearTimeout(K.current),Ie!==""&&(K.current=window.setTimeout(()=>se(""),1e3))}),"updateSearch")(J),ke&&setTimeout(()=>ke.focus())},"handleTypeaheadSearch");s.useEffect(()=>()=>window.clearTimeout(K.current),[]),nr();const L=s.useCallback(A=>{var ie,Y;return G.current===((ie=O.current)==null?void 0:ie.side)&&Ji(A,(Y=O.current)==null?void 0:Y.area)},[]);return a.jsx(cu,{scope:r,searchRef:z,onItemEnter:s.useCallback(A=>{L(A)&&A.preventDefault()},[L]),onItemLeave:s.useCallback(A=>{var J;L(A)||((J=I.current)==null||J.focus(),M(null))},[L]),onTriggerLeave:s.useCallback(A=>{L(A)&&A.preventDefault()},[L]),pointerGraceTimerRef:j,onPointerGraceIntentChange:s.useCallback(A=>{O.current=A},[]),children:a.jsx(le,{...N,children:a.jsx(Ql,{asChild:!0,trapped:i,onMountAutoFocus:U(l,A=>{var J;A.preventDefault(),(J=I.current)==null||J.focus({preventScroll:!0})}),onUnmountAutoFocus:c,children:a.jsx(Gl,{asChild:!0,disableOutsidePointerEvents:u,onEscapeKeyDown:g,onPointerDownOutside:h,onFocusOutside:p,onInteractOutside:v,onDismiss:m,children:a.jsx(Kc,{asChild:!0,...k,dir:y.dir,orientation:"vertical",loop:o,currentTabStopId:P,onCurrentTabStopIdChange:M,onEntryFocus:U(f,A=>{y.isUsingKeyboardRef.current||A.preventDefault()}),preventScrollOnEntryFocus:!0,children:a.jsx(mc,{role:"menu","aria-orientation":"vertical","data-state":Ki(S.open),"data-radix-menu-content":"",dir:y.dir,...x,...w,ref:T,style:{outline:"none",...w.style},onKeyDown:U(w.onKeyDown,A=>{const ie=A.target.closest("[data-radix-menu-content]")===A.currentTarget,Y=A.ctrlKey||A.altKey||A.metaKey,Le=A.key.length===1;ie&&(A.key==="Tab"&&A.preventDefault(),!Y&&Le&&xe(A.key));const Pe=I.current;if(A.target!==Pe||!Jc.includes(A.key))return;A.preventDefault();const ke=R().filter(fe=>!fe.disabled).map(fe=>fe.ref.current);Ui.includes(A.key)&&ke.reverse(),Yi(ke)}),onBlur:U(t.onBlur,A=>{A.currentTarget.contains(A.target)||(window.clearTimeout(K.current),z.current="")}),onPointerMove:U(t.onPointerMove,rn(A=>{const J=A.target,ie=Z.current!==A.clientX;if(A.currentTarget.contains(J)&&ie){const Y=A.clientX>Z.current?"right":"left";G.current=Y,Z.current=A.clientX}}))})})})})})})},"MenuContentImpl")),Yn="MenuItem",vo="menu.itemSelect",pu=s.forwardRef(H(function(t,n){const{disabled:r=!1,onSelect:o,...i}=t,l=s.useRef(null),c=cr(Yn,t.__scopeMenu),u=Gi(Yn,t.__scopeMenu),f=q(n,l),g=s.useRef(!1),h=H(()=>{const p=l.current;if(!r&&p){const v=new CustomEvent(vo,{bubbles:!0,cancelable:!0});p.addEventListener(vo,m=>o==null?void 0:o(m),{once:!0}),Zn(p,v),v.defaultPrevented?g.current=!1:c.onClose()}},"handleSelect");return a.jsx(mu,{...i,ref:f,disabled:r,onClick:U(t.onClick,h),onPointerDown:p=>{var v;(v=t.onPointerDown)==null||v.call(t,p),g.current=!0},onPointerUp:U(t.onPointerUp,p=>{var v;g.current||(v=p.currentTarget)==null||v.click()}),onKeyDown:U(t.onKeyDown,p=>{r||p.target!==p.currentTarget||u.searchRef.current!==""&&p.key===" "||Qc.includes(p.key)&&(p.currentTarget.click(),p.preventDefault())})})},"MenuItem")),mu=s.forwardRef(H(function(t,n){const{__scopeMenu:r,disabled:o=!1,textValue:i,...l}=t,c=Gi(Yn,r),u=zi(r),f=s.useRef(null),g=q(n,f),[h,p]=s.useState(!1),[v,m]=s.useState("");return s.useEffect(()=>{const b=f.current;b&&m((b.textContent??"").trim())},[l.children]),a.jsx(Kn.ItemSlot,{scope:r,disabled:o,textValue:i??v,children:a.jsx(Yc,{asChild:!0,...u,focusable:!o,children:a.jsx(Re.div,{role:"menuitem","data-highlighted":h?"":void 0,"aria-disabled":o||void 0,"data-disabled":o?"":void 0,...l,ref:g,onPointerMove:U(t.onPointerMove,rn(b=>{o?c.onItemLeave(b):(c.onItemEnter(b),b.defaultPrevented||b.currentTarget.focus({preventScroll:!0}))})),onPointerLeave:U(t.onPointerLeave,rn(b=>c.onItemLeave(b))),onFocus:U(t.onFocus,()=>p(!0)),onBlur:U(t.onBlur,()=>p(!1))})})})},"MenuItemImpl")),gu=s.forwardRef(H(function(t,n){const{checked:r=!1,onCheckedChange:o,...i}=t;return a.jsx(bu,{scope:t.__scopeMenu,checked:r,children:a.jsx(pu,{role:"menuitemcheckbox","aria-checked":jt(r)?"mixed":r,...i,ref:n,"data-state":ur(r),onSelect:U(i.onSelect,()=>o==null?void 0:o(jt(r)?!0:!r),{checkForDefaultPrevented:!1})})})},"MenuCheckboxItem")),vu="MenuRadioGroup",[xd,kd]=rt(vu,{value:void 0,onValueChange:H(()=>{},"onValueChange")}),qi="MenuItemIndicator",[bu,yu]=rt(qi,{checked:!1}),wu=s.forwardRef(H(function(t,n){const{__scopeMenu:r,forceMount:o,...i}=t,l=yu(qi,r);return a.jsx(or,{present:o||jt(l.checked)||l.checked===!0,children:a.jsx(Re.span,{...i,ref:n,"data-state":ur(l.checked)})})},"MenuItemIndicator")),xu="MenuSub",[Sd,Cd]=rt(xu);function Ki(e){return e?"open":"closed"}H(Ki,"getOpenState");function jt(e){return e==="indeterminate"}H(jt,"isIndeterminate");function ur(e){return jt(e)?"indeterminate":e?"checked":"unchecked"}H(ur,"getCheckedState");function Yi(e){const t=document.activeElement;for(const n of e)if(n===t||(n.focus(),document.activeElement!==t))return}H(Yi,"focusFirst");function Xi(e,t){return e.map((n,r)=>e[(t+r)%e.length])}H(Xi,"wrapArray");function Qi(e,t,n){const o=t.length>1&&Array.from(t).every(f=>f===t[0])?t[0]:t,i=n?e.indexOf(n):-1;let l=Xi(e,Math.max(i,0));o.length===1&&(l=l.filter(f=>f!==n));const u=l.find(f=>f.toLowerCase().startsWith(o.toLowerCase()));return u!==n?u:void 0}H(Qi,"getNextMatch");function Zi(e,t){const{x:n,y:r}=e;let o=!1;for(let i=0,l=t.length-1;i<t.length;l=i++){const c=t[i],u=t[l],f=c.x,g=c.y,h=u.x,p=u.y;g>r!=p>r&&n<(h-f)*(r-g)/(p-g)+f&&(o=!o)}return o}H(Zi,"isPointInPolygon");function Ji(e,t){if(!t)return!1;const n={x:e.clientX,y:e.clientY};return Zi(n,t)}H(Ji,"isPointerInGraceArea");function rn(e){return t=>t.pointerType==="mouse"?e(t):void 0}H(rn,"whenMouse");var ku=ou,Su=iu,Cu=lu,Eu=uu,Ru=gu,Pu=wu,Iu=Object.defineProperty,mt=(e,t)=>Iu(e,"name",{value:t,configurable:!0}),dr="DropdownMenu",[Tu,Ed]=_e(dr,[Hi]),gt=Hi(),[Au,es]=Tu(dr),Mu=mt(e=>{const{__scopeDropdownMenu:t,children:n,dir:r,open:o,defaultOpen:i,onOpenChange:l,modal:c=!0}=e,u=gt(t),f=s.useRef(null),[g,h]=Qn({prop:o,defaultProp:i??!1,onChange:l,caller:dr});return a.jsx(Au,{scope:t,triggerId:nn(),triggerRef:f,contentId:nn(),open:g,onOpenChange:h,onOpenToggle:s.useCallback(()=>h(p=>!p),[h]),modal:c,children:a.jsx(ku,{...u,open:g,onOpenChange:h,dir:r,modal:c,children:n})})},"DropdownMenu"),ju="DropdownMenuTrigger",Nu=s.forwardRef(mt(function(t,n){const{__scopeDropdownMenu:r,disabled:o=!1,...i}=t,l=es(ju,r),c=gt(r),u=q(n,l.triggerRef);return a.jsx(Su,{asChild:!0,...c,children:a.jsx(Re.button,{type:"button",id:l.triggerId,"aria-haspopup":"menu","aria-expanded":l.open,"aria-controls":l.open?l.contentId:void 0,"data-state":l.open?"open":"closed","data-disabled":o?"":void 0,disabled:o,...i,ref:u,onPointerDown:U(t.onPointerDown,f=>{!o&&f.button===0&&f.ctrlKey===!1&&(l.onOpenToggle(),l.open||f.preventDefault())}),onKeyDown:U(t.onKeyDown,f=>{o||(["Enter"," "].includes(f.key)&&l.onOpenToggle(),f.key==="ArrowDown"&&l.onOpenChange(!0),["Enter"," ","ArrowDown"].includes(f.key)&&f.preventDefault())})})})},"DropdownMenuTrigger")),Du=mt(e=>{const{__scopeDropdownMenu:t,...n}=e,r=gt(t);return a.jsx(Cu,{...r,...n})},"DropdownMenuPortal"),_u="DropdownMenuContent",Lu=s.forwardRef(mt(function(t,n){const{__scopeDropdownMenu:r,...o}=t,i=es(_u,r),l=gt(r),c=s.useRef(!1);return a.jsx(Eu,{id:i.contentId,"aria-labelledby":i.triggerId,...l,...o,ref:n,onCloseAutoFocus:U(t.onCloseAutoFocus,u=>{var f;c.current||(f=i.triggerRef.current)==null||f.focus(),c.current=!1,u.preventDefault()}),onInteractOutside:U(t.onInteractOutside,u=>{const f=u.detail.originalEvent,g=f.button===0&&f.ctrlKey===!0,h=f.button===2||g;(!i.modal||h)&&(c.current=!0)}),style:{...t.style,"--radix-dropdown-menu-content-transform-origin":"var(--radix-popper-transform-origin)","--radix-dropdown-menu-content-available-width":"var(--radix-popper-available-width)","--radix-dropdown-menu-content-available-height":"var(--radix-popper-available-height)","--radix-dropdown-menu-trigger-width":"var(--radix-popper-anchor-width)","--radix-dropdown-menu-trigger-height":"var(--radix-popper-anchor-height)"}})},"DropdownMenuContent")),Ou=s.forwardRef(mt(function(t,n){const{__scopeDropdownMenu:r,...o}=t,i=gt(r);return a.jsx(Ru,{...i,...o,ref:n})},"DropdownMenuCheckboxItem")),Fu=s.forwardRef(mt(function(t,n){const{__scopeDropdownMenu:r,...o}=t,i=gt(r);return a.jsx(Pu,{...i,...o,ref:n})},"DropdownMenuItemIndicator")),$u=Mu,Bu=Nu,Uu=Du,ts=Lu,ns=Ou,Hu=Fu;const zu=$u,Vu=Bu,Gu=e=>e.preventDefault(),rs=s.forwardRef(({className:e,align:t="start",...n},r)=>a.jsx(Uu,{children:a.jsx(ts,{ref:r,align:t,sideOffset:4,className:W("z-50 overflow-hidden rounded-md border border-border bg-surface p-1 shadow-lg",e),...n})}));rs.displayName=ts.displayName;const os=s.forwardRef(({className:e,children:t,onSelect:n,...r},o)=>a.jsxs(ns,{ref:o,onSelect:n??Gu,className:W("relative flex cursor-pointer select-none items-start rounded-sm py-1.5 pl-7 pr-3","text-[13px] text-fg outline-none data-[highlighted]:bg-surface-muted","data-[disabled]:pointer-events-none data-[disabled]:opacity-50",e),...r,children:[a.jsx("span",{className:"absolute left-2 top-2 flex h-3.5 w-3.5 items-center justify-center",children:a.jsx(Hu,{children:a.jsx(Us,{className:"h-3.5 w-3.5"})})}),t]}));os.displayName=ns.displayName;function Wu({url:e,isNew:t,visibility:n,onClose:r}){const o=s.useRef(null),i=s.useRef(null);s.useEffect(()=>{const c=i.current;c&&!c.contains(document.activeElement)&&c.focus()},[]);function l(c){if(c.key==="Escape"){r();return}if(c.key!=="Tab")return;const u=o.current;if(!u)return;const f=u.querySelectorAll(["a[href]","button:not([disabled])","input:not([disabled])","select:not([disabled])","textarea:not([disabled])",'[contenteditable="true"]','[tabindex]:not([tabindex="-1"])'].join(", "));if(f.length===0)return;const g=f[0],h=f[f.length-1],p=document.activeElement;c.shiftKey&&(p===g||!u.contains(p))?(c.preventDefault(),h.focus()):!c.shiftKey&&(p===h||!u.contains(p))&&(c.preventDefault(),g.focus())}return a.jsx("div",{ref:i,tabIndex:-1,className:"fixed inset-0 z-50 grid place-items-center bg-ink/45 p-4 backdrop-blur-sm focus:outline-none",role:"dialog","aria-modal":"true","aria-labelledby":"publish-success-title",onKeyDown:l,onMouseDown:c=>{c.target===c.currentTarget&&r()},children:a.jsxs("div",{ref:o,className:"w-full max-w-md rounded-lg border border-border bg-surface shadow-lg",children:[a.jsxs("div",{className:"flex flex-col items-center gap-2 px-6 pt-6 text-center",children:[a.jsx(Hs,{className:"h-10 w-10 text-success"}),a.jsx("div",{id:"publish-success-title",className:"text-[15px] font-semibold text-fg",children:t?"Page published":"Update published"}),a.jsx("p",{className:"text-[12px] text-fg-2",children:t?n==="private"?"Your page is live. Only you and the people you added can open it.":"Your page is live. Anyone with the link can view it.":"The live page now shows your latest changes."})]}),a.jsx("div",{className:"px-6 py-4",children:a.jsx($a,{url:e})}),a.jsx("div",{className:"flex justify-end border-t border-border px-6 py-3",children:a.jsx(ze,{autoFocus:!0,onClick:r,children:"Done"})})]})})}function qu({initialAlias:e,busy:t,onCancel:n,onPublish:r}){const[o,i]=s.useState(e),[l,c]=s.useState("public"),[u,f]=s.useState([]),g=s.useRef(null),h=s.useRef(null);s.useEffect(()=>{const v=h.current;v&&!v.contains(document.activeElement)&&v.focus()},[]);function p(v){if(v.key==="Escape"){n();return}if(v.key!=="Tab")return;const m=g.current;if(!m)return;const b=m.querySelectorAll(["a[href]","button:not([disabled])","input:not([disabled])","select:not([disabled])","textarea:not([disabled])",'[contenteditable="true"]','[tabindex]:not([tabindex="-1"])'].join(", "));if(b.length===0)return;const w=b[0],S=b[b.length-1],y=document.activeElement;v.shiftKey&&(y===w||!m.contains(y))?(v.preventDefault(),S.focus()):!v.shiftKey&&(y===S||!m.contains(y))&&(v.preventDefault(),w.focus())}return a.jsx("div",{ref:h,tabIndex:-1,className:"fixed inset-0 z-50 grid place-items-center bg-ink/45 p-4 backdrop-blur-sm focus:outline-none",role:"dialog","aria-modal":"true","aria-labelledby":"pre-publish-title",onKeyDown:p,onMouseDown:v=>{v.target===v.currentTarget&&!t&&n()},children:a.jsxs("div",{ref:g,className:"w-full max-w-md rounded-lg border border-border bg-surface shadow-lg",children:[a.jsxs("div",{className:"border-b border-border px-6 py-4",children:[a.jsx("div",{id:"pre-publish-title",className:"text-[15px] font-semibold text-fg",children:"Publish app"}),a.jsx("p",{className:"mt-1 text-[12px] text-fg-2",children:"Choose the address and who can open it. You can change both later from Apps."})]}),a.jsxs("div",{className:"space-y-4 px-6 py-4",children:[a.jsxs("div",{children:[a.jsx(Yr,{htmlFor:"publish-alias",hint:"optional — leave blank for a UUID URL",children:"Alias"}),a.jsx(Fa,{id:"publish-alias",autoFocus:!0,value:o,disabled:t,onChange:v=>i(v.target.value.toLowerCase()),placeholder:"my-app"}),a.jsxs("div",{className:"mt-1 font-mono text-[11px] text-fg-3",children:["/p/",o.trim()||"<uuid>"]})]}),a.jsxs("div",{children:[a.jsx(Yr,{children:"Who can open it"}),a.jsx(Ba,{visibility:l,onVisibilityChange:c,grants:u,onGrantsChange:f,disabled:t})]})]}),a.jsxs("div",{className:"flex justify-end gap-2 border-t border-border px-6 py-3",children:[a.jsx(ze,{variant:"secondary",onClick:n,disabled:t,children:"Cancel"}),a.jsxs(ze,{onClick:()=>r({alias:o.trim(),visibility:l,grants:u}),disabled:t,children:[a.jsx(Eo,{className:"h-3.5 w-3.5"}),t?"Publishing…":"Publish"]})]})]})})}function Ku(e,t){return tn({queryKey:["page-history",e],queryFn:()=>ht.getPageHistory(e).then(n=>n.versions),enabled:t,retry:!1})}function bo(e,t){return tn({queryKey:["page-history-version",e,t],queryFn:()=>ht.getPageHistoryVersion(e,t).then(n=>n.html),enabled:t!==null,retry:!1})}function Yu({entries:e,isLoading:t,isError:n,isFetching:r,selectedSha:o,onSelect:i,onRefresh:l}){return a.jsxs(a.Fragment,{children:[a.jsxs("div",{className:"flex items-center gap-1.5 border-b border-border px-3 py-2.5 text-[12px] font-semibold text-fg",children:[a.jsx(Ro,{className:"h-3.5 w-3.5 text-fg-3"}),a.jsx("span",{className:"flex-1",children:"Version history"}),a.jsx("button",{type:"button",onClick:l,disabled:r,title:"Refresh — GitHub sync runs in the background, so a just-published version can take a moment to appear",className:"font-normal text-fg-3 hover:text-fg disabled:opacity-50",children:"Refresh"})]}),a.jsxs("div",{className:"scroll-slim flex-1 overflow-y-auto p-1.5",children:[t?a.jsx("div",{className:"px-2 py-2 text-[12px] text-fg-3",children:"Loading…"}):null,n?a.jsx("div",{className:"px-2 py-2 text-[12px] text-no-strong",children:"Failed to load history."}):null,e&&e.length===0?a.jsx("div",{className:"px-2 py-2 text-[12px] text-fg-3",children:"No published versions yet."}):null,(e??[]).map(c=>{const u=c.sha===o;return a.jsxs("button",{type:"button",onClick:()=>i(c),className:W("block w-full rounded-md px-2.5 py-2 text-left",u?"bg-ink":"hover:bg-surface-muted"),children:[a.jsx("div",{className:W("text-[12px] font-medium",u?"text-white":"text-fg"),children:new Date(c.committed_at).toLocaleString()}),a.jsxs("div",{className:W("truncate text-[11px]",u?"text-white/70":"text-fg-3"),children:[c.message,c.author_email?` — ${c.author_email}`:""]})]},c.sha)})]})]})}function Xu({entry:e,canRestore:t,onRestore:n,onExit:r}){const o=So();return a.jsxs("div",{className:"flex items-center gap-2 border-b border-border bg-surface-muted px-3 py-2 text-[12px]",children:[a.jsx("div",{className:"min-w-0 flex-1 truncate text-fg-2",children:e?a.jsxs(a.Fragment,{children:["Viewing version from ",new Date(e.committed_at).toLocaleString(),e.author_email?` (${e.author_email})`:""," — read-only"]}):"Select a version from the list to preview it"}),a.jsxs(ze,{variant:"secondary",size:"sm",onClick:r,children:[a.jsx(zs,{className:"h-3.5 w-3.5"})," Back to current draft"]}),a.jsx(ze,{size:"sm",disabled:!t,onClick:async()=>{await o({title:"Restore this version",body:"This replaces your current editor content. Unsaved changes will be lost. The page stays unpublished until you publish again.",confirmLabel:"Restore",variant:"danger"})&&n()},children:"Restore this version"})]})}class Qu{diff(t,n,r={}){let o;typeof r=="function"?(o=r,r={}):"callback"in r&&(o=r.callback);const i=this.castInput(t,r),l=this.castInput(n,r),c=this.removeEmpty(this.tokenize(i,r)),u=this.removeEmpty(this.tokenize(l,r));return this.diffWithOptionsObj(c,u,r,o)}diffWithOptionsObj(t,n,r,o){var i;const l=y=>{if(y=this.postProcess(y,r),o){setTimeout(function(){o(y)},0);return}else return y},c=n.length,u=t.length;let f=1,g=c+u;r.maxEditLength!=null&&(g=Math.min(g,r.maxEditLength));const h=(i=r.timeout)!==null&&i!==void 0?i:1/0,p=Date.now()+h,v=[{oldPos:-1,lastComponent:void 0}];let m=this.extractCommon(v[0],n,t,0,r);if(v[0].oldPos+1>=u&&m+1>=c)return l(this.buildValues(v[0].lastComponent,n,t));let b=-1/0,w=1/0;const S=()=>{for(let y=Math.max(b,-f);y<=Math.min(w,f);y+=2){let x;const k=v[y-1],R=v[y+1];k&&(v[y-1]=void 0);let P=!1;if(R){const I=R.oldPos-y;P=R&&0<=I&&I<c}const M=k&&k.oldPos+1<u;if(!P&&!M){v[y]=void 0;continue}if(!M||P&&k.oldPos<R.oldPos?x=this.addToPath(R,!0,!1,0,r):x=this.addToPath(k,!1,!0,1,r),m=this.extractCommon(x,n,t,y,r),x.oldPos+1>=u&&m+1>=c)return l(this.buildValues(x.lastComponent,n,t))||!0;v[y]=x,x.oldPos+1>=u&&(w=Math.min(w,y-1)),m+1>=c&&(b=Math.max(b,y+1))}f++};if(o)(function y(){setTimeout(function(){if(f>g||Date.now()>p)return o(void 0);S()||y()},0)})();else for(;f<=g&&Date.now()<=p;){const y=S();if(y)return y}}addToPath(t,n,r,o,i){const l=t.lastComponent;return l&&!i.oneChangePerToken&&l.added===n&&l.removed===r?{oldPos:t.oldPos+o,lastComponent:{count:l.count+1,added:n,removed:r,previousComponent:l.previousComponent}}:{oldPos:t.oldPos+o,lastComponent:{count:1,added:n,removed:r,previousComponent:l}}}extractCommon(t,n,r,o,i){const l=n.length,c=r.length;let u=t.oldPos,f=u-o,g=0;for(;f+1<l&&u+1<c&&this.equals(r[u+1],n[f+1],i);)f++,u++,g++,i.oneChangePerToken&&(t.lastComponent={count:1,previousComponent:t.lastComponent,added:!1,removed:!1});return g&&!i.oneChangePerToken&&(t.lastComponent={count:g,previousComponent:t.lastComponent,added:!1,removed:!1}),t.oldPos=u,f}equals(t,n,r){return r.comparator?r.comparator(t,n):t===n||!!r.ignoreCase&&t.toLowerCase()===n.toLowerCase()}removeEmpty(t){const n=[];for(let r=0;r<t.length;r++)t[r]&&n.push(t[r]);return n}castInput(t,n){return t}tokenize(t,n){return Array.from(t)}join(t){return t.join("")}postProcess(t,n){return t}get useLongestToken(){return!1}buildValues(t,n,r){const o=[];let i;for(;t;)o.push(t),i=t.previousComponent,delete t.previousComponent,t=i;o.reverse();const l=o.length;let c=0,u=0,f=0;for(;c<l;c++){const g=o[c];if(g.removed)g.value=this.join(r.slice(f,f+g.count)),f+=g.count;else{if(!g.added&&this.useLongestToken){let h=n.slice(u,u+g.count);h=h.map(function(p,v){const m=r[f+v];return m.length>p.length?m:p}),g.value=this.join(h)}else g.value=this.join(n.slice(u,u+g.count));u+=g.count,g.added||(f+=g.count)}}return o}}class Zu extends Qu{constructor(){super(...arguments),this.tokenize=td}equals(t,n,r){return r.ignoreWhitespace?((!r.newlineIsToken||!t.includes(`
`))&&(t=t.trim()),(!r.newlineIsToken||!n.includes(`
`))&&(n=n.trim())):r.ignoreNewlineAtEof&&!r.newlineIsToken&&(t.endsWith(`
`)&&(t=t.slice(0,-1)),n.endsWith(`
`)&&(n=n.slice(0,-1))),super.equals(t,n,r)}}const Ju=new Zu;function ed(e,t,n){return Ju.diff(e,t,n)}function td(e,t){t.stripTrailingCr&&(e=e.replace(/\r\n/g,`
`));const n=[],r=e.split(/(\n|\r\n)/);r[r.length-1]||r.pop();for(let o=0;o<r.length;o++){const i=r[o];o%2&&!t.newlineIsToken?n[n.length-1]+=i:n.push(i)}return n}function nd(e,t){const n=[];let r=0;for(const o of ed(e,t)){const i=o.added?"added":o.removed?"removed":"context",l=o.value.split(`
`);l.length>0&&l[l.length-1]===""&&l.pop();for(const c of l)n.push({key:r++,kind:i,text:c})}return n}function Dn({oldText:e,newText:t,oldLabel:n,newLabel:r}){const o=s.useMemo(()=>nd(e,t),[e,t]),i=o.every(l=>l.kind==="context");return a.jsxs("div",{className:"flex h-full min-h-0 flex-col overflow-hidden",children:[a.jsxs("div",{className:"flex items-center gap-3 border-b border-border bg-surface-muted px-3 py-1.5 text-[11px]",children:[a.jsxs("span",{className:"text-no-strong",children:["− ",n]}),a.jsxs("span",{className:"text-success",children:["+ ",r]})]}),a.jsx("div",{className:"scroll-slim flex-1 overflow-auto",children:i?a.jsx("div",{className:"p-4 text-[12px] text-fg-3",children:"No differences."}):a.jsx("div",{className:"min-w-max font-mono text-[12px] leading-5",children:o.map(l=>a.jsxs("div",{className:W("flex whitespace-pre px-3",l.kind==="added"&&"bg-status-soft",l.kind==="removed"&&"bg-no-soft",l.kind==="context"&&"text-fg-2"),children:[a.jsx("span",{className:W("mr-2 shrink-0 select-none",l.kind==="added"&&"text-success",l.kind==="removed"&&"text-no-strong",l.kind==="context"&&"text-fg-3"),children:l.kind==="added"?"+":l.kind==="removed"?"−":" "}),a.jsx("span",{children:l.text||" "})]},l.key))})})]})}const rd=s.lazy(()=>Ms(()=>import("./CodeEditor-CpBk1YCX.js"),__vite__mapDeps([0,1,2,3,4,5]),import.meta.url).then(e=>({default:e.CodeEditor}))),dt=`<!doctype html>
<html lang="en">
<head>
<meta charset="utf-8">
...
`,At=[];function yo(e){return e<1e3?String(e):e<1e6?`${(e/1e3).toFixed(e<1e4?1:0)}k`:`${(e/1e6).toFixed(2)}M`}function od(e,t,n){const r=JSON.stringify(e).length,o=t.reduce((i,l)=>{var c,u;return i+(l.kind==="inline"?((c=l.data)==null?void 0:c.length)??0:((u=l.text)==null?void 0:u.length)??0)},0);return r+o+n.length}const id=["off","low","medium","high"],is="medium",wo={off:0,low:4096,medium:12288,high:24576};function xo(e,t){let n=wo[e]??wo[is];return e==="off"&&t.includes("pro")&&(n=128),{thinkingConfig:{thinkingBudget:n,...e==="off"?{}:{includeThoughts:!0}}}}const sd=.75,ad=.85,ko=[{name:"compact",aliases:["compress"],hint:"[focus instructions]",description:"Summarize the conversation to free up context"}];function ld(e,t,n){if(n){const r=Math.max(0,Math.ceil((n.deadline-Date.now())/1e3));return`rate-limited — retry ${n.attempt} of ${n.max} in ${r}s…`}if(e)switch(e.name){case"write":return"writing the page…";case"edit":return"editing the page…";case"read":return`reading the page${e.detail?` (${e.detail})`:""}…`;case"grep":return`searching the page${e.detail?` for “${e.detail}”`:""}…`;case"console":return"checking the console…";case"skill":return e.detail?`loading the ${e.detail} skill…`:"loading a skill…";case"action":return`running ${e.detail??"an action"}…`;case"web_search":return e.detail?`searching the web for “${e.detail}”…`:"searching the web…";case"database":return"updating the database…";default:return`using ${e.name}…`}return t>=10?`working… (${t}s — large edits can take a minute)`:t>=3?`working… (${t}s)`:"working…"}function cd(e){return a.jsxs("div",{children:[a.jsx("div",{className:"flex items-center gap-1.5 text-[11px] text-fg-3",children:e.name==="screenshot"?a.jsxs(a.Fragment,{children:[a.jsx(ea,{className:"h-3 w-3 text-fg-3"}),a.jsx("span",{children:"looked at the page"})]}):e.name==="write"||e.name==="edit"?a.jsxs(a.Fragment,{children:[a.jsx(Io,{className:"h-3 w-3 text-fg-3"}),a.jsx("span",{children:"edited the page"})]}):e.name==="skill"?a.jsxs(a.Fragment,{children:[a.jsx(Po,{className:"h-3 w-3 text-fg-3"}),a.jsxs("span",{children:["loaded the ",a.jsx("span",{className:"font-medium text-fg-2",children:e.detail??"unknown"})," skill"]})]}):e.name==="action"?a.jsxs(a.Fragment,{children:[a.jsx(Vr,{className:"h-3 w-3 text-fg-3"}),a.jsxs("span",{children:["ran ",a.jsx("span",{className:"font-medium text-fg-2",children:e.detail??"an action"})]})]}):e.name==="console"?a.jsxs(a.Fragment,{children:[a.jsx(Vr,{className:"h-3 w-3 text-fg-3"}),a.jsx("span",{children:"checked the console"})]}):e.name==="grep"?a.jsxs(a.Fragment,{children:[a.jsx(ta,{className:"h-3 w-3 text-fg-3"}),a.jsxs("span",{children:["searched the page",e.detail?a.jsxs(a.Fragment,{children:[" for ",a.jsx("span",{className:"max-w-[16rem] truncate font-medium text-fg-2",children:e.detail})]}):null]})]}):e.name==="database"?a.jsxs(a.Fragment,{children:[a.jsx(na,{className:"h-3 w-3 text-fg-3"}),a.jsxs("span",{children:["updated the database",e.detail?` (${e.detail})`:""]})]}):e.name==="read"?a.jsxs(a.Fragment,{children:[a.jsx(ra,{className:"h-3 w-3 text-fg-3"}),a.jsxs("span",{children:["read the page",e.detail?` (${e.detail})`:""]})]}):a.jsxs(a.Fragment,{children:[a.jsx(To,{className:"h-3 w-3"}),a.jsxs("span",{children:["used ",a.jsx("span",{className:"font-medium text-fg-2",children:e.name}),e.detail?` (${e.detail})`:""]})]})}),e.name==="screenshot"&&e.imageUrl?a.jsx("img",{src:e.imageUrl,alt:"screenshot of the live preview",className:"mt-1.5 max-h-48 max-w-full rounded-md border border-border"}):null]})}function Rd(){var i;const{id:e}=Ua(),n=((i=Ha().state)==null?void 0:i.publishContinuation)===!0,r=s.useRef(0),o=s.useRef(e);return!n&&e!==o.current&&(r.current+=1),o.current=e,a.jsx(ud,{pageId:e??null},r.current)}function ud({pageId:e}){var Dr,_r,Lr,Or,Fr,$r;const t=e??"draft",n=za(),r=oa(),o=So(),[i,l]=s.useState(!1),[c,u]=s.useState(dt),[f,g]=s.useState(At),[h,p]=s.useState(""),[v,m]=s.useState(is),[b,w]=s.useState([]),S=s.useRef(null),[y,x]=s.useState(""),[k,R]=s.useState([]),[P,M]=s.useState(!1),[I,T]=s.useState(!1),[K,z]=s.useState(""),[j,O]=s.useState(""),[G,Z]=s.useState(null),[le,N]=s.useState(0),[xe,L]=s.useState(null),[A,J]=s.useState(!1),[ie,Y]=s.useState(null),[Le,Pe]=s.useState(null),[ue,ke]=s.useState(!1),[fe,Oe]=s.useState("desktop"),[se,Ie]=s.useState("code"),[vt,ot]=s.useState(null),it=e!=null&&vt!=null,[bt,Se]=s.useState(null);s.useEffect(()=>{ue||Ie("code")},[ue]);const[_t,ln]=s.useState(""),[yt,wt]=s.useState(null),[cn,Ke]=s.useState("public"),[xt,un]=s.useState(null),[ss,dn]=s.useState(!1),[as,fr]=s.useState(!1),[Lt,Ot]=s.useState(0),[hr,ls]=s.useState(0),st=s.useMemo(()=>URL.createObjectURL(new Blob([so(c,{screenshot:!0})],{type:"text/html"})),[c,hr]),Ft=s.useRef(null);s.useEffect(()=>{Ft.current&&Ft.current!==st&&URL.revokeObjectURL(Ft.current),Ft.current=st},[st]);const[B,pr]=s.useState(!1),[ee,$t]=s.useState(null),de=Ku(e??"",!!e),ae=bo(e??"",B?(ee==null?void 0:ee.sha)??null:null);s.useEffect(()=>{!B||!de.data||(ee&&!de.data.some(d=>d.sha===ee.sha)?$t(de.data[0]??null):!ee&&de.data.length>0&&$t(de.data[0]))},[B,ee,de.data]);function Bt(){pr(!1),$t(null),fn("preview"),hn("previous")}const[Te,fn]=s.useState("preview"),[Fe,hn]=s.useState("previous"),mr=B&&ee&&de.data?de.data.findIndex(d=>d.sha===ee.sha):-1,kt=mr>=0?((Dr=de.data)==null?void 0:Dr[mr+1])??null:null,Ut=bo(e??"",B&&Te==="diff"&&Fe==="previous"?(kt==null?void 0:kt.sha)??null:null),[gr,vr]=s.useState(!1),pn=s.useRef(null);s.useEffect(()=>()=>{pn.current&&clearTimeout(pn.current)},[]);function cs(){gr||(vr(!0),de.refetch().finally(()=>{pn.current=setTimeout(()=>vr(!1),2e3)}))}const St=s.useMemo(()=>ae.data===void 0?null:URL.createObjectURL(new Blob([so(ae.data)],{type:"text/html"})),[ae.data]),Ht=s.useRef(null);s.useEffect(()=>{Ht.current&&Ht.current!==St&&URL.revokeObjectURL(Ht.current),Ht.current=St},[St]);const zt=s.useRef(null),mn=s.useRef([]),br=s.useRef(0);s.useEffect(()=>{mn.current=[],br.current=Date.now()},[st]);const us=s.useRef(0),Ct=s.useRef(new Map),gn=s.useRef(!1),yr=s.useRef(B);s.useEffect(()=>{yr.current=B},[B]),s.useEffect(()=>{gn.current=!1;const d=Ct.current;d.forEach(C=>{window.clearTimeout(C.timer),C.reject(new Error("the live preview reloaded — read the page again before acting on it"))}),d.clear()},[st,ue,B]),s.useEffect(()=>{function d(C){var D;if(C.source!==((D=zt.current)==null?void 0:D.contentWindow))return;const E=C.data;if(!E)return;if(E.type==="aero-dom-ready"){gn.current=!0;return}if(E.type==="aero-dom-op-result"&&typeof E.id=="number"){const V=Ct.current.get(E.id);if(!V)return;Ct.current.delete(E.id),window.clearTimeout(V.timer);const oe=typeof E.generation=="number"?E.generation:null;V.resolve(E.ok?{ok:!0,result:E.result,generation:oe}:{ok:!1,error:E.error||"the action failed",generation:oe});return}if(E.type!=="aero-console"||typeof E.ts=="number"&&E.ts<br.current)return;const F=E.level==="info"||E.level==="warn"||E.level==="error"?E.level:"log",_=mn.current;_.push({level:F,text:typeof E.text=="string"?E.text:"",ts:E.ts??Date.now()}),_.length>300&&_.splice(0,_.length-300)}return window.addEventListener("message",d),()=>window.removeEventListener("message",d)},[]);async function ds(d,C,E){var oe;yr.current&&Bt(),ke(!1);const F=Date.now()+1e4;for(;!gn.current||!((oe=zt.current)!=null&&oe.contentWindow);){if(Date.now()>F)return{ok:!1,error:"the live preview did not finish loading",generation:null};await new Promise(Pt=>setTimeout(Pt,50))}const _=zt.current.contentWindow,D=++us.current,V=d==="screenshot"?3e4:15e3;return new Promise(Pt=>{const Is=window.setTimeout(()=>{Ct.current.delete(D),Pt({ok:!1,error:"the live preview did not respond — read the page again and retry",generation:null})},V);Ct.current.set(D,{resolve:Pt,reject:Ts=>Pt({ok:!1,error:Ts.message,generation:null}),timer:Is}),_.postMessage({type:"aero-dom-op",id:D,op:d,args:C,generation:E},"*")})}const ge=s.useRef(c),Ae=d=>{ge.current=d,u(d)},Me=s.useRef(dt),$e=s.useRef(null),Vt=s.useRef(At),vn=s.useRef(null),wr=s.useRef(null),xr=s.useRef(null),Ye=s.useRef(null),bn=s.useRef(Mo);s.useEffect(()=>{let d=!0;return aa().then(C=>ro(C).then(E=>{d&&(bn.current=E)})).catch(()=>{}),la().then(C=>ro(C).then(E=>{d&&(bn.current=E)})).catch(()=>{}),()=>{d=!1}},[]);const ve=tn({queryKey:["ai-models"],queryFn:ja,staleTime:300*1e3,retry:!1}),kr=tn({queryKey:["zen-models"],queryFn:Na,staleTime:300*1e3,retry:!1}),Xe=kr.data??[],Be=!ve.isPending&&!kr.isPending,fs=!!((_r=ve.data)!=null&&_r.project_id),Qe=Xe.find(d=>d.id===h),at=!!h&&ca(h)==="zen",Et=ua(h),Ze=at?da((Qe==null?void 0:Qe.reasoning_efforts)??[]):[...id],hs=Ze.join(",");s.useEffect(()=>{!Be||Ze.length===0||Ze.includes(v)||m("off")},[hs,v,Be]),s.useEffect(()=>{var d;!Be||h||p(fa(((d=ve.data)==null?void 0:d.models)??[],Xe))},[Be,h]);const Ce=!!h&&(!Be||(((Lr=ve.data)==null?void 0:Lr.models)??[]).includes(h)||Xe.some(d=>d.id===h));s.useEffect(()=>{let d=!1;return ot(null),Se(null),S.current=null,$e.current=null,(async()=>{const C=await Wr(t).catch(()=>{});if(d)return;let E=At;if(C&&(Ae(C.html),Me.current=C.html,E=ha(C.contents),g(E),Vt.current=E,Ot(qr(E)),C.model&&p(C.model),C.thinking&&m(C.thinking),w(C.disabledTools??[]),S.current=C.zenSessionId??null),e)try{const F=await ht.getPage(e);if(d)return;wt(F.url),Ke(As(F.visibility)),ot(F.html),$e.current=F.updated_at;const{html:_,supersededLocal:D}=tl(C,F);Ae(_),Me.current=_,C&&D!==null&&(Se(D),Wt({...C,html:_,contents:E,basedOnUpdatedAt:F.updated_at,updatedAt:0}).catch(()=>{}))}catch{d||L("Failed to load page.")}d||l(!0)})(),()=>{d=!0}},[t]);const Je=s.useRef(Date.now());s.useEffect(()=>{if(!I)return;Je.current=Date.now(),N(0);const d=setInterval(()=>N(Math.round((Date.now()-Je.current)/1e3)),1e3);return()=>clearInterval(d)},[I]);const Sr=()=>{if(at)return S.current??(S.current=crypto.randomUUID()),S.current},Ue=(d,C=b)=>{const E=ge.current;return Wt({key:t,pageId:e,html:E,contents:d,model:h||null,thinking:v,disabledTools:C,zenSessionId:S.current??void 0,basedOnUpdatedAt:$e.current??void 0,updatedAt:0}).then(()=>{Me.current=E,Vt.current=d}).catch(()=>{})},lt=s.useRef({sessionKey:t,pageId:e,contents:f,model:h,thinking:v,disabledTools:b});lt.current={sessionKey:t,pageId:e,contents:f,model:h,thinking:v,disabledTools:b};const Cr=s.useRef(I);Cr.current=I,s.useEffect(()=>()=>{if(ge.current===Me.current&&lt.current.contents===Vt.current)return;const{sessionKey:d,pageId:C,contents:E,model:F,thinking:_,disabledTools:D}=lt.current;Wt({key:d,pageId:C,html:ge.current,contents:E,model:F||null,thinking:_,disabledTools:D,zenSessionId:S.current??void 0,basedOnUpdatedAt:$e.current??void 0,updatedAt:0}).catch(()=>{})},[]);const Er=!at,ps=Er&&(k.length>0||f.some(d=>d.parts.some(C=>C.inlineData))),ct=s.useMemo(()=>od(f,k,y),[f,k,y]),Rr=Er&&ct>Tt,Pr=ct/Tt>=sd,Ir=Lt/Et>=ad,Tr=Math.max(0,100-Math.round(Lt/Et*100)),Ar=Et>=1e6?`${Math.round(Et/1e6)}M`:`${Math.round(Et/1e3)}K`;async function ms(){var V;const d=y.trim();if(!d&&k.length===0||I||!Ce)return;if(Rr){L(`This message is too large to send (~${tt(ct)} — Gemini's inline-request limit is ~${tt(Tt)}). Remove an attachment, or run /compact first.`);return}if(d.startsWith("/")){const oe=d.split(/\s+/)[0];if(!ya(ko,oe)){L(`Unknown command: ${oe} — available: /compact`);return}}const C=wa(d);if(C){x(""),await vs(C.instructions);return}const E=[xa()];for(const oe of k)E.push(ka(oe.name,oe.mimeType)),E.push(oe.kind==="inline"?{inlineData:{mimeType:oe.mimeType,data:oe.data??""}}:{text:oe.text??""});d&&E.push({text:d});const F=/\b(slides?|decks?|presentations?|powerpoint|pptx?|pitch(?:es)?)\b/i.test(d),_=/\bdeck-container\b|class="slide slide--/.test(ge.current);ge.current===dt?E.push(En(`The HTML document is still the untouched blank starter template — it contains no user content. Do not call \`read\` on it. If this message is a change request, load the \`${F?"aero-slides":"aero-app-style"}\` skill, then write the first draft directly with \`write\`.`)):_?E.push(En("The current document is an aero slide deck. Load the `aero-slides` skill (if not already loaded in this conversation) and follow its layout catalogue and navigation engine when editing.")):F&&E.push(En("This request is about a slide deck / presentation. Load the `aero-slides` skill before making changes, and follow its layout catalogue and navigation engine."));const D=[...f,{role:"user",parts:E}];(V=vn.current)==null||V.followOutput(),g(D),x(""),R([]),rl(),await Mr(D)}async function Mr(d){const C=new AbortController;Ye.current=C,T(!0),z(""),O(""),L(null),J(!1),Y(null);const E=Date.now(),F=Sr();try{const _=await Ia({model:h,contents:d,html:()=>ge.current,skills:bn.current,pageId:e,consoleLogs:()=>mn.current,domOp:ds,generationConfig:xo(v,h),thinking:v,zenModelInfo:Qe,zenSession:F,hasGoogleProject:fs,disabledTools:b,signal:C.signal,callbacks:{onText:D=>{Je.current=Date.now(),Y(null),z(V=>V+D)},onThought:D=>{Je.current=Date.now(),Y(null),O(V=>V+D)},onUsage:D=>{const V=D.totalTokenCount??D.promptTokenCount;typeof V=="number"&&Ot(V)},onTool:(D,V)=>{Je.current=Date.now(),Y(null),Z({name:D,detail:V})},onHtml:D=>Ae(D),onContents:D=>{Je.current=Date.now(),Z(null),g(D),z(""),O("")},onRetry:(D,V,oe)=>{Je.current=Date.now(),Y({attempt:D,max:V,deadline:Date.now()+oe*1e3})}}});g(_),await Ue(_),Date.now()-E>1e4&&io({ok:!0})}catch(_){if(_ instanceof DOMException&&_.name==="AbortError")await Ue(lt.current.contents);else{const D=_ instanceof et?Ta(_.body):null,V=_ instanceof et?_.message==="reauth_required"?"Your Google credential has expired or is invalid. Sign out and sign in again to reconnect.":D?D.message:`AI request failed: ${_.message}`:"AI request failed.";D&&Pe(D),L(V),J(!(_ instanceof et&&_.message==="reauth_required")),io({ok:!1,error:V}),await Ue(d)}}finally{Ye.current===C&&(Ye.current=null),T(!1),z(""),O(""),Z(null),Y(null)}}function gs(){var d;(d=Ye.current)==null||d.abort()}async function Gt(){var d;I||!Ce||f.length===0||((d=vn.current)==null||d.followOutput(),await Mr(f))}async function vs(d){if(I||!Ce)return;if(f.length===0){L("Nothing to compact — the conversation is empty.");return}const C=new AbortController;Ye.current=C,T(!0),fr(!0),L(null);try{const E=await Aa({model:h,contents:f,instructions:d||void 0,generationConfig:xo("off",h),zenSession:Sr(),signal:C.signal});await ut(Ma(E))}catch(E){E instanceof DOMException&&E.name==="AbortError"||L(E instanceof et?`Compaction failed: ${E.message}`:"Compaction failed.")}finally{Ye.current===C&&(Ye.current=null),T(!1),fr(!1)}}async function ut(d){g(d),Ot(qr(d)),await Ue(d)}async function bs(d){if(I)return;const C=f;if(!(!await o({title:"Delete from history?",body:d.kind==="tool"||d.kind==="grouped-search"?`Removes ${d.refs.length===1?"this tool call and its result":`these ${d.refs.length} tool calls and their results`} from the context sent to the model. The page itself is not affected.`:d.kind==="thought"?"Clears this reasoning from the context sent to the model. The page itself is not affected.":"Removes this record from the context sent to the model. The page itself is not affected.",confirmLabel:"Delete",variant:"danger"})||Cr.current||lt.current.contents!==C))switch(d.kind){case"user":case"compact":await ut(Ra(f,d.contentIndex));break;case"thought":await ut(Ea(f,d.refs));break;case"tool":case"grouped-search":await ut(Ca(f,d.refs));break;case"assistant":await ut(Sa(f,d.refs));break}}async function ys(d,C){I||d.kind!=="user"&&d.kind!=="assistant"||lt.current.contents===f&&await ut(Pa(f,d.refs,C))}const Rt=ia({mutationFn:async d=>{const C=ge.current;if(e){const F=await ht.patchPage(e,{html:C});return{id:e,isNew:!1,url:null,html:C,visibility:cn,updatedAt:F.updated_at}}const E=await ht.createPage(C,{alias:(d==null?void 0:d.alias)||null,visibility:(d==null?void 0:d.visibility)??"public",grants:(d==null?void 0:d.grants)??[]});return{id:E.id,isNew:!0,url:E.url,html:C,visibility:(d==null?void 0:d.visibility)??"public",updatedAt:E.updated_at}},onSuccess:async({id:d,isNew:C,url:E,html:F,visibility:_,updatedAt:D})=>{if(L(null),dn(!1),Ke(_),Me.current=F,ot(F),$e.current=D??$e.current,Se(null),r.invalidateQueries({queryKey:["pages"]}),r.invalidateQueries({queryKey:["page",d]}),r.invalidateQueries({queryKey:["page-history",d]}),C)await Wt({key:d,pageId:d,html:ge.current,contents:f,model:h||null,basedOnUpdatedAt:$e.current??void 0,updatedAt:0}).catch(()=>{}),await Cn("draft").catch(()=>{}),wt(E),un({url:E??`/p/${d}`,id:d,isNew:!0,visibility:_});else{const V=yt??`/p/${d}`;wt(V),un({url:V,id:d,isNew:!1,visibility:_})}},onError:d=>{d instanceof et&&d.body&&typeof d.body=="object"&&"reason"in d.body?L(`Publish failed: ${d.message} (${String(d.body.reason)})`):d instanceof et?L(`Publish failed: ${d.message}`):L("Publish failed.")}});async function ws(){if(await o({title:"Reset builder",body:e?"Clears the conversation and restores the HTML from the published page.":"Clears the conversation and the draft HTML. This cannot be undone.",confirmLabel:"Reset",variant:"danger"}))if(await Cn(t).catch(()=>{}),g(At),Vt.current=At,Ot(0),L(null),S.current=null,e)try{const C=await ht.getPage(e);Ae(C.html),Me.current=C.html,$e.current=C.updated_at,Se(null)}catch{L("Failed to reload page.")}else Ae(dt),Me.current=dt}async function xs(){if(ge.current!==Me.current){if(!await o({title:"Unpublished changes",body:"You have unpublished changes to this page. Publish them first, or discard them and start a new page.",confirmLabel:"Discard & start new",variant:"danger"}))return;Me.current=ge.current}const d=await Wr("draft").catch(()=>{});d&&(d.contents.length>0||d.html!==dt)&&await o({title:"Unfinished draft",body:"You have an unfinished draft. Start fresh and discard it, or resume where you left off?",confirmLabel:"Start fresh",cancelLabel:"Resume draft",variant:"danger"})&&await Cn("draft").catch(()=>{}),n("/")}async function ks(d){var F;const C=(F=d.target.files)==null?void 0:F[0];if(d.target.value="",!C)return;const E=await C.text();Ae(E),L(null),Ue(f)}async function yn(d){if(d.length===0)return;if(at){L("Free models cannot read attachments. Switch to a Google model to attach files.");return}const C=[],E=[];for(const F of d){const _=await Xa(F);"error"in _?E.push(_.error):C.push(_)}C.length>0&&R(F=>[...F,...C]),E.length>0&&L(E.join(" "))}function Ss(d){const C=Array.from(d.target.files??[]);d.target.value="",yn(C)}const wn=s.useMemo(()=>pa(f),[f]),xn=((Or=ve.data)==null?void 0:Or.models.length)??0,Cs=ve.isError||!!ve.data&&xn===0,He=Be&&xn===0&&Xe.length===0,jr=Cs&&Xe.length>0,kn=ve.error instanceof et?ve.error.message:void 0,je=f[f.length-1],Es=(je==null?void 0:je.role)==="model"&&!je.parts.some(d=>d.functionCall),Rs=(je==null?void 0:je.role)==="user"&&je.parts.some(ma),Nr=!I&&!!je&&!Es&&!Rs,Ps=((Fr=wn[wn.length-1])==null?void 0:Fr.kind)==="user";return i?a.jsxs("div",{className:"flex h-[calc(100vh-8.5rem)] min-h-[480px] flex-col gap-3",children:[a.jsxs("div",{className:"flex flex-wrap items-center gap-2",children:[a.jsxs(Xr,{value:Ce?h:"",onValueChange:p,disabled:I||!Be,children:[a.jsx(Qr,{className:"h-8 w-auto min-w-[9rem] text-[13px]",children:a.jsx(Zr,{placeholder:Be?"select a model":"loading models…"})}),a.jsxs(Jr,{children:[xn>0?a.jsxs(eo,{children:[a.jsx(to,{children:"Google"}),($r=ve.data)==null?void 0:$r.models.map(d=>a.jsx(Rn,{value:d,children:d},d))]}):null,Xe.length>0?a.jsxs(eo,{children:[a.jsx(to,{children:"Free · opencode zen"}),Xe.map(d=>a.jsx(Rn,{value:d.id,children:d.name},d.id))]}):null]})]}),a.jsxs(Xr,{value:Ze.includes(v)?v:"off",onValueChange:m,disabled:I||Ze.length===0,children:[a.jsxs(Qr,{className:"h-8 w-auto text-[13px]",title:Ze.length>0?"Thinking level — how much the model reasons before answering":Qe!=null&&Qe.reasoning?"This model reasons but offers no thinking-level control":"This model does not support thinking",children:[a.jsx(Po,{className:"h-3.5 w-3.5 shrink-0 text-fg-3"}),a.jsx(Zr,{})]}),a.jsx(Jr,{children:Ze.map(d=>a.jsx(Rn,{value:d,children:d},d))})]}),a.jsxs("button",{type:"button",onClick:()=>ke(d=>!d),disabled:B,className:W("inline-flex h-8 items-center gap-1.5 rounded-md border border-border px-2.5 text-[12px] disabled:opacity-50",ue?"bg-ink text-white":"bg-surface text-fg-2 hover:text-fg"),children:[a.jsx(Io,{className:"h-3.5 w-3.5"})," Code"]}),a.jsxs("div",{className:W("flex items-center gap-1 rounded-md border border-border bg-surface p-0.5 text-[11px]",(ue||B&&Te!=="preview")&&"opacity-50"),children:[a.jsxs("button",{type:"button",onClick:()=>Oe("desktop"),disabled:ue||B&&Te!=="preview",title:"Preview at full width",className:W("inline-flex items-center gap-1 rounded-sm px-2 py-1",fe==="desktop"?"bg-ink text-white":"text-fg-2 hover:text-fg"),children:[a.jsx(Vs,{className:"h-3.5 w-3.5"})," Desktop"]}),a.jsxs("button",{type:"button",onClick:()=>Oe("mobile"),disabled:ue||B&&Te!=="preview",title:"Preview at phone width",className:W("inline-flex items-center gap-1 rounded-sm px-2 py-1",fe==="mobile"?"bg-ink text-white":"text-fg-2 hover:text-fg"),children:[a.jsx(Gs,{className:"h-3.5 w-3.5"})," Mobile"]})]}),a.jsxs("button",{type:"button",onClick:()=>ls(d=>d+1),disabled:ue||B,title:"Reload the preview (recovers a broken or navigated-away preview)",className:"inline-flex h-8 items-center gap-1.5 rounded-md border border-border bg-surface px-2.5 text-[12px] text-fg-2 hover:text-fg disabled:opacity-50",children:[a.jsx(Hr,{className:"h-3.5 w-3.5"})," Reload"]}),a.jsxs("button",{type:"button",onClick:()=>{var d;return(d=wr.current)==null?void 0:d.click()},disabled:I||B,title:"Load an .html file into the builder (replaces the current document)",className:"inline-flex h-8 items-center gap-1.5 rounded-md border border-border bg-surface px-2.5 text-[12px] text-fg-2 hover:text-fg disabled:opacity-50",children:[a.jsx(Ws,{className:"h-3.5 w-3.5"})," Upload"]}),a.jsx("input",{ref:wr,type:"file",accept:".html,.htm,text/html",hidden:!0,onChange:ks}),a.jsxs("button",{type:"button",onClick:ws,disabled:I||B,className:"inline-flex h-8 items-center gap-1.5 rounded-md border border-border bg-surface px-2.5 text-[12px] text-fg-2 hover:text-fg disabled:opacity-50",children:[a.jsx(qs,{className:"h-3.5 w-3.5"})," Reset"]}),e?a.jsxs("button",{type:"button",onClick:xs,disabled:I||B,title:"Start a new page in the draft builder",className:"inline-flex h-8 items-center gap-1.5 rounded-md border border-border bg-surface px-2.5 text-[12px] text-fg-2 hover:text-fg disabled:opacity-50",children:[a.jsx(Ks,{className:"h-3.5 w-3.5"})," New"]}):null,e?a.jsxs("button",{type:"button",onClick:()=>B?Bt():pr(!0),title:"Browse previously published versions of this page",className:W("inline-flex h-8 items-center gap-1.5 rounded-md border border-border px-2.5 text-[12px]",B?"bg-ink text-white":"bg-surface text-fg-2 hover:text-fg"),children:[a.jsx(Ro,{className:"h-3.5 w-3.5"})," History"]}):null,a.jsxs("div",{className:"ml-auto flex items-center gap-2",children:[yt?a.jsxs("a",{href:yt,target:"_blank",rel:"noreferrer",className:"inline-flex items-center gap-1 text-[12px] text-fg-2 hover:text-fg",children:["View live ",a.jsx(Ys,{className:"h-3 w-3"})]}):null,a.jsxs(ze,{size:"sm",onClick:()=>e?Rt.mutate(void 0):dn(!0),disabled:I||Rt.isPending||B,children:[Rt.isPending?a.jsx(Xs,{className:"h-3.5 w-3.5 animate-spin"}):a.jsx(Eo,{className:"h-3.5 w-3.5"}),e?"Publish update":"Publish"]})]})]}),xe&&!B?a.jsxs("div",{className:"flex items-center gap-2 rounded-md border border-no/30 bg-no-soft px-3 py-2 text-[12px] text-no-strong",children:[a.jsx("span",{className:"min-w-0 flex-1 break-words",children:xe}),A&&!I?a.jsxs("button",{type:"button",onClick:()=>void Gt(),className:"inline-flex shrink-0 items-center gap-1 rounded border border-no/30 bg-surface px-2 py-0.5 text-[11px] font-medium text-no-strong hover:bg-no-soft",children:[a.jsx(Hr,{className:"h-3 w-3"})," Retry"]}):null]}):null,bt!==null&&!B?a.jsxs("div",{className:"flex items-center gap-2 rounded-md border border-border bg-surface-muted px-3 py-2 text-[12px] text-fg-2",children:[a.jsx("span",{className:"min-w-0 flex-1 break-words",children:"This page was updated outside this browser — loaded the latest published version."}),a.jsxs("button",{type:"button",onClick:()=>{Ae(bt),Se(null),Ue(f)},className:"inline-flex shrink-0 items-center gap-1 rounded border border-border bg-surface px-2 py-0.5 text-[11px] font-medium text-fg hover:bg-surface-muted",children:[a.jsx(Qs,{className:"h-3 w-3"})," Keep my local copy"]}),a.jsx("button",{type:"button",onClick:()=>Se(null),"aria-label":"Dismiss",className:"shrink-0 rounded p-0.5 text-fg-3 hover:text-fg",children:a.jsx(zr,{className:"h-3 w-3"})})]}):null,(He||jr)&&!B?a.jsxs("div",{className:"space-y-2",children:[a.jsxs("div",{className:"rounded-md border border-border bg-surface-muted px-3 py-2 text-[12px] text-fg-2",children:[He?"AI is unavailable — ":"Google models are unavailable — ",kn==="no_project"?a.jsxs(a.Fragment,{children:["no Code Assist project selected for your account."," ",a.jsx(Va,{to:"/settings",className:"underline hover:text-fg",children:"Choose one in Settings"}),"."]}):kn==="reauth_required"?"your Google credential has expired or is invalid. Sign out and sign in again to reconnect.":"could not load models. Try again later.",jr?" Free models are listed in the model picker and need no Google account.":null]}),kn==="no_project"?a.jsx(Da,{}):null]}):null,Nr&&!xe&&!Ps&&!B?a.jsxs("div",{className:"flex items-center gap-2 rounded-md border border-border bg-surface-muted px-3 py-2 text-[12px] text-fg-2",children:[a.jsx("span",{className:"min-w-0 flex-1",children:"Aero stopped before finishing — resume to keep going."}),a.jsxs("button",{type:"button",onClick:()=>void Gt(),disabled:He||!Ce,className:"inline-flex shrink-0 items-center gap-1 rounded border border-border bg-surface px-2 py-0.5 text-[11px] font-medium text-fg-2 hover:bg-surface-muted disabled:opacity-50",children:[a.jsx(Zs,{className:"h-3 w-3"})," Resume"]})]}):null,a.jsxs("div",{className:"flex min-h-0 flex-1 gap-4",children:[a.jsx("div",{className:W("flex w-[380px] shrink-0 flex-col rounded-lg border border-border bg-surface",P&&"ring-2 ring-ink"),onDragOver:d=>{B||(d.preventDefault(),M(!0))},onDragLeave:()=>M(!1),onDrop:d=>{B||(d.preventDefault(),M(!1),yn(Array.from(d.dataTransfer.files)))},children:B?a.jsx(Yu,{entries:de.data,isLoading:de.isLoading,isError:de.isError,isFetching:de.isFetching||gr,selectedSha:(ee==null?void 0:ee.sha)??null,onSelect:$t,onRefresh:cs}):a.jsx(ga,{ref:vn,chat:wn,busy:I,streamText:K,streamThought:j,busyLabel:as?"compacting conversation…":ld(G,le,ie),toolActive:G!==null,retrying:ie!==null,busyElapsed:le,emptyState:a.jsxs(a.Fragment,{children:["Describe the page you want to build.",a.jsx("br",{}),"Aero edits the HTML and you preview it live.",a.jsx("br",{}),"Or upload an existing .html file to start from."]}),renderToolItem:cd,canResume:Nr,resumeDisabled:He||!Ce,onResume:()=>void Gt(),onSaveItemEdit:(d,C)=>void ys(d,C),onDeleteItem:d=>void bs(d),input:y,onInputChange:x,onSend:()=>void ms(),onStop:gs,composerDisabled:I||He||!Ce,sendDisabled:He||!Ce||!y.trim()&&k.length===0||Rr,placeholder:He?"AI unavailable":!Ce&&ve.data?"Pick a model to continue — the last one is no longer available":"Ask Aero to build or change something…",slashCommands:ko,composerMeta:a.jsxs("div",{className:"flex min-w-0 items-center gap-2 text-[11px] text-fg-3",children:[ps?a.jsx("span",{className:W("tabular truncate",Pr&&"font-medium text-no-strong"),title:`Estimated request size with attached files: ${tt(ct)} of ${tt(Tt)} — Gemini rejects requests over ~20MB`,children:Pr?`${tt(ct)} / ${tt(Tt)}`:tt(ct)}):null,a.jsx("span",{className:W("tabular truncate",Ir&&"font-medium text-no-strong"),title:`Approximate context window usage: ${yo(Lt)} of ${Ar} tokens (${Tr}% left) — ${at?"free models are held to a 200K-token context":"all Gemini models have a ~1M-token context"}`,children:Ir?`${yo(Lt)} / ${Ar}`:`${Tr}% left`})]}),attachmentsBar:k.length>0?a.jsx("div",{className:"flex flex-wrap gap-1.5 px-3 pt-2.5",children:k.map(d=>a.jsxs("div",{className:"flex items-center gap-1.5 overflow-hidden rounded-md border border-border bg-surface-muted pr-1.5 text-[11px]",children:[d.kind==="inline"&&d.mimeType.startsWith("image/")?a.jsx("img",{src:`data:${d.mimeType};base64,${d.data}`,alt:d.name,className:"h-7 w-7 shrink-0 object-cover"}):a.jsx("span",{className:"flex h-7 w-7 shrink-0 items-center justify-center text-fg-3",children:ba(d.mimeType)}),a.jsx("span",{className:"max-w-[8rem] truncate text-fg-2",title:d.name,children:d.name}),a.jsx("button",{type:"button",onClick:()=>R(C=>C.filter(E=>E.id!==d.id)),title:"Remove",className:"text-fg-3 hover:text-fg",children:a.jsx(zr,{className:"h-3 w-3"})})]},d.id))}):void 0,composerLeading:a.jsxs("div",{className:"flex shrink-0 items-center gap-0.5",children:[a.jsxs(zu,{children:[a.jsx(Vu,{asChild:!0,children:a.jsxs(ze,{variant:"ghost",size:"sm","aria-label":"Which tools the agent may use",title:"Which tools the agent may use",className:W(Kr,"relative"),children:[a.jsx(To,{className:"h-3.5 w-3.5"}),b.length>0?a.jsx("span",{className:"absolute right-1 top-1 h-1.5 w-1.5 rounded-full bg-status"}):null]})}),a.jsx(rs,{className:"w-60",children:va.map(d=>a.jsx(os,{checked:!d.names.some(C=>b.includes(C)),onCheckedChange:C=>{const E=C?b.filter(F=>!d.names.includes(F)):[...new Set([...b,...d.names])];w(E),Ue(f,E)},children:a.jsxs("span",{className:"flex flex-col",children:[a.jsx("span",{children:d.label}),a.jsx("span",{className:"text-[11px] text-fg-3",children:d.hint})]})},d.id))})]}),at?null:a.jsxs(a.Fragment,{children:[a.jsx(ze,{variant:"ghost",size:"sm",onClick:()=>{var d;return(d=xr.current)==null?void 0:d.click()},disabled:I||He||!Ce,title:"Attach a file (image, PDF, audio, video, or text)",className:Kr,children:a.jsx(Js,{className:"h-3.5 w-3.5"})}),a.jsx("input",{ref:xr,type:"file",multiple:!0,hidden:!0,onChange:Ss})]})]}),onPasteFiles:d=>void yn(d)})}),a.jsx("div",{className:"flex min-w-0 flex-1 flex-col overflow-hidden rounded-lg border border-border bg-surface",children:B?a.jsxs(a.Fragment,{children:[a.jsx(Xu,{entry:ee,canRestore:!!ee&&ae.data!==void 0,onRestore:()=>{ae.data!==void 0&&(Ae(ae.data),Ue(f)),Bt()},onExit:Bt}),ee?a.jsxs("div",{className:"flex items-center gap-2 border-b border-border px-3 py-1.5",children:[a.jsxs("div",{className:"flex items-center gap-1 rounded-md border border-border bg-surface p-0.5 text-[11px]",children:[a.jsx("button",{type:"button",onClick:()=>fn("preview"),className:W("rounded-sm px-2 py-1",Te==="preview"?"bg-ink text-white":"text-fg-2 hover:text-fg"),children:"Preview"}),a.jsx("button",{type:"button",onClick:()=>fn("diff"),className:W("rounded-sm px-2 py-1",Te==="diff"?"bg-ink text-white":"text-fg-2 hover:text-fg"),children:"Diff"})]}),Te==="diff"?a.jsxs("div",{className:"flex items-center gap-1 rounded-md border border-border bg-surface p-0.5 text-[11px]",children:[a.jsx("button",{type:"button",onClick:()=>hn("previous"),className:W("rounded-sm px-2 py-1",Fe==="previous"?"bg-surface-muted text-fg":"text-fg-3 hover:text-fg-2"),children:"vs Previous version"}),a.jsx("button",{type:"button",onClick:()=>hn("draft"),className:W("rounded-sm px-2 py-1",Fe==="draft"?"bg-surface-muted text-fg":"text-fg-3 hover:text-fg-2"),children:"vs Current draft"})]}):null]}):null,Te==="diff"&&ee?Fe==="previous"&&!kt?a.jsx("div",{className:"p-4 text-[12px] text-fg-3",children:"This is the first published version — nothing to compare it against."}):Fe==="previous"&&Ut.isLoading||ae.isLoading?a.jsx("div",{className:"p-4 text-[12px] text-fg-3",children:"Loading diff…"}):Fe==="previous"&&Ut.isError||ae.isError?a.jsx("div",{className:"p-4 text-[12px] text-no-strong",children:"Failed to load diff."}):Fe==="previous"&&Ut.data!==void 0&&ae.data!==void 0?a.jsx(Dn,{oldText:Ut.data,newText:ae.data,oldLabel:`Version from ${new Date(kt.committed_at).toLocaleString()}`,newLabel:`Version from ${new Date(ee.committed_at).toLocaleString()}`}):Fe==="draft"&&ae.data!==void 0?a.jsx(Dn,{oldText:c,newText:ae.data,oldLabel:"Current draft",newLabel:`Version from ${new Date(ee.committed_at).toLocaleString()}`}):null:Te==="preview"?ae.isLoading?a.jsx("div",{className:"p-4 text-[12px] text-fg-3",children:"Loading version…"}):ae.isError?a.jsx("div",{className:"p-4 text-[12px] text-no-strong",children:"Failed to load this version."}):St?a.jsx("div",{className:"flex h-full w-full justify-center overflow-auto bg-surface-muted",children:a.jsx("iframe",{title:"historic version preview",src:St,sandbox:"allow-scripts allow-modals allow-forms allow-popups",className:W("h-full bg-white",fe==="mobile"?"w-[390px] shrink-0 border-x border-border":"w-full flex-1")})}):a.jsx("div",{className:"p-4 text-[12px] text-fg-3",children:"Select a version from the list to preview it."}):null]}):ue?a.jsxs(a.Fragment,{children:[a.jsx("div",{className:"flex items-center gap-2 border-b border-border px-3 py-1.5",children:a.jsxs("div",{className:"flex items-center gap-1 rounded-md border border-border bg-surface p-0.5 text-[11px]",children:[a.jsx("button",{type:"button",onClick:()=>Ie("code"),className:W("rounded-sm px-2 py-1",se==="code"?"bg-ink text-white":"text-fg-2 hover:text-fg"),children:"Code"}),a.jsx("button",{type:"button",onClick:()=>Ie("diff"),disabled:!it,title:it?void 0:"Diff becomes available once this page has been published",className:W("rounded-sm px-2 py-1 disabled:opacity-50",se==="diff"?"bg-ink text-white":"text-fg-2 hover:text-fg"),children:"Diff"})]})}),se==="diff"&&it?a.jsx(Dn,{oldText:vt,newText:c,oldLabel:"Last published version",newLabel:"Current draft"}):a.jsx(s.Suspense,{fallback:a.jsx("div",{className:"p-3 text-[12px] text-fg-3",children:"Loading editor…"}),children:a.jsx(rd,{value:c,onChange:Ae,language:"html",className:"flex-1 overflow-auto"})})]}):a.jsx("div",{className:"flex h-full w-full justify-center overflow-auto bg-surface-muted",children:a.jsx("iframe",{ref:zt,title:"preview",src:st,sandbox:"allow-scripts allow-modals allow-forms allow-popups",className:W("h-full bg-white",fe==="mobile"?"w-[390px] shrink-0 border-x border-border":"w-full flex-1")},hr)})})]}),ss?a.jsx(qu,{initialAlias:_t,busy:Rt.isPending,onCancel:()=>dn(!1),onPublish:d=>{ln(d.alias),Rt.mutate(d)}}):null,xt?a.jsx(Wu,{url:xt.url,isNew:xt.isNew,visibility:xt.visibility,onClose:()=>{const d=xt;un(null),d.isNew&&n(`/builder/${d.id}`,{replace:!0,state:{publishContinuation:!0}})}}):null,Le?a.jsx(_a,{info:Le,onEnabled:()=>{Pe(null),L(null),Gt()},onClose:()=>Pe(null)}):null]}):a.jsx("div",{className:"text-fg-3",children:"Loading…"})}export{Rd as BuilderPage};
