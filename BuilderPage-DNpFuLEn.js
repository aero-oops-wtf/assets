...
`,po=`# Aero HTML Slides Style Guide
...
`,mo=`# aero-ai: calling Gemini from inside an aero page
...
})();<\/script>`,Co=`<script>(function(){
var module={exports:{}};var exports=module.exports;
`+wo.replace(/<\/script/gi,"<\\/script")+`
...
})();<\/script>`;function $n(n,r){const o=So+yo+ko+(r!=null&&r.screenshot?Co:"")+jo,a=n.match(/<head[^>]*>/i);if(!a)return o+n;const s=a.index+a[0].length;return n.slice(0,s)+o+n.slice(s)}function To({url:n,isNew:r,visibility:o,onClose:a}){const s=l.useRef(null),h=l.useRef(null);l.useEffect(()=>{const d=h.current;d&&!d.contains(document.activeElement)&&d.focus()},[]);function f(d){if(d.key==="Escape"){a();return}if(d.key!=="Tab")return;const m=s.current;if(!m)return;const c=m.querySelectorAll(["a[href]","button:not([disabled])","input:not([disabled])","select:not([disabled])","textarea:not([disabled])",'[contenteditable="true"]','[tabindex]:not([tabindex="-1"])'].join(", "));if(c.length===0)return;const p=c[0],T=c[c.length-1],R=document.activeElement;d.shiftKey&&(R===p||!m.contains(R))?(d.preventDefault(),T.focus()):!d.shiftKey&&(R===T||!m.contains(R))&&(d.preventDefault(),p.focus())}return e.jsx("div",{ref:h,tabIndex:-1,className:"fixed inset-0 z-50 grid place-items-center bg-ink/45 p-4 backdrop-blur-sm focus:outline-none",role:"dialog","aria-modal":"true","aria-labelledby":"publish-success-title",onKeyDown:f,onMouseDown:d=>{d.target===d.currentTarget&&a()},children:e.jsxs("div",{ref:s,className:"w-full max-w-md rounded-lg border border-border bg-surface shadow-lg",children:[e.jsxs("div",{className:"flex flex-col items-center gap-2 px-6 pt-6 text-center",children:[e.jsx(Wn,{className:"h-10 w-10 text-success"}),e.jsx("div",{id:"publish-success-title",className:"text-[15px] font-semibold text-fg",children:r?"Page published":"Update published"}),e.jsx("p",{className:"text-[12px] text-fg-2",children:r?o==="private"?"Your page is live. Only you and the people you added can open it.":"Your page is live. Anyone with the link can view it.":"The live page now shows your latest changes."})]}),e.jsx("div",{className:"px-6 py-4",children:e.jsx(qa,{url:n})}),e.jsx("div",{className:"flex justify-end border-t border-border px-6 py-3",children:e.jsx(te,{autoFocus:!0,onClick:a,children:"Done"})})]})})}function Eo({initialAlias:n,busy:r,onCancel:o,onPublish:a}){const[s,h]=l.useState(n),[f,d]=l.useState("public"),[m,c]=l.useState([]),p=l.useRef(null),T=l.useRef(null);l.useEffect(()=>{const v=T.current;v&&!v.contains(document.activeElement)&&v.focus()},[]);function R(v){if(v.key==="Escape"){o();return}if(v.key!=="Tab")return;const S=p.current;if(!S)return;const _=S.querySelectorAll(["a[href]","button:not([disabled])","input:not([disabled])","select:not([disabled])","textarea:not([disabled])",'[contenteditable="true"]','[tabindex]:not([tabindex="-1"])'].join(", "));if(_.length===0)return;const I=_[0],ne=_[_.length-1],x=document.activeElement;v.shiftKey&&(x===I||!S.contains(x))?(v.preventDefault(),ne.focus()):!v.shiftKey&&(x===ne||!S.contains(x))&&(v.preventDefault(),I.focus())}return e.jsx("div",{ref:T,tabIndex:-1,className:"fixed inset-0 z-50 grid place-items-center bg-ink/45 p-4 backdrop-blur-sm focus:outline-none",role:"dialog","aria-modal":"true","aria-labelledby":"pre-publish-title",onKeyDown:R,onMouseDown:v=>{v.target===v.currentTarget&&!r&&o()},children:e.jsxs("div",{ref:p,className:"w-full max-w-md rounded-lg border border-border bg-surface shadow-lg",children:[e.jsxs("div",{className:"border-b border-border px-6 py-4",children:[e.jsx("div",{id:"pre-publish-title",className:"text-[15px] font-semibold text-fg",children:"Publish app"}),e.jsx("p",{className:"mt-1 text-[12px] text-fg-2",children:"Choose the address and who can open it. You can change both later from Apps."})]}),e.jsxs("div",{className:"space-y-4 px-6 py-4",children:[e.jsxs("div",{children:[e.jsx(Pn,{htmlFor:"publish-alias",hint:"optional — leave blank for a UUID URL",children:"Alias"}),e.jsx(Ga,{id:"publish-alias",autoFocus:!0,value:s,disabled:r,onChange:v=>h(v.target.value.toLowerCase()),placeholder:"my-app"}),e.jsxs("div",{className:"mt-1 font-mono text-[11px] text-fg-3",children:["/p/",s.trim()||"<uuid>"]})]}),e.jsxs("div",{children:[e.jsx(Pn,{children:"Who can open it"}),e.jsx(za,{visibility:f,onVisibilityChange:d,grants:m,onGrantsChange:c,disabled:r})]})]}),e.jsxs("div",{className:"flex justify-end gap-2 border-t border-border px-6 py-3",children:[e.jsx(te,{variant:"secondary",onClick:o,disabled:r,children:"Cancel"}),e.jsxs(te,{onClick:()=>a({alias:s.trim(),visibility:f,grants:m}),disabled:r,children:[e.jsx(Yn,{className:"h-3.5 w-3.5"}),r?"Publishing…":"Publish"]})]})]})})}function No(n,r){return Zn({queryKey:["page-history",n],queryFn:()=>xe.getPageHistory(n).then(o=>o.versions),enabled:r,retry:!1})}function Un(n,r){return Zn({queryKey:["page-history-version",n,r],queryFn:()=>xe.getPageHistoryVersion(n,r).then(o=>o.html),enabled:r!==null,retry:!1})}function Ao({entries:n,isLoading:r,isError:o,isFetching:a,selectedSha:s,onSelect:h,onRefresh:f}){return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"flex items-center gap-1.5 border-b border-border px-3 py-2.5 text-[12px] font-semibold text-fg",children:[e.jsx(Xn,{className:"h-3.5 w-3.5 text-fg-3"}),e.jsx("span",{className:"flex-1",children:"Version history"}),e.jsx("button",{type:"button",onClick:f,disabled:a,title:"Refresh — GitHub sync runs in the background, so a just-published version can take a moment to appear",className:"font-normal text-fg-3 hover:text-fg disabled:opacity-50",children:"Refresh"})]}),e.jsxs("div",{className:"scroll-slim flex-1 overflow-y-auto p-1.5",children:[r?e.jsx("div",{className:"px-2 py-2 text-[12px] text-fg-3",children:"Loading…"}):null,o?e.jsx("div",{className:"px-2 py-2 text-[12px] text-no-strong",children:"Failed to load history."}):null,n&&n.length===0?e.jsx("div",{className:"px-2 py-2 text-[12px] text-fg-3",children:"No published versions yet."}):null,(n??[]).map(d=>{const m=d.sha===s;return e.jsxs("button",{type:"button",onClick:()=>h(d),className:E("block w-full rounded-md px-2.5 py-2 text-left",m?"bg-ink":"hover:bg-surface-muted"),children:[e.jsx("div",{className:E("text-[12px] font-medium",m?"text-white":"text-fg"),children:new Date(d.committed_at).toLocaleString()}),e.jsxs("div",{className:E("truncate text-[11px]",m?"text-white/70":"text-fg-3"),children:[d.message,d.author_email?` — ${d.author_email}`:""]})]},d.sha)})]})]})}function Lo({entry:n,canRestore:r,onRestore:o,onExit:a}){const s=Vn();return e.jsxs("div",{className:"flex items-center gap-2 border-b border-border bg-surface-muted px-3 py-2 text-[12px]",children:[e.jsx("div",{className:"min-w-0 flex-1 truncate text-fg-2",children:n?e.jsxs(e.Fragment,{children:["Viewing version from ",new Date(n.committed_at).toLocaleString(),n.author_email?` (${n.author_email})`:""," — read-only"]}):"Select a version from the list to preview it"}),e.jsxs(te,{variant:"secondary",size:"sm",onClick:a,children:[e.jsx(Ir,{className:"h-3.5 w-3.5"})," Back to current draft"]}),e.jsx(te,{size:"sm",disabled:!r,onClick:async()=>{await s({title:"Restore this version",body:"This replaces your current editor content. Unsaved changes will be lost. The page stays unpublished until you publish again.",confirmLabel:"Restore",variant:"danger"})&&o()},children:"Restore this version"})]})}class Ro{diff(r,o,a={}){let s;typeof a=="function"?(s=a,a={}):"callback"in a&&(s=a.callback);const h=this.castInput(r,a),f=this.castInput(o,a),d=this.removeEmpty(this.tokenize(h,a)),m=this.removeEmpty(this.tokenize(f,a));return this.diffWithOptionsObj(d,m,a,s)}diffWithOptionsObj(r,o,a,s){var h;const f=x=>{if(x=this.postProcess(x,a),s){setTimeout(function(){s(x)},0);return}else return x},d=o.length,m=r.length;let c=1,p=d+m;a.maxEditLength!=null&&(p=Math.min(p,a.maxEditLength));const T=(h=a.timeout)!==null&&h!==void 0?h:1/0,R=Date.now()+T,v=[{oldPos:-1,lastComponent:void 0}];let S=this.extractCommon(v[0],o,r,0,a);if(v[0].oldPos+1>=m&&S+1>=d)return f(this.buildValues(v[0].lastComponent,o,r));let _=-1/0,I=1/0;const ne=()=>{for(let x=Math.max(_,-c);x<=Math.min(I,c);x+=2){let F;const J=v[x-1],z=v[x+1];J&&(v[x-1]=void 0);let ye=!1;if(z){const Se=z.oldPos-x;ye=z&&0<=Se&&Se<d}const ke=J&&J.oldPos+1<m;if(!ye&&!ke){v[x]=void 0;continue}if(!ke||ye&&J.oldPos<z.oldPos?F=this.addToPath(z,!0,!1,0,a):F=this.addToPath(J,!1,!0,1,a),S=this.extractCommon(F,o,r,x,a),F.oldPos+1>=m&&S+1>=d)return f(this.buildValues(F.lastComponent,o,r))||!0;v[x]=F,F.oldPos+1>=m&&(I=Math.min(I,x-1)),S+1>=d&&(_=Math.max(_,x+1))}c++};if(s)(function x(){setTimeout(function(){if(c>p||Date.now()>R)return s(void 0);ne()||x()},0)})();else for(;c<=p&&Date.now()<=R;){const x=ne();if(x)return x}}addToPath(r,o,a,s,h){const f=r.lastComponent;return f&&!h.oneChangePerToken&&f.added===o&&f.removed===a?{oldPos:r.oldPos+s,lastComponent:{count:f.count+1,added:o,removed:a,previousComponent:f.previousComponent}}:{oldPos:r.oldPos+s,lastComponent:{count:1,added:o,removed:a,previousComponent:f}}}extractCommon(r,o,a,s,h){const f=o.length,d=a.length;let m=r.oldPos,c=m-s,p=0;for(;c+1<f&&m+1<d&&this.equals(a[m+1],o[c+1],h);)c++,m++,p++,h.oneChangePerToken&&(r.lastComponent={count:1,previousComponent:r.lastComponent,added:!1,removed:!1});return p&&!h.oneChangePerToken&&(r.lastComponent={count:p,previousComponent:r.lastComponent,added:!1,removed:!1}),r.oldPos=m,c}equals(r,o,a){return a.comparator?a.comparator(r,o):r===o||!!a.ignoreCase&&r.toLowerCase()===o.toLowerCase()}removeEmpty(r){const o=[];for(let a=0;a<r.length;a++)r[a]&&o.push(r[a]);return o}castInput(r,o){return r}tokenize(r,o){return Array.from(r)}join(r){return r.join("")}postProcess(r,o){return r}get useLongestToken(){return!1}buildValues(r,o,a){const s=[];let h;for(;r;)s.push(r),h=r.previousComponent,delete r.previousComponent,r=h;s.reverse();const f=s.length;let d=0,m=0,c=0;for(;d<f;d++){const p=s[d];if(p.removed)p.value=this.join(a.slice(c,c+p.count)),c+=p.count;else{if(!p.added&&this.useLongestToken){let T=o.slice(m,m+p.count);T=T.map(function(R,v){const S=a[c+v];return S.length>R.length?S:R}),p.value=this.join(T)}else p.value=this.join(o.slice(m,m+p.count));m+=p.count,p.added||(c+=p.count)}}return s}}class Mo extends Ro{constructor(){super(...arguments),this.tokenize=Io}equals(r,o,a){return a.ignoreWhitespace?((!a.newlineIsToken||!r.includes(`
`))&&(r=r.trim()),(!a.newlineIsToken||!o.includes(`
`))&&(o=o.trim())):a.ignoreNewlineAtEof&&!a.newlineIsToken&&(r.endsWith(`
`)&&(r=r.slice(0,-1)),o.endsWith(`
`)&&(o=o.slice(0,-1))),super.equals(r,o,a)}}const Do=new Mo;function Po(n,r,o){return Do.diff(n,r,o)}function Io(n,r){r.stripTrailingCr&&(n=n.replace(/\r\n/g,`
`));const o=[],a=n.split(/(\n|\r\n)/);a[a.length-1]||a.pop();for(let s=0;s<a.length;s++){const h=a[s];s%2&&!r.newlineIsToken?o[o.length-1]+=h:o.push(h)}return o}function Fo(n,r){const o=[];let a=0;for(const s of Po(n,r)){const h=s.added?"added":s.removed?"removed":"context",f=s.value.split(`
`);f.length>0&&f[f.length-1]===""&&f.pop();for(const d of f)o.push({key:a++,kind:h,text:d})}return o}function Dt({oldText:n,newText:r,oldLabel:o,newLabel:a}){const s=l.useMemo(()=>Fo(n,r),[n,r]),h=s.every(f=>f.kind==="context");return e.jsxs("div",{className:"flex h-full min-h-0 flex-col overflow-hidden",children:[e.jsxs("div",{className:"flex items-center gap-3 border-b border-border bg-surface-muted px-3 py-1.5 text-[11px]",children:[e.jsxs("span",{className:"text-no-strong",children:["− ",o]}),e.jsxs("span",{className:"text-success",children:["+ ",a]})]}),e.jsx("div",{className:"scroll-slim flex-1 overflow-auto",children:h?e.jsx("div",{className:"p-4 text-[12px] text-fg-3",children:"No differences."}):e.jsx("div",{className:"min-w-max font-mono text-[12px] leading-5",children:s.map(f=>e.jsxs("div",{className:E("flex whitespace-pre px-3",f.kind==="added"&&"bg-status-soft",f.kind==="removed"&&"bg-no-soft",f.kind==="context"&&"text-fg-2"),children:[e.jsx("span",{className:E("mr-2 shrink-0 select-none",f.kind==="added"&&"text-success",f.kind==="removed"&&"text-no-strong",f.kind==="context"&&"text-fg-3"),children:f.kind==="added"?"+":f.kind==="removed"?"−":" "}),e.jsx("span",{children:f.text||" "})]},f.key))})})]})}const Bo=l.lazy(()=>Gn(()=>import("./CodeEditor-DKUw9K8j.js"),__vite__mapDeps([0,1,2,3,4,5]),import.meta.url).then(n=>({default:n.CodeEditor}))),we=`<!doctype html>
<html lang="en">
<head>
<meta charset="utf-8">
...
`,Pe=[];function qn(n,r,o){const a=JSON.stringify(n).length,s=r.reduce((h,f)=>{var d,m;return h+(f.kind==="inline"?((d=f.data)==null?void 0:d.length)??0:((m=f.text)==null?void 0:m.length)??0)},0);return a+s+o.length}const _o=.75,Ho=.85,zn=[{name:"compact",aliases:["compress"],hint:"[focus instructions]",description:"Summarize the conversation to free up context"}];function Oo(n,r,o){if(o){const a=Math.max(0,Math.ceil((o.deadline-Date.now())/1e3));return`rate-limited — retry ${o.attempt} of ${o.max} in ${a}s…`}if(n)switch(n.name){case"write":return"writing the page…";case"edit":return"editing the page…";case"read":return`reading the page${n.detail?` (${n.detail})`:""}…`;case"grep":return`searching the page${n.detail?` for “${n.detail}”`:""}…`;case"console":return"checking the console…";case"skill":return n.detail?`loading the ${n.detail} skill…`:"loading a skill…";case"action":return`running ${n.detail??"an action"}…`;case"web_search":return n.detail?`searching the web for “${n.detail}”…`:"searching the web…";case"database":return"updating the database…";default:return`using ${n.name}…`}return r>=10?`working… (${r}s — large edits can take a minute)`:r>=3?`working… (${r}s)`:"working…"}function $o(n){return e.jsxs("div",{children:[e.jsx("div",{className:"flex items-center gap-1.5 text-[11px] text-fg-3",children:n.name==="screenshot"?e.jsxs(e.Fragment,{children:[e.jsx(Gr,{className:"h-3 w-3 text-fg-3"}),e.jsx("span",{children:"looked at the page"})]}):n.name==="write"||n.name==="edit"?e.jsxs(e.Fragment,{children:[e.jsx(Kn,{className:"h-3 w-3 text-fg-3"}),e.jsx("span",{children:"edited the page"})]}):n.name==="skill"?e.jsxs(e.Fragment,{children:[e.jsx(Vr,{className:"h-3 w-3 text-fg-3"}),e.jsxs("span",{children:["loaded the ",e.jsx("span",{className:"font-medium text-fg-2",children:n.detail??"unknown"})," skill"]})]}):n.name==="action"?e.jsxs(e.Fragment,{children:[e.jsx(kn,{className:"h-3 w-3 text-fg-3"}),e.jsxs("span",{children:["ran ",e.jsx("span",{className:"font-medium text-fg-2",children:n.detail??"an action"})]})]}):n.name==="console"?e.jsxs(e.Fragment,{children:[e.jsx(kn,{className:"h-3 w-3 text-fg-3"}),e.jsx("span",{children:"checked the console"})]}):n.name==="grep"?e.jsxs(e.Fragment,{children:[e.jsx(Wr,{className:"h-3 w-3 text-fg-3"}),e.jsxs("span",{children:["searched the page",n.detail?e.jsxs(e.Fragment,{children:[" for ",e.jsx("span",{className:"max-w-[16rem] truncate font-medium text-fg-2",children:n.detail})]}):null]})]}):n.name==="database"?e.jsxs(e.Fragment,{children:[e.jsx(Yr,{className:"h-3 w-3 text-fg-3"}),e.jsxs("span",{children:["updated the database",n.detail?` (${n.detail})`:""]})]}):n.name==="read"?e.jsxs(e.Fragment,{children:[e.jsx(Jn,{className:"h-3 w-3 text-fg-3"}),e.jsxs("span",{children:["read the page",n.detail?` (${n.detail})`:""]})]}):e.jsxs(e.Fragment,{children:[e.jsx(Qn,{className:"h-3 w-3"}),e.jsxs("span",{children:["used ",e.jsx("span",{className:"font-medium text-fg-2",children:n.name}),n.detail?` (${n.detail})`:""]})]})}),n.name==="screenshot"&&n.imageUrl?e.jsx("img",{src:n.imageUrl,alt:"screenshot of the live preview",className:"mt-1.5 max-h-48 max-w-full rounded-md border border-border"}):null]})}function es(){var h;const{id:n}=Wa(),o=((h=Ya().state)==null?void 0:h.publishContinuation)===!0,a=l.useRef(0),s=l.useRef(n);return!o&&n!==s.current&&(a.current+=1),s.current=n,e.jsx(Uo,{pageId:n??null},a.current)}function Uo({pageId:n}){var bn,vn;const r=n??"draft",o=Xa(),a=Xr(),s=Vn(),[h,f]=l.useState(!1),[d,m]=l.useState(we),[c,p]=l.useState(Pe),T=Jr(),R=Na(),v=Aa(),{model:S,setModel:_,thinking:I,restoreThinking:ne,preferredThinkingRef:x,zenModels:F,zenModelInfo:J,modelsSettled:z,hasGoogleProject:ye,googleModels:ke,modelOffered:Se,modelLabel:Ie,modelReady:H,aiUnavailable:G,googleOut:rr,googleReason:Je,zenInfoFor:ar}=T,[O,Ft]=l.useState(()=>[...Zr]),[re,Ze]=l.useState(""),ue=l.useRef(null),or=t=>{if(Sn(t)==="zen")return ue.current??(ue.current=crypto.randomUUID()),ue.current},$=l.useRef(null),[Ce,et]=l.useState(""),[ae,tt]=l.useState([]),[Fe,Bt]=l.useState([]),[sr,nt]=l.useState(!1),[N,Be]=l.useState(!1),[ir,je]=l.useState(""),[lr,Te]=l.useState(""),[_t,rt]=l.useState(null),[Ht,Ot]=l.useState(0),[at,A]=l.useState(null),[cr,$t]=l.useState(!1),[Ut,oe]=l.useState(null),[qt,ot]=l.useState(null),[V,zt]=l.useState(!1),[_e,Gt]=l.useState("desktop"),[st,it]=l.useState("code"),[Vt,lt]=l.useState(null),ct=n!=null&&Vt!=null,[Wt,he]=l.useState(null);l.useEffect(()=>{V||it("code")},[V]);const[dr,ur]=l.useState(""),[dt,ut]=l.useState(null),[hr,Yt]=l.useState("public"),[Ee,ht]=l.useState(null),[fr,ft]=l.useState(!1),[pr,Xt]=l.useState(!1),[U,Ne]=l.useState(null),[mr,pt]=l.useState(!1),[He,Oe]=l.useState(0),[Kt,gr]=l.useState(0),fe=l.useMemo(()=>URL.createObjectURL(new Blob([$n(d,{screenshot:!0})],{type:"text/html"})),[d,Kt]),$e=l.useRef(null);l.useEffect(()=>{$e.current&&$e.current!==fe&&URL.revokeObjectURL($e.current),$e.current=fe},[fe]);const[y,Qt]=l.useState(!1),[L,Ue]=l.useState(null),D=No(n??"",!!n),M=Un(n??"",y?(L==null?void 0:L.sha)??null:null);l.useEffect(()=>{!y||!D.data||(L&&!D.data.some(t=>t.sha===L.sha)?Ue(D.data[0]??null):!L&&D.data.length>0&&Ue(D.data[0]))},[y,L,D.data]);function qe(){Qt(!1),Ue(null),mt("preview"),gt("previous")}const[W,mt]=l.useState("preview"),[Z,gt]=l.useState("previous"),Jt=y&&L&&D.data?D.data.findIndex(t=>t.sha===L.sha):-1,Ae=Jt>=0?((bn=D.data)==null?void 0:bn[Jt+1])??null:null,ze=Un(n??"",y&&W==="diff"&&Z==="previous"?(Ae==null?void 0:Ae.sha)??null:null),[Zt,en]=l.useState(!1),bt=l.useRef(null);l.useEffect(()=>()=>{bt.current&&clearTimeout(bt.current)},[]);function br(){Zt||(en(!0),D.refetch().finally(()=>{bt.current=setTimeout(()=>en(!1),2e3)}))}const Le=l.useMemo(()=>M.data===void 0?null:URL.createObjectURL(new Blob([$n(M.data)],{type:"text/html"})),[M.data]),Ge=l.useRef(null);l.useEffect(()=>{Ge.current&&Ge.current!==Le&&URL.revokeObjectURL(Ge.current),Ge.current=Le},[Le]);const Ve=l.useRef(null),We=l.useRef([]),tn=l.useRef(0);l.useEffect(()=>{We.current=[],tn.current=Date.now()},[fe]);const vr=l.useRef(0),Re=l.useRef(new Map),vt=l.useRef(!1),nn=l.useRef(y);l.useEffect(()=>{nn.current=y},[y]),l.useEffect(()=>{vt.current=!1;const t=Re.current;t.forEach(i=>{window.clearTimeout(i.timer),i.reject(new Error("the live preview reloaded — read the page again before acting on it"))}),t.clear()},[fe,V,y]),l.useEffect(()=>{function t(i){var C;if(i.source!==((C=Ve.current)==null?void 0:C.contentWindow))return;const u=i.data;if(!u)return;if(u.type==="aero-dom-ready"){vt.current=!0;return}if(u.type==="aero-dom-op-result"&&typeof u.id=="number"){const b=Re.current.get(u.id);if(!b)return;Re.current.delete(u.id),window.clearTimeout(b.timer);const w=typeof u.generation=="number"?u.generation:null;b.resolve(u.ok?{ok:!0,result:u.result,generation:w}:{ok:!1,error:u.error||"the action failed",generation:w});return}if(u.type!=="aero-console"||typeof u.ts=="number"&&u.ts<tn.current)return;const g=u.level==="info"||u.level==="warn"||u.level==="error"?u.level:"log",k=We.current;k.push({level:g,text:typeof u.text=="string"?u.text:"",ts:u.ts??Date.now()}),k.length>300&&k.splice(0,k.length-300)}return window.addEventListener("message",t),()=>window.removeEventListener("message",t)},[]);async function wr(t,i,u){var w;nn.current&&qe(),zt(!1);const g=Date.now()+1e4;for(;!vt.current||!((w=Ve.current)!=null&&w.contentWindow);){if(Date.now()>g)return{ok:!1,error:"the live preview did not finish loading",generation:null};await new Promise(j=>setTimeout(j,50))}const k=Ve.current.contentWindow,C=++vr.current,b=t==="screenshot"?3e4:15e3;return new Promise(j=>{const q=window.setTimeout(()=>{Re.current.delete(C),j({ok:!1,error:"the live preview did not respond — read the page again and retry",generation:null})},b);Re.current.set(C,{resolve:j,reject:ce=>j({ok:!1,error:ce.message,generation:null}),timer:q}),k.postMessage({type:"aero-dom-op",id:C,op:t,args:i,generation:u},"*")})}const P=l.useRef(d),Y=t=>{P.current=t,m(t)},X=l.useRef(we),ee=l.useRef(null),Ye=l.useRef(Pe),wt=l.useRef(null),rn=l.useRef(null),an=l.useRef(null),se=l.useRef(null),xt=l.useRef(nr);l.useEffect(()=>{let t=!0;return La().then(i=>_n(i).then(u=>{t&&(xt.current=u)})).catch(()=>{}),Ra().then(i=>_n(i).then(u=>{t&&(xt.current=u)})).catch(()=>{}),()=>{t=!1}},[]);const ie=!!S&&Sn(S)==="zen",pe=ie&&ea(J),me=ie?ha:$a,yt=ta(S),xr=()=>{if(!re)return"Same as builder";const t=Ie(re);return!z||Se(re)?t:`${t} — unavailable`};l.useEffect(()=>{let t=!1;return lt(null),he(null),Ne(null),pt(!1),Ze(""),$.current=null,ue.current=null,ee.current=null,(async()=>{const i=await Cn(r).catch(()=>{});if(t)return;let u=Pe;if(i&&(Y(i.html),X.current=i.html,u=na(i.contents),p(u),Ye.current=u,Oe(jn(u)),i.model&&_(i.model),ne(i.thinking,i.model??S),Ft(ra(i.disabledTools,i.knownTools)),Ze(i.observerModel??""),$.current=i.zenSessionId??null),n)try{const g=await xe.getPage(n);if(t)return;ut(g.url),Yt(Pr(g.visibility)),lt(g.html),ee.current=g.updated_at;const{html:k,supersededLocal:C}=go(i,g);Y(k),X.current=k,i&&C!==null&&(he(C),Ke({...i,html:k,contents:u,basedOnUpdatedAt:g.updated_at,updatedAt:0}).catch(()=>{}))}catch{t||A("Failed to load page.")}t||f(!0)})(),()=>{t=!0}},[r]);const le=l.useRef(Date.now());l.useEffect(()=>{if(!N)return;le.current=Date.now(),Ot(0);const t=setInterval(()=>Ot(Math.round((Date.now()-le.current)/1e3)),1e3);return()=>clearInterval(t)},[N]);const on=()=>{if(ie)return $.current??($.current=crypto.randomUUID()),$.current},K=(t,i=O,u=re)=>{const g=P.current;return Ke({key:r,pageId:n,html:g,contents:t,model:S||null,thinking:x.current,disabledTools:i,knownTools:Tt(),observerModel:u||void 0,zenSessionId:$.current??void 0,basedOnUpdatedAt:ee.current??void 0,updatedAt:0}).then(()=>{X.current=g,Ye.current=t}).catch(()=>{})},sn={sessionKey:r,pageId:n,contents:c,model:S,thinking:I,disabledTools:O,observerModel:re,modelsSettled:z,modelOffered:Se,zenInfoFor:ar},B=l.useRef(sn);B.current=sn;const ln=l.useRef(N);ln.current=N,l.useEffect(()=>()=>{if(P.current===X.current&&B.current.contents===Ye.current)return;const{sessionKey:t,pageId:i,contents:u,model:g,thinking:k,disabledTools:C,observerModel:b}=B.current;Ke({key:t,pageId:i,html:P.current,contents:u,model:g||null,thinking:k,disabledTools:C,knownTools:Tt(),observerModel:b||void 0,zenSessionId:$.current??void 0,basedOnUpdatedAt:ee.current??void 0,updatedAt:0}).catch(()=>{})},[]);const kt=!ie||pe,yr=kt&&(ae.length>0||c.some(t=>t.parts.some(i=>i.inlineData))),ge=l.useMemo(()=>qn(c,ae,Ce),[c,ae,Ce]),kr=kt&&ge>me,cn=ge/me>=_o,dn=He/yt>=Ho,un=Math.max(0,100-Math.round(He/yt*100)),hn=ua(yt);async function fn(t){var ce;const i=t===void 0,u=(t??Ce).trim(),g=i?ae:[];if(!u&&g.length===0||N||!H||Fe.length>0)return;const k=i?ge:qn(c,g,u);if(kt&&k>me){A(`This message is too large to send (~${de(k)} — the limit for ${Ie} is ~${de(me)}). `+(g.length>0?"Remove an attachment, or run /compact first.":"Run /compact first."));return}if(u.startsWith("/")){const Q=u.split(/\s+/)[0];if(!fa(zn,Q)){A(`Unknown command: ${Q} — available: /compact`);return}}const C=pa(u);if(C){et(""),await jr(C.instructions);return}const b=[ma()];for(const Q of g)b.push(ga(Q.name,Q.mimeType)),b.push(Q.kind==="inline"?{inlineData:{mimeType:Q.mimeType,data:Q.data??""}}:{text:Q.text??""});u&&b.push({text:u});const w=/\b(slides?|decks?|presentations?|powerpoint|pptx?|pitch(?:es)?)\b/i.test(u),j=/\bdeck-container\b|class="slide slide--/.test(P.current);P.current===we?b.push(At(`The HTML document is still the untouched blank starter template — it contains no user content. Do not call \`read\` on it. If this message is a change request, load the \`${w?"aero-slides":"aero-app-style"}\` skill, then write the first draft directly with \`write\`.`)):j?b.push(At("The current document is an aero slide deck. Load the `aero-slides` skill (if not already loaded in this conversation) and follow its layout catalogue and navigation engine when editing.")):w&&b.push(At("This request is about a slide deck / presentation. Load the `aero-slides` skill before making changes, and follow its layout catalogue and navigation engine."));const q=[...c,{role:"user",parts:b}];(ce=wt.current)==null||ce.followOutput(),p(q),i&&(et(""),tt([])),vo(),await pn(q)}async function pn(t){const i=new AbortController;se.current=i,Be(!0),je(""),Te(""),A(null),$t(!1),oe(null);const u=B.current.sessionKey;Ne(null);const g=P.current,k=Date.now(),C=on();try{const b=await ka({model:S,contents:t,html:()=>P.current,skills:xt.current,pageId:n,consoleLogs:()=>We.current,domOp:wr,browse:R,generationConfig:Ln(I,S),thinking:I,zenModelInfo:J,zenSession:C,hasGoogleProject:ye,disabledTools:O,signal:i.signal,callbacks:{onText:w=>{le.current=Date.now(),oe(null),je(j=>j+w)},onThought:w=>{le.current=Date.now(),oe(null),Te(j=>j+w)},onUsage:w=>{const j=w.totalTokenCount??w.promptTokenCount;typeof j=="number"&&Oe(j)},onTool:(w,j)=>{le.current=Date.now(),oe(null),rt({name:w,detail:j})},onHtml:w=>Y(w),onContents:w=>{le.current=Date.now(),rt(null),p(w),je(""),Te("")},onStreamReset:()=>{je(""),Te(""),oe(null)},onRetry:(w,j,q)=>{le.current=Date.now(),oe({attempt:w,max:j,deadline:Date.now()+q*1e3})}}});p(b),await K(b),Date.now()-k>1e4&&On({ok:!0});try{await Cr(b,g,u,i.signal)}catch{}}catch(b){if(b instanceof DOMException&&b.name==="AbortError")await K(B.current.contents);else{const w=b instanceof ve?Sa(b.body):null,j=b instanceof ve?b.message==="reauth_required"?"Your Google credential has expired or is invalid. Sign out and sign in again to reconnect.":w?w.message:`AI request failed: ${b.message}`:"AI request failed.";w&&ot(w),A(j),$t(!(b instanceof ve&&b.message==="reauth_required")),On({ok:!1,error:j}),await K(t)}}finally{se.current===i&&(se.current=null),Be(!1),je(""),Te(""),rt(null),oe(null)}}function Sr(){var t;(t=se.current)==null||t.abort()}async function Xe(){var t;N||!H||c.length===0||((t=wt.current)==null||t.followOutput(),await pn(c))}async function Cr(t,i,u,g){if(B.current.sessionKey!==u||B.current.disabledTools.includes(Nt)||g.aborted||P.current===i||!Tn(t))return;const{observerModel:k,model:C,modelsSettled:b,modelOffered:w,zenInfoFor:j}=B.current,q=k&&(!b||w(k))?k:C;pt(!0);try{const ce=await Ta({model:q,request:Ea(t),html:P.current,consoleEntries:We.current,zenModelInfo:j(q),zenSession:or(q),signal:g});ce&&B.current.sessionKey===u&&Ne(ce)}finally{pt(!1)}}async function jr(t){if(N||!H)return;if(c.length===0){A("Nothing to compact — the conversation is empty.");return}const i=new AbortController;se.current=i,Be(!0),Xt(!0),A(null);try{const u=await Ca({model:S,profile:Rn,contents:c,instructions:t||void 0,generationConfig:Ln("off",S),zenSession:on(),signal:i.signal});await be(ja(u,Rn))}catch(u){u instanceof DOMException&&u.name==="AbortError"||A(u instanceof ve?`Compaction failed: ${u.message}`:"Compaction failed.")}finally{se.current===i&&(se.current=null),Be(!1),Xt(!1)}}async function be(t){p(t),Oe(jn(t)),await K(t)}async function Tr(t){if(N)return;const i=c;if(!(!await s({title:"Delete from history?",body:t.kind==="tool"||t.kind==="grouped-search"?`Removes ${t.refs.length===1?"this tool call and its result":`these ${t.refs.length} tool calls and their results`} from the context sent to the model. The page itself is not affected.`:t.kind==="thought"?"Clears this reasoning from the context sent to the model. The page itself is not affected.":"Removes this record from the context sent to the model. The page itself is not affected.",confirmLabel:"Delete",variant:"danger"})||ln.current||B.current.contents!==i))switch(t.kind){case"user":case"compact":await be(xa(c,t.contentIndex));break;case"thought":await be(wa(c,t.refs));break;case"tool":case"grouped-search":await be(va(c,t.refs));break;case"assistant":await be(ba(c,t.refs));break}}async function Er(t,i){N||t.kind!=="user"&&t.kind!=="assistant"||B.current.contents===c&&await be(ya(c,t.refs,i))}const Me=Kr({mutationFn:async t=>{const i=P.current;if(n){const g=await xe.patchPage(n,{html:i});return{id:n,isNew:!1,url:null,html:i,visibility:hr,updatedAt:g.updated_at}}const u=await xe.createPage(i,{alias:(t==null?void 0:t.alias)||null,visibility:(t==null?void 0:t.visibility)??"public",grants:(t==null?void 0:t.grants)??[]});return{id:u.id,isNew:!0,url:u.url,html:i,visibility:(t==null?void 0:t.visibility)??"public",updatedAt:u.updated_at}},onSuccess:async({id:t,isNew:i,url:u,html:g,visibility:k,updatedAt:C})=>{if(A(null),ft(!1),Yt(k),X.current=g,lt(g),ee.current=C??ee.current,he(null),a.invalidateQueries({queryKey:["pages"]}),a.invalidateQueries({queryKey:["page",t]}),a.invalidateQueries({queryKey:["page-history",t]}),i)await Ke({key:t,pageId:t,html:P.current,contents:c,model:S||null,thinking:I,disabledTools:O,knownTools:Tt(),observerModel:re||void 0,zenSessionId:$.current??void 0,basedOnUpdatedAt:ee.current??void 0,updatedAt:0}).catch(()=>{}),await Et("draft").catch(()=>{}),ut(u),ht({url:u??`/p/${t}`,id:t,isNew:!0,visibility:k});else{const b=dt??`/p/${t}`;ut(b),ht({url:b,id:t,isNew:!1,visibility:k})}},onError:t=>{t instanceof ve&&t.body&&typeof t.body=="object"&&"reason"in t.body?A(`Publish failed: ${t.message} (${String(t.body.reason)})`):t instanceof ve?A(`Publish failed: ${t.message}`):A("Publish failed.")}});async function Nr(){if(await s({title:"Reset builder",body:n?"Clears the conversation and restores the HTML from the published page.":"Clears the conversation and the draft HTML. This cannot be undone.",confirmLabel:"Reset",variant:"danger"}))if(await Et(r).catch(()=>{}),p(Pe),Ye.current=Pe,Oe(0),A(null),Ne(null),$.current=null,ue.current=null,n)try{const i=await xe.getPage(n);Y(i.html),X.current=i.html,ee.current=i.updated_at,he(null)}catch{A("Failed to reload page.")}else Y(we),X.current=we}async function Ar(){if(P.current!==X.current){if(!await s({title:"Unpublished changes",body:"You have unpublished changes to this page. Publish them first, or discard them and start a new page.",confirmLabel:"Discard & start new",variant:"danger"}))return;X.current=P.current}const t=await Cn("draft").catch(()=>{});t&&(t.contents.length>0||t.html!==we)&&await s({title:"Unfinished draft",body:"You have an unfinished draft. Start fresh and discard it, or resume where you left off?",confirmLabel:"Start fresh",cancelLabel:"Resume draft",variant:"danger"})&&await Et("draft").catch(()=>{}),o("/")}async function Lr(t){var g;const i=(g=t.target.files)==null?void 0:g[0];if(t.target.value="",!i)return;const u=await i.text();Y(u),A(null),K(c)}async function St(t){if(t.length===0)return;if(ie&&!pe){A(`${Ie} cannot read attachments. Switch models to attach files.`);return}if(pe&&t.some(g=>!g.type.startsWith("image/"))){A(`${Ie} accepts images only. Other file types need a Google model.`);return}const i=[],u=[];for(const g of t){let k=g;if(er(g)){Bt(b=>[...b,g.name]);try{k=await no(g)}catch(b){u.push(b.message);continue}finally{Bt(b=>{const w=b.indexOf(g.name);return w<0?b:[...b.slice(0,w),...b.slice(w+1)]})}}else if(to(g)){u.push(`"${g.name}" is the pre-2007 .ppt format. Save it as .pptx first.`);continue}const C=await Oa(k);"error"in C?u.push(C.error):i.push(C)}i.length>0&&tt(g=>[...g,...i]),u.length>0&&A(u.join(" "))}function Rr(t){const i=Array.from(t.target.files??[]);t.target.value="",St(i)}const Ct=l.useMemo(()=>aa(c),[c]),mn=rr&&F.length>0,De=c[c.length-1],Mr=(De==null?void 0:De.role)==="user"&&De.parts.some(oa),gn=!N&&!!De&&!Tn(c)&&!Mr,Dr=((vn=Ct[Ct.length-1])==null?void 0:vn.kind)==="user";return h?e.jsxs("div",{className:"flex min-h-[480px] flex-1 flex-col gap-3",children:[e.jsxs("div",{className:"flex flex-wrap items-center gap-2",children:[e.jsx(sa,{choice:T,disabled:N}),e.jsxs("button",{type:"button",onClick:()=>zt(t=>!t),disabled:y,className:E("inline-flex h-8 items-center gap-1.5 rounded-md border border-border px-2.5 text-[12px] disabled:opacity-50",V?"bg-ink text-white":"bg-surface text-fg-2 hover:text-fg"),children:[e.jsx(Kn,{className:"h-3.5 w-3.5"})," Code"]}),e.jsxs("div",{className:E("flex items-center gap-1 rounded-md border border-border bg-surface p-0.5 text-[11px]",(V||y&&W!=="preview")&&"opacity-50"),children:[e.jsxs("button",{type:"button",onClick:()=>Gt("desktop"),disabled:V||y&&W!=="preview",title:"Preview at full width",className:E("inline-flex items-center gap-1 rounded-sm px-2 py-1",_e==="desktop"?"bg-ink text-white":"text-fg-2 hover:text-fg"),children:[e.jsx(Fr,{className:"h-3.5 w-3.5"})," Desktop"]}),e.jsxs("button",{type:"button",onClick:()=>Gt("mobile"),disabled:V||y&&W!=="preview",title:"Preview at phone width",className:E("inline-flex items-center gap-1 rounded-sm px-2 py-1",_e==="mobile"?"bg-ink text-white":"text-fg-2 hover:text-fg"),children:[e.jsx(Br,{className:"h-3.5 w-3.5"})," Mobile"]})]}),e.jsxs("button",{type:"button",onClick:()=>gr(t=>t+1),disabled:V||y,title:"Reload the preview (recovers a broken or navigated-away preview)",className:"inline-flex h-8 items-center gap-1.5 rounded-md border border-border bg-surface px-2.5 text-[12px] text-fg-2 hover:text-fg disabled:opacity-50",children:[e.jsx(wn,{className:"h-3.5 w-3.5"})," Reload"]}),e.jsxs("button",{type:"button",onClick:()=>{var t;return(t=rn.current)==null?void 0:t.click()},disabled:N||y,title:"Load an .html file into the builder (replaces the current document)",className:"inline-flex h-8 items-center gap-1.5 rounded-md border border-border bg-surface px-2.5 text-[12px] text-fg-2 hover:text-fg disabled:opacity-50",children:[e.jsx(_r,{className:"h-3.5 w-3.5"})," Upload"]}),e.jsx("input",{ref:rn,type:"file",accept:".html,.htm,text/html",hidden:!0,onChange:Lr}),e.jsxs("button",{type:"button",onClick:Nr,disabled:N||y,className:"inline-flex h-8 items-center gap-1.5 rounded-md border border-border bg-surface px-2.5 text-[12px] text-fg-2 hover:text-fg disabled:opacity-50",children:[e.jsx(Hr,{className:"h-3.5 w-3.5"})," Reset"]}),n?e.jsxs("button",{type:"button",onClick:Ar,disabled:N||y,title:"Start a new page in the draft builder",className:"inline-flex h-8 items-center gap-1.5 rounded-md border border-border bg-surface px-2.5 text-[12px] text-fg-2 hover:text-fg disabled:opacity-50",children:[e.jsx(Or,{className:"h-3.5 w-3.5"})," New"]}):null,n?e.jsxs("button",{type:"button",onClick:()=>y?qe():Qt(!0),title:"Browse previously published versions of this page",className:E("inline-flex h-8 items-center gap-1.5 rounded-md border border-border px-2.5 text-[12px]",y?"bg-ink text-white":"bg-surface text-fg-2 hover:text-fg"),children:[e.jsx(Xn,{className:"h-3.5 w-3.5"})," History"]}):null,e.jsxs("div",{className:"ml-auto flex items-center gap-2",children:[dt?e.jsxs("a",{href:dt,target:"_blank",rel:"noreferrer",className:"inline-flex items-center gap-1 text-[12px] text-fg-2 hover:text-fg",children:["View live ",e.jsx($r,{className:"h-3 w-3"})]}):null,e.jsxs(te,{size:"sm",onClick:()=>n?Me.mutate(void 0):ft(!0),disabled:N||Me.isPending||y,children:[Me.isPending?e.jsx(xn,{className:"h-3.5 w-3.5 animate-spin"}):e.jsx(Yn,{className:"h-3.5 w-3.5"}),n?"Publish update":"Publish"]})]})]}),at&&!y?e.jsxs("div",{className:"flex items-center gap-2 rounded-md border border-no/30 bg-no-soft px-3 py-2 text-[12px] text-no-strong",children:[e.jsx("span",{className:"min-w-0 flex-1 break-words",children:at}),cr&&!N?e.jsxs("button",{type:"button",onClick:()=>void Xe(),className:"inline-flex shrink-0 items-center gap-1 rounded border border-no/30 bg-surface px-2 py-0.5 text-[11px] font-medium text-no-strong hover:bg-no-soft",children:[e.jsx(wn,{className:"h-3 w-3"})," Retry"]}):null]}):null,Wt!==null&&!y?e.jsxs("div",{className:"flex items-center gap-2 rounded-md border border-border bg-surface-muted px-3 py-2 text-[12px] text-fg-2",children:[e.jsx("span",{className:"min-w-0 flex-1 break-words",children:"This page was updated outside this browser — loaded the latest published version."}),e.jsxs("button",{type:"button",onClick:()=>{Y(Wt),he(null),K(c)},className:"inline-flex shrink-0 items-center gap-1 rounded border border-border bg-surface px-2 py-0.5 text-[11px] font-medium text-fg hover:bg-surface-muted",children:[e.jsx(Ur,{className:"h-3 w-3"})," Keep my local copy"]}),e.jsx("button",{type:"button",onClick:()=>he(null),"aria-label":"Dismiss",className:"shrink-0 rounded p-0.5 text-fg-3 hover:text-fg",children:e.jsx(jt,{className:"h-3 w-3"})})]}):null,(G||mn)&&!y?e.jsxs("div",{className:"space-y-2",children:[e.jsxs("div",{className:"rounded-md border border-border bg-surface-muted px-3 py-2 text-[12px] text-fg-2",children:[G?"AI is unavailable — ":"Google models are unavailable — ",Je==="no_project"?e.jsxs(e.Fragment,{children:["no Code Assist project selected for your account."," ",e.jsx(Ka,{to:"/settings",className:"underline hover:text-fg",children:"Choose one in Settings"}),"."]}):Je==="reauth_required"?"your Google credential has expired or is invalid. Sign out and sign in again to reconnect.":"could not load models. Try again later.",mn?" Free models are listed in the model picker and need no Google account.":null]}),Je==="no_project"?e.jsx(Ua,{}):null]}):null,gn&&!at&&!Dr&&!y?e.jsxs("div",{className:"flex items-center gap-2 rounded-md border border-border bg-surface-muted px-3 py-2 text-[12px] text-fg-2",children:[e.jsx("span",{className:"min-w-0 flex-1",children:"Aero stopped before finishing — resume to keep going."}),e.jsxs("button",{type:"button",onClick:()=>void Xe(),disabled:G||!H,className:"inline-flex shrink-0 items-center gap-1 rounded border border-border bg-surface px-2 py-0.5 text-[11px] font-medium text-fg-2 hover:bg-surface-muted disabled:opacity-50",children:[e.jsx(yn,{className:"h-3 w-3"})," Resume"]})]}):null,e.jsxs("div",{className:"flex min-h-0 flex-1 gap-4",children:[e.jsx("div",{className:E("flex w-[380px] shrink-0 flex-col rounded-lg border border-border bg-surface",sr&&"ring-2 ring-ink"),onDragOver:t=>{y||(t.preventDefault(),nt(!0))},onDragLeave:()=>nt(!1),onDrop:t=>{y||(t.preventDefault(),nt(!1),St(Array.from(t.dataTransfer.files)))},children:y?e.jsx(Ao,{entries:D.data,isLoading:D.isLoading,isError:D.isError,isFetching:D.isFetching||Zt,selectedSha:(L==null?void 0:L.sha)??null,onSelect:Ue,onRefresh:br}):e.jsx(ia,{ref:wt,chat:Ct,busy:N,streamText:ir,streamThought:lr,busyLabel:pr?"compacting conversation…":mr?"reviewing the page…":Oo(_t,Ht,Ut),toolActive:_t!==null,retrying:Ut!==null,busyElapsed:Ht,emptyState:e.jsxs(e.Fragment,{children:["Describe the page you want to build.",e.jsx("br",{}),"Aero edits the HTML and you preview it live.",e.jsx("br",{}),"Or upload an existing .html file to start from."]}),renderToolItem:$o,afterMessages:U?e.jsxs("div",{className:"rounded-md border border-border bg-surface-muted px-3 py-2 text-[12px] text-fg-2",children:[e.jsxs("div",{className:"flex items-center gap-1.5",children:[U.kind==="issues"?e.jsx(zr,{className:"h-3.5 w-3.5 shrink-0 text-warning"}):U.kind==="pass"?e.jsx(Wn,{className:"h-3.5 w-3.5 shrink-0 text-success"}):e.jsx(Jn,{className:"h-3.5 w-3.5 shrink-0 text-fg-3"}),e.jsx("span",{className:"min-w-0 flex-1",children:U.kind==="issues"?e.jsxs("span",{className:"font-medium text-fg-2",children:["Review found"," ",U.findings.length===1?"1 thing":`${U.findings.length} things`," ","to check"]}):U.kind==="pass"?e.jsxs("span",{className:"text-fg-3",children:[e.jsx("span",{className:"font-medium text-fg-2",children:"Review passed"})," — nothing to flag on this change."]}):e.jsxs("span",{className:"text-fg-3",children:[e.jsx("span",{className:"font-medium text-fg-2",children:"Review didn’t run."})," The build finished normally — only the review failed."]})}),e.jsx("button",{type:"button",onClick:()=>Ne(null),"aria-label":"Dismiss review",title:"Dismiss review",className:"shrink-0 rounded p-0.5 text-fg-3 hover:bg-surface hover:text-fg-2",children:e.jsx(jt,{className:"h-3 w-3"})})]}),U.kind==="issues"?e.jsxs(e.Fragment,{children:[e.jsx("ul",{className:"mt-1.5 space-y-1 pl-5",children:U.findings.map((t,i)=>e.jsx("li",{className:"list-disc text-fg-2",children:t},i))}),e.jsx("div",{className:"mt-2 pl-5",children:e.jsxs("button",{type:"button",onClick:()=>void fn(da(U.findings)),disabled:N||G||!H,className:"inline-flex shrink-0 items-center gap-1 rounded border border-border bg-surface px-2 py-0.5 text-[11px] font-medium text-fg-2 hover:bg-surface-muted disabled:opacity-50",children:[e.jsx(yn,{className:"h-3 w-3"})," Fix these"]})})]}):null]}):null,canResume:gn,resumeDisabled:G||!H,onResume:()=>void Xe(),onSaveItemEdit:(t,i)=>void Er(t,i),onDeleteItem:t=>void Tr(t),input:Ce,onInputChange:et,onSend:()=>void fn(),onStop:Sr,composerDisabled:N||G||!H,sendDisabled:G||!H||Fe.length>0||!Ce.trim()&&ae.length===0||kr,placeholder:G?"AI unavailable":!H&&z?"Pick a model to continue — the last one is no longer available":"Ask Aero to build or change something…",slashCommands:zn,composerMeta:e.jsxs("div",{className:"flex min-w-0 items-center gap-2 text-[11px] text-fg-3",children:[yr?e.jsx("span",{className:E("tabular truncate",cn&&"font-medium text-no-strong"),title:`Estimated request size with attached files: ${de(ge)} of ${de(me)} — requests over that are rejected`,children:cn?`${de(ge)} / ${de(me)}`:de(ge)}):null,e.jsx("span",{className:E("tabular truncate",dn&&"font-medium text-no-strong"),title:`Approximate context window usage: ${An(He)} of ${hn} tokens (${un}% left) — ${ie?"free models are held to a 200K-token context":"all Gemini models have a ~1M-token context"}`,children:dn?`${An(He)} / ${hn}`:`${un}% left`})]}),attachmentsBar:ae.length>0||Fe.length>0?e.jsxs("div",{className:"flex flex-wrap gap-1.5 px-3 pt-2.5",children:[ae.map(t=>e.jsxs("div",{className:"flex items-center gap-1.5 overflow-hidden rounded-md border border-border bg-surface-muted pr-1.5 text-[11px]",children:[t.kind==="inline"&&t.mimeType.startsWith("image/")?e.jsx("img",{src:`data:${t.mimeType};base64,${t.data}`,alt:t.name,className:"h-7 w-7 shrink-0 object-cover"}):e.jsx("span",{className:"flex h-7 w-7 shrink-0 items-center justify-center text-fg-3",children:ca(t.mimeType)}),e.jsx("span",{className:"max-w-[8rem] truncate text-fg-2",title:t.name,children:t.name}),e.jsx("button",{type:"button",onClick:()=>tt(i=>i.filter(u=>u.id!==t.id)),title:"Remove",className:"text-fg-3 hover:text-fg",children:e.jsx(jt,{className:"h-3 w-3"})})]},t.id)),Fe.map((t,i)=>e.jsxs("div",{className:"flex items-center gap-1.5 rounded-md border border-border bg-surface-muted pr-1.5 text-[11px]",children:[e.jsx("span",{className:"flex h-7 w-7 shrink-0 items-center justify-center text-fg-3",children:e.jsx(xn,{className:"h-3.5 w-3.5 animate-spin"})}),e.jsxs("span",{className:"max-w-[8rem] truncate text-fg-2",title:t,children:["Converting ",t,"…"]})]},`converting-${i}`))]}):void 0,composerLeading:e.jsxs("div",{className:"flex shrink-0 items-center gap-0.5",children:[e.jsxs(Ma,{children:[e.jsx(Da,{asChild:!0,children:e.jsxs(te,{variant:"ghost",size:"sm","aria-label":"Which tools the agent may use",title:"Which tools the agent may use",className:E(En,"relative"),children:[e.jsx(Qn,{className:"h-3.5 w-3.5"}),O.length>0?e.jsx("span",{className:"absolute right-1 top-1 h-1.5 w-1.5 rounded-full bg-status"}):null]})}),e.jsx(Pa,{className:"w-60",children:la.map(t=>e.jsxs(l.Fragment,{children:[e.jsx(Ia,{checked:!t.names.some(i=>O.includes(i)),disabled:!!Nn(t.names,{browseAvailable:v}),onCheckedChange:i=>{const u=i?O.filter(g=>!t.names.includes(g)):[...new Set([...O,...t.names])];Ft(u),K(c,u)},children:e.jsxs("span",{className:"flex flex-col",children:[e.jsx("span",{children:t.label}),e.jsx("span",{className:"text-[11px] text-fg-3",children:Nn(t.names,{browseAvailable:v})??t.hint})]})}),t.names.includes(Nt)&&!O.includes(Nt)?e.jsxs(Fa,{children:[e.jsx(Ba,{children:e.jsxs("span",{className:"flex flex-col",children:[e.jsx("span",{children:"Reviewer model"}),e.jsx("span",{className:"text-[11px] text-fg-3",children:xr()})]})}),e.jsx(_a,{className:"max-h-72 w-56 overflow-y-auto",children:e.jsxs(Ha,{value:re,onValueChange:i=>{Ze(i),K(c,O,i)},children:[e.jsx(Lt,{value:"",children:"Same as builder"}),ke.length>0?e.jsxs(e.Fragment,{children:[e.jsx(Dn,{children:"Google"}),ke.map(i=>e.jsx(Lt,{value:i,children:i},i))]}):null,F.length>0?e.jsxs(e.Fragment,{children:[e.jsx(Dn,{children:"Free · opencode zen"}),F.map(i=>e.jsx(Lt,{value:i.id,children:i.name},i.id))]}):null]})})]}):null]},t.id))})]}),ie&&!pe?null:e.jsxs(e.Fragment,{children:[e.jsx(te,{variant:"ghost",size:"sm",onClick:()=>{var t;return(t=an.current)==null?void 0:t.click()},disabled:N||G||!H,title:pe?"Attach an image":"Attach a file (image, PDF, audio, video, PowerPoint, or text)",className:En,children:e.jsx(qr,{className:"h-3.5 w-3.5"})}),e.jsx("input",{ref:an,type:"file",multiple:!0,hidden:!0,...pe?{accept:"image/*"}:{},onChange:Rr})]})]}),onPasteFiles:t=>void St(t)})}),e.jsx("div",{className:"flex min-w-0 flex-1 flex-col overflow-hidden rounded-lg border border-border bg-surface",children:y?e.jsxs(e.Fragment,{children:[e.jsx(Lo,{entry:L,canRestore:!!L&&M.data!==void 0,onRestore:()=>{M.data!==void 0&&(Y(M.data),K(c)),qe()},onExit:qe}),L?e.jsxs("div",{className:"flex items-center gap-2 border-b border-border px-3 py-1.5",children:[e.jsxs("div",{className:"flex items-center gap-1 rounded-md border border-border bg-surface p-0.5 text-[11px]",children:[e.jsx("button",{type:"button",onClick:()=>mt("preview"),className:E("rounded-sm px-2 py-1",W==="preview"?"bg-ink text-white":"text-fg-2 hover:text-fg"),children:"Preview"}),e.jsx("button",{type:"button",onClick:()=>mt("diff"),className:E("rounded-sm px-2 py-1",W==="diff"?"bg-ink text-white":"text-fg-2 hover:text-fg"),children:"Diff"})]}),W==="diff"?e.jsxs("div",{className:"flex items-center gap-1 rounded-md border border-border bg-surface p-0.5 text-[11px]",children:[e.jsx("button",{type:"button",onClick:()=>gt("previous"),className:E("rounded-sm px-2 py-1",Z==="previous"?"bg-surface-muted text-fg":"text-fg-3 hover:text-fg-2"),children:"vs Previous version"}),e.jsx("button",{type:"button",onClick:()=>gt("draft"),className:E("rounded-sm px-2 py-1",Z==="draft"?"bg-surface-muted text-fg":"text-fg-3 hover:text-fg-2"),children:"vs Current draft"})]}):null]}):null,W==="diff"&&L?Z==="previous"&&!Ae?e.jsx("div",{className:"p-4 text-[12px] text-fg-3",children:"This is the first published version — nothing to compare it against."}):Z==="previous"&&ze.isLoading||M.isLoading?e.jsx("div",{className:"p-4 text-[12px] text-fg-3",children:"Loading diff…"}):Z==="previous"&&ze.isError||M.isError?e.jsx("div",{className:"p-4 text-[12px] text-no-strong",children:"Failed to load diff."}):Z==="previous"&&ze.data!==void 0&&M.data!==void 0?e.jsx(Dt,{oldText:ze.data,newText:M.data,oldLabel:`Version from ${new Date(Ae.committed_at).toLocaleString()}`,newLabel:`Version from ${new Date(L.committed_at).toLocaleString()}`}):Z==="draft"&&M.data!==void 0?e.jsx(Dt,{oldText:d,newText:M.data,oldLabel:"Current draft",newLabel:`Version from ${new Date(L.committed_at).toLocaleString()}`}):null:W==="preview"?M.isLoading?e.jsx("div",{className:"p-4 text-[12px] text-fg-3",children:"Loading version…"}):M.isError?e.jsx("div",{className:"p-4 text-[12px] text-no-strong",children:"Failed to load this version."}):Le?e.jsx("div",{className:"flex h-full w-full justify-center overflow-auto bg-surface-muted",children:e.jsx("iframe",{title:"historic version preview",src:Le,sandbox:"allow-scripts allow-modals allow-forms allow-popups",className:E("h-full bg-white",_e==="mobile"?"w-[390px] shrink-0 border-x border-border":"w-full flex-1")})}):e.jsx("div",{className:"p-4 text-[12px] text-fg-3",children:"Select a version from the list to preview it."}):null]}):V?e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"flex items-center gap-2 border-b border-border px-3 py-1.5",children:e.jsxs("div",{className:"flex items-center gap-1 rounded-md border border-border bg-surface p-0.5 text-[11px]",children:[e.jsx("button",{type:"button",onClick:()=>it("code"),className:E("rounded-sm px-2 py-1",st==="code"?"bg-ink text-white":"text-fg-2 hover:text-fg"),children:"Code"}),e.jsx("button",{type:"button",onClick:()=>it("diff"),disabled:!ct,title:ct?void 0:"Diff becomes available once this page has been published",className:E("rounded-sm px-2 py-1 disabled:opacity-50",st==="diff"?"bg-ink text-white":"text-fg-2 hover:text-fg"),children:"Diff"})]})}),st==="diff"&&ct?e.jsx(Dt,{oldText:Vt,newText:d,oldLabel:"Last published version",newLabel:"Current draft"}):e.jsx(l.Suspense,{fallback:e.jsx("div",{className:"p-3 text-[12px] text-fg-3",children:"Loading editor…"}),children:e.jsx(Bo,{value:d,onChange:Y,language:"html",className:"flex-1 overflow-auto"})})]}):e.jsx("div",{className:"flex h-full w-full justify-center overflow-auto bg-surface-muted",children:e.jsx("iframe",{ref:Ve,title:"preview",src:fe,sandbox:"allow-scripts allow-modals allow-forms allow-popups",className:E("h-full bg-white",_e==="mobile"?"w-[390px] shrink-0 border-x border-border":"w-full flex-1")},Kt)})})]}),fr?e.jsx(Eo,{initialAlias:dr,busy:Me.isPending,onCancel:()=>ft(!1),onPublish:t=>{ur(t.alias),Me.mutate(t)}}):null,Ee?e.jsx(To,{url:Ee.url,isNew:Ee.isNew,visibility:Ee.visibility,onClose:()=>{const t=Ee;ht(null),t.isNew&&o(`/builder/${t.id}`,{replace:!0,state:{publishContinuation:!0}})}}):null,qt?e.jsx(Va,{info:qt,onEnabled:()=>{ot(null),A(null),Xe()},onClose:()=>ot(null)}):null]}):e.jsx("div",{className:"text-fg-3",children:"Loading…"})}export{es as BuilderPage};
