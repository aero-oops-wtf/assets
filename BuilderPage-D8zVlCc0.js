...
`,Ba=`# Aero HTML Slides Style Guide
...
`,Ha=`# aero-ai: calling Gemini from inside an aero page
...
})();<\/script>`;function Nn(n,r){const s=Va+$a+Ga+(r!=null&&r.screenshot?Wa:"")+Ya,i=n.match(/<head[^>]*>/i);if(!i)return s+n;const c=i.index+i[0].length;return n.slice(0,c)+s+n.slice(c)}function Ka({url:n,isNew:r,visibility:s,onClose:i}){const c=o.useRef(null),d=o.useRef(null);o.useEffect(()=>{const h=d.current;h&&!h.contains(document.activeElement)&&h.focus()},[]);function u(h){if(h.key==="Escape"){i();return}if(h.key!=="Tab")return;const p=c.current;if(!p)return;const f=p.querySelectorAll(["a[href]","button:not([disabled])","input:not([disabled])","select:not([disabled])","textarea:not([disabled])",'[contenteditable="true"]','[tabindex]:not([tabindex="-1"])'].join(", "));if(f.length===0)return;const g=f[0],L=f[f.length-1],M=document.activeElement;h.shiftKey&&(M===g||!p.contains(M))?(h.preventDefault(),L.focus()):!h.shiftKey&&(M===L||!p.contains(M))&&(h.preventDefault(),g.focus())}return e.jsx("div",{ref:d,tabIndex:-1,className:"fixed inset-0 z-50 grid place-items-center bg-ink/45 p-4 backdrop-blur-sm focus:outline-none",role:"dialog","aria-modal":"true","aria-labelledby":"publish-success-title",onKeyDown:u,onMouseDown:h=>{h.target===h.currentTarget&&i()},children:e.jsxs("div",{ref:c,className:"w-full max-w-md rounded-lg border border-border bg-surface shadow-lg",children:[e.jsxs("div",{className:"flex flex-col items-center gap-2 px-6 pt-6 text-center",children:[e.jsx(In,{className:"h-10 w-10 text-success"}),e.jsx("div",{id:"publish-success-title",className:"text-[15px] font-semibold text-fg",children:r?"Page published":"Update published"}),e.jsx("p",{className:"text-[12px] text-fg-2",children:r?s==="private"?"Your page is live. Only you and the people you added can open it.":"Your page is live. Anyone with the link can view it.":"The live page now shows your latest changes."})]}),e.jsx("div",{className:"px-6 py-4",children:e.jsx(Ea,{url:n})}),e.jsx("div",{className:"flex justify-end border-t border-border px-6 py-3",children:e.jsx(ee,{autoFocus:!0,onClick:i,children:"Done"})})]})})}function Xa({initialAlias:n,busy:r,onCancel:s,onPublish:i}){const[c,d]=o.useState(n),[u,h]=o.useState("public"),[p,f]=o.useState([]),g=o.useRef(null),L=o.useRef(null);o.useEffect(()=>{const w=L.current;w&&!w.contains(document.activeElement)&&w.focus()},[]);function M(w){if(w.key==="Escape"){s();return}if(w.key!=="Tab")return;const S=g.current;if(!S)return;const H=S.querySelectorAll(["a[href]","button:not([disabled])","input:not([disabled])","select:not([disabled])","textarea:not([disabled])",'[contenteditable="true"]','[tabindex]:not([tabindex="-1"])'].join(", "));if(H.length===0)return;const P=H[0],te=H[H.length-1],y=document.activeElement;w.shiftKey&&(y===P||!S.contains(y))?(w.preventDefault(),te.focus()):!w.shiftKey&&(y===te||!S.contains(y))&&(w.preventDefault(),P.focus())}return e.jsx("div",{ref:L,tabIndex:-1,className:"fixed inset-0 z-50 grid place-items-center bg-ink/45 p-4 backdrop-blur-sm focus:outline-none",role:"dialog","aria-modal":"true","aria-labelledby":"pre-publish-title",onKeyDown:M,onMouseDown:w=>{w.target===w.currentTarget&&!r&&s()},children:e.jsxs("div",{ref:g,className:"w-full max-w-md rounded-lg border border-border bg-surface shadow-lg",children:[e.jsxs("div",{className:"border-b border-border px-6 py-4",children:[e.jsx("div",{id:"pre-publish-title",className:"text-[15px] font-semibold text-fg",children:"Publish app"}),e.jsx("p",{className:"mt-1 text-[12px] text-fg-2",children:"Choose the address and who can open it. You can change both later from Apps."})]}),e.jsxs("div",{className:"space-y-4 px-6 py-4",children:[e.jsxs("div",{children:[e.jsx(Cn,{htmlFor:"publish-alias",hint:"optional — leave blank for a UUID URL",children:"Alias"}),e.jsx(Aa,{id:"publish-alias",autoFocus:!0,value:c,disabled:r,onChange:w=>d(w.target.value.toLowerCase()),placeholder:"my-app"}),e.jsxs("div",{className:"mt-1 font-mono text-[11px] text-fg-3",children:["/p/",c.trim()||"<uuid>"]})]}),e.jsxs("div",{children:[e.jsx(Cn,{children:"Who can open it"}),e.jsx(Na,{visibility:u,onVisibilityChange:h,grants:p,onGrantsChange:f,disabled:r})]})]}),e.jsxs("div",{className:"flex justify-end gap-2 border-t border-border px-6 py-3",children:[e.jsx(ee,{variant:"secondary",onClick:s,disabled:r,children:"Cancel"}),e.jsxs(ee,{onClick:()=>i({alias:c.trim(),visibility:u,grants:p}),disabled:r,children:[e.jsx(Pn,{className:"h-3.5 w-3.5"}),r?"Publishing…":"Publish"]})]})]})})}function Qa(n,r){return On({queryKey:["page-history",n],queryFn:()=>ve.getPageHistory(n).then(s=>s.versions),enabled:r,retry:!1})}function An(n,r){return On({queryKey:["page-history-version",n,r],queryFn:()=>ve.getPageHistoryVersion(n,r).then(s=>s.html),enabled:r!==null,retry:!1})}function Ja({entries:n,isLoading:r,isError:s,isFetching:i,selectedSha:c,onSelect:d,onRefresh:u}){return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"flex items-center gap-1.5 border-b border-border px-3 py-2.5 text-[12px] font-semibold text-fg",children:[e.jsx(Fn,{className:"h-3.5 w-3.5 text-fg-3"}),e.jsx("span",{className:"flex-1",children:"Version history"}),e.jsx("button",{type:"button",onClick:u,disabled:i,title:"Refresh — GitHub sync runs in the background, so a just-published version can take a moment to appear",className:"font-normal text-fg-3 hover:text-fg disabled:opacity-50",children:"Refresh"})]}),e.jsxs("div",{className:"scroll-slim flex-1 overflow-y-auto p-1.5",children:[r?e.jsx("div",{className:"px-2 py-2 text-[12px] text-fg-3",children:"Loading…"}):null,s?e.jsx("div",{className:"px-2 py-2 text-[12px] text-no-strong",children:"Failed to load history."}):null,n&&n.length===0?e.jsx("div",{className:"px-2 py-2 text-[12px] text-fg-3",children:"No published versions yet."}):null,(n??[]).map(h=>{const p=h.sha===c;return e.jsxs("button",{type:"button",onClick:()=>d(h),className:j("block w-full rounded-md px-2.5 py-2 text-left",p?"bg-ink":"hover:bg-surface-muted"),children:[e.jsx("div",{className:j("text-[12px] font-medium",p?"text-white":"text-fg"),children:new Date(h.committed_at).toLocaleString()}),e.jsxs("div",{className:j("truncate text-[11px]",p?"text-white/70":"text-fg-3"),children:[h.message,h.author_email?` — ${h.author_email}`:""]})]},h.sha)})]})]})}function Za({entry:n,canRestore:r,onRestore:s,onExit:i}){const c=Dn();return e.jsxs("div",{className:"flex items-center gap-2 border-b border-border bg-surface-muted px-3 py-2 text-[12px]",children:[e.jsx("div",{className:"min-w-0 flex-1 truncate text-fg-2",children:n?e.jsxs(e.Fragment,{children:["Viewing version from ",new Date(n.committed_at).toLocaleString(),n.author_email?` (${n.author_email})`:""," — read-only"]}):"Select a version from the list to preview it"}),e.jsxs(ee,{variant:"secondary",size:"sm",onClick:i,children:[e.jsx(kr,{className:"h-3.5 w-3.5"})," Back to current draft"]}),e.jsx(ee,{size:"sm",disabled:!r,onClick:async()=>{await c({title:"Restore this version",body:"This replaces your current editor content. Unsaved changes will be lost. The page stays unpublished until you publish again.",confirmLabel:"Restore",variant:"danger"})&&s()},children:"Restore this version"})]})}class eo{diff(r,s,i={}){let c;typeof i=="function"?(c=i,i={}):"callback"in i&&(c=i.callback);const d=this.castInput(r,i),u=this.castInput(s,i),h=this.removeEmpty(this.tokenize(d,i)),p=this.removeEmpty(this.tokenize(u,i));return this.diffWithOptionsObj(h,p,i,c)}diffWithOptionsObj(r,s,i,c){var d;const u=y=>{if(y=this.postProcess(y,i),c){setTimeout(function(){c(y)},0);return}else return y},h=s.length,p=r.length;let f=1,g=h+p;i.maxEditLength!=null&&(g=Math.min(g,i.maxEditLength));const L=(d=i.timeout)!==null&&d!==void 0?d:1/0,M=Date.now()+L,w=[{oldPos:-1,lastComponent:void 0}];let S=this.extractCommon(w[0],s,r,0,i);if(w[0].oldPos+1>=p&&S+1>=h)return u(this.buildValues(w[0].lastComponent,s,r));let H=-1/0,P=1/0;const te=()=>{for(let y=Math.max(H,-f);y<=Math.min(P,f);y+=2){let F;const ne=w[y-1],$=w[y+1];ne&&(w[y-1]=void 0);let we=!1;if($){const ye=$.oldPos-y;we=$&&0<=ye&&ye<h}const xe=ne&&ne.oldPos+1<p;if(!we&&!xe){w[y]=void 0;continue}if(!xe||we&&ne.oldPos<$.oldPos?F=this.addToPath($,!0,!1,0,i):F=this.addToPath(ne,!1,!0,1,i),S=this.extractCommon(F,s,r,y,i),F.oldPos+1>=p&&S+1>=h)return u(this.buildValues(F.lastComponent,s,r))||!0;w[y]=F,F.oldPos+1>=p&&(P=Math.min(P,y-1)),S+1>=h&&(H=Math.max(H,y+1))}f++};if(c)(function y(){setTimeout(function(){if(f>g||Date.now()>M)return c(void 0);te()||y()},0)})();else for(;f<=g&&Date.now()<=M;){const y=te();if(y)return y}}addToPath(r,s,i,c,d){const u=r.lastComponent;return u&&!d.oneChangePerToken&&u.added===s&&u.removed===i?{oldPos:r.oldPos+c,lastComponent:{count:u.count+1,added:s,removed:i,previousComponent:u.previousComponent}}:{oldPos:r.oldPos+c,lastComponent:{count:1,added:s,removed:i,previousComponent:u}}}extractCommon(r,s,i,c,d){const u=s.length,h=i.length;let p=r.oldPos,f=p-c,g=0;for(;f+1<u&&p+1<h&&this.equals(i[p+1],s[f+1],d);)f++,p++,g++,d.oneChangePerToken&&(r.lastComponent={count:1,previousComponent:r.lastComponent,added:!1,removed:!1});return g&&!d.oneChangePerToken&&(r.lastComponent={count:g,previousComponent:r.lastComponent,added:!1,removed:!1}),r.oldPos=p,f}equals(r,s,i){return i.comparator?i.comparator(r,s):r===s||!!i.ignoreCase&&r.toLowerCase()===s.toLowerCase()}removeEmpty(r){const s=[];for(let i=0;i<r.length;i++)r[i]&&s.push(r[i]);return s}castInput(r,s){return r}tokenize(r,s){return Array.from(r)}join(r){return r.join("")}postProcess(r,s){return r}get useLongestToken(){return!1}buildValues(r,s,i){const c=[];let d;for(;r;)c.push(r),d=r.previousComponent,delete r.previousComponent,r=d;c.reverse();const u=c.length;let h=0,p=0,f=0;for(;h<u;h++){const g=c[h];if(g.removed)g.value=this.join(i.slice(f,f+g.count)),f+=g.count;else{if(!g.added&&this.useLongestToken){let L=s.slice(p,p+g.count);L=L.map(function(M,w){const S=i[f+w];return S.length>M.length?S:M}),g.value=this.join(L)}else g.value=this.join(s.slice(p,p+g.count));p+=g.count,g.added||(f+=g.count)}}return c}}class to extends eo{constructor(){super(...arguments),this.tokenize=ao}equals(r,s,i){return i.ignoreWhitespace?((!i.newlineIsToken||!r.includes(`
`))&&(r=r.trim()),(!i.newlineIsToken||!s.includes(`
`))&&(s=s.trim())):i.ignoreNewlineAtEof&&!i.newlineIsToken&&(r.endsWith(`
`)&&(r=r.slice(0,-1)),s.endsWith(`
`)&&(s=s.slice(0,-1))),super.equals(r,s,i)}}const no=new to;function ro(n,r,s){return no.diff(n,r,s)}function ao(n,r){r.stripTrailingCr&&(n=n.replace(/\r\n/g,`
`));const s=[],i=n.split(/(\n|\r\n)/);i[i.length-1]||i.pop();for(let c=0;c<i.length;c++){const d=i[c];c%2&&!r.newlineIsToken?s[s.length-1]+=d:s.push(d)}return s}function oo(n,r){const s=[];let i=0;for(const c of ro(n,r)){const d=c.added?"added":c.removed?"removed":"context",u=c.value.split(`
`);u.length>0&&u[u.length-1]===""&&u.pop();for(const h of u)s.push({key:i++,kind:d,text:h})}return s}function At({oldText:n,newText:r,oldLabel:s,newLabel:i}){const c=o.useMemo(()=>oo(n,r),[n,r]),d=c.every(u=>u.kind==="context");return e.jsxs("div",{className:"flex h-full min-h-0 flex-col overflow-hidden",children:[e.jsxs("div",{className:"flex items-center gap-3 border-b border-border bg-surface-muted px-3 py-1.5 text-[11px]",children:[e.jsxs("span",{className:"text-no-strong",children:["− ",s]}),e.jsxs("span",{className:"text-success",children:["+ ",i]})]}),e.jsx("div",{className:"scroll-slim flex-1 overflow-auto",children:d?e.jsx("div",{className:"p-4 text-[12px] text-fg-3",children:"No differences."}):e.jsx("div",{className:"min-w-max font-mono text-[12px] leading-5",children:c.map(u=>e.jsxs("div",{className:j("flex whitespace-pre px-3",u.kind==="added"&&"bg-status-soft",u.kind==="removed"&&"bg-no-soft",u.kind==="context"&&"text-fg-2"),children:[e.jsx("span",{className:j("mr-2 shrink-0 select-none",u.kind==="added"&&"text-success",u.kind==="removed"&&"text-no-strong",u.kind==="context"&&"text-fg-3"),children:u.kind==="added"?"+":u.kind==="removed"?"−":" "}),e.jsx("span",{children:u.text||" "})]},u.key))})})]})}const io=o.lazy(()=>yr(()=>import("./CodeEditor-B9Q8UEYj.js"),__vite__mapDeps([0,1,2,3,4,5]),import.meta.url).then(n=>({default:n.CodeEditor}))),be=`<!doctype html>
<html lang="en">
<head>
<meta charset="utf-8">
...
`,Ie=[];function Rn(n){return n<1e3?String(n):n<1e6?`${(n/1e3).toFixed(n<1e4?1:0)}k`:`${(n/1e6).toFixed(2)}M`}function Ln(n,r,s){const i=JSON.stringify(n).length,c=r.reduce((d,u)=>{var h,p;return d+(u.kind==="inline"?((h=u.data)==null?void 0:h.length)??0:((p=u.text)==null?void 0:p.length)??0)},0);return i+c+s.length}const so=.75,lo=.85,Mn=[{name:"compact",aliases:["compress"],hint:"[focus instructions]",description:"Summarize the conversation to free up context"}];function co(n,r,s){if(s){const i=Math.max(0,Math.ceil((s.deadline-Date.now())/1e3));return`rate-limited — retry ${s.attempt} of ${s.max} in ${i}s…`}if(n)switch(n.name){case"write":return"writing the page…";case"edit":return"editing the page…";case"read":return`reading the page${n.detail?` (${n.detail})`:""}…`;case"grep":return`searching the page${n.detail?` for “${n.detail}”`:""}…`;case"console":return"checking the console…";case"skill":return n.detail?`loading the ${n.detail} skill…`:"loading a skill…";case"action":return`running ${n.detail??"an action"}…`;case"web_search":return n.detail?`searching the web for “${n.detail}”…`:"searching the web…";case"database":return"updating the database…";default:return`using ${n.name}…`}return r>=10?`working… (${r}s — large edits can take a minute)`:r>=3?`working… (${r}s)`:"working…"}function uo(n){return e.jsxs("div",{children:[e.jsx("div",{className:"flex items-center gap-1.5 text-[11px] text-fg-3",children:n.name==="screenshot"?e.jsxs(e.Fragment,{children:[e.jsx(Dr,{className:"h-3 w-3 text-fg-3"}),e.jsx("span",{children:"looked at the page"})]}):n.name==="write"||n.name==="edit"?e.jsxs(e.Fragment,{children:[e.jsx(Bn,{className:"h-3 w-3 text-fg-3"}),e.jsx("span",{children:"edited the page"})]}):n.name==="skill"?e.jsxs(e.Fragment,{children:[e.jsx(Ir,{className:"h-3 w-3 text-fg-3"}),e.jsxs("span",{children:["loaded the ",e.jsx("span",{className:"font-medium text-fg-2",children:n.detail??"unknown"})," skill"]})]}):n.name==="action"?e.jsxs(e.Fragment,{children:[e.jsx(pn,{className:"h-3 w-3 text-fg-3"}),e.jsxs("span",{children:["ran ",e.jsx("span",{className:"font-medium text-fg-2",children:n.detail??"an action"})]})]}):n.name==="console"?e.jsxs(e.Fragment,{children:[e.jsx(pn,{className:"h-3 w-3 text-fg-3"}),e.jsx("span",{children:"checked the console"})]}):n.name==="grep"?e.jsxs(e.Fragment,{children:[e.jsx(Pr,{className:"h-3 w-3 text-fg-3"}),e.jsxs("span",{children:["searched the page",n.detail?e.jsxs(e.Fragment,{children:[" for ",e.jsx("span",{className:"max-w-[16rem] truncate font-medium text-fg-2",children:n.detail})]}):null]})]}):n.name==="database"?e.jsxs(e.Fragment,{children:[e.jsx(Fr,{className:"h-3 w-3 text-fg-3"}),e.jsxs("span",{children:["updated the database",n.detail?` (${n.detail})`:""]})]}):n.name==="read"?e.jsxs(e.Fragment,{children:[e.jsx(_n,{className:"h-3 w-3 text-fg-3"}),e.jsxs("span",{children:["read the page",n.detail?` (${n.detail})`:""]})]}):e.jsxs(e.Fragment,{children:[e.jsx(Hn,{className:"h-3 w-3"}),e.jsxs("span",{children:["used ",e.jsx("span",{className:"font-medium text-fg-2",children:n.name}),n.detail?` (${n.detail})`:""]})]})}),n.name==="screenshot"&&n.imageUrl?e.jsx("img",{src:n.imageUrl,alt:"screenshot of the live preview",className:"mt-1.5 max-h-48 max-w-full rounded-md border border-border"}):null]})}function Co(){var d;const{id:n}=La(),s=((d=Ma().state)==null?void 0:d.publishContinuation)===!0,i=o.useRef(0),c=o.useRef(n);return!s&&n!==c.current&&(i.current+=1),c.current=n,e.jsx(ho,{pageId:n??null},i.current)}function ho({pageId:n}){var dn,un;const r=n??"draft",s=Da(),i=Br(),c=Dn(),[d,u]=o.useState(!1),[h,p]=o.useState(be),[f,g]=o.useState(Ie),L=qr(),M=zr(),w=$r(),{model:S,setModel:H,thinking:P,restoreThinking:te,preferredThinkingRef:y,zenModels:F,zenModelInfo:ne,modelsSettled:$,hasGoogleProject:we,googleModels:xe,modelOffered:ye,modelLabel:qn,modelReady:_,aiUnavailable:G,googleOut:zn,googleReason:Xe,zenInfoFor:$n}=L,[O,Rt]=o.useState(()=>[...Gr]),[re,Qe]=o.useState(""),de=o.useRef(null),Gn=t=>{if(mn(t)==="zen")return de.current??(de.current=crypto.randomUUID()),de.current},U=o.useRef(null),[ke,Je]=o.useState(""),[ae,Ze]=o.useState([]),[Vn,et]=o.useState(!1),[T,Pe]=o.useState(!1),[Wn,Se]=o.useState(""),[Yn,Ce]=o.useState(""),[Lt,tt]=o.useState(null),[Mt,Dt]=o.useState(0),[nt,N]=o.useState(null),[Kn,It]=o.useState(!1),[Pt,oe]=o.useState(null),[Ft,rt]=o.useState(null),[V,Bt]=o.useState(!1),[Fe,Ht]=o.useState("desktop"),[at,ot]=o.useState("code"),[_t,it]=o.useState(null),st=n!=null&&_t!=null,[Ot,ue]=o.useState(null);o.useEffect(()=>{V||ot("code")},[V]);const[Xn,Qn]=o.useState(""),[lt,ct]=o.useState(null),[Jn,Ut]=o.useState("public"),[je,dt]=o.useState(null),[Zn,ut]=o.useState(!1),[er,qt]=o.useState(!1),[q,Te]=o.useState(null),[tr,ht]=o.useState(!1),[Be,He]=o.useState(0),[zt,nr]=o.useState(0),he=o.useMemo(()=>URL.createObjectURL(new Blob([Nn(h,{screenshot:!0})],{type:"text/html"})),[h,zt]),_e=o.useRef(null);o.useEffect(()=>{_e.current&&_e.current!==he&&URL.revokeObjectURL(_e.current),_e.current=he},[he]);const[k,$t]=o.useState(!1),[A,Oe]=o.useState(null),D=Qa(n??"",!!n),R=An(n??"",k?(A==null?void 0:A.sha)??null:null);o.useEffect(()=>{!k||!D.data||(A&&!D.data.some(t=>t.sha===A.sha)?Oe(D.data[0]??null):!A&&D.data.length>0&&Oe(D.data[0]))},[k,A,D.data]);function Ue(){$t(!1),Oe(null),ft("preview"),pt("previous")}const[W,ft]=o.useState("preview"),[J,pt]=o.useState("previous"),Gt=k&&A&&D.data?D.data.findIndex(t=>t.sha===A.sha):-1,Ee=Gt>=0?((dn=D.data)==null?void 0:dn[Gt+1])??null:null,qe=An(n??"",k&&W==="diff"&&J==="previous"?(Ee==null?void 0:Ee.sha)??null:null),[Vt,Wt]=o.useState(!1),mt=o.useRef(null);o.useEffect(()=>()=>{mt.current&&clearTimeout(mt.current)},[]);function rr(){Vt||(Wt(!0),D.refetch().finally(()=>{mt.current=setTimeout(()=>Wt(!1),2e3)}))}const Ne=o.useMemo(()=>R.data===void 0?null:URL.createObjectURL(new Blob([Nn(R.data)],{type:"text/html"})),[R.data]),ze=o.useRef(null);o.useEffect(()=>{ze.current&&ze.current!==Ne&&URL.revokeObjectURL(ze.current),ze.current=Ne},[Ne]);const $e=o.useRef(null),Ge=o.useRef([]),Yt=o.useRef(0);o.useEffect(()=>{Ge.current=[],Yt.current=Date.now()},[he]);const ar=o.useRef(0),Ae=o.useRef(new Map),gt=o.useRef(!1),Kt=o.useRef(k);o.useEffect(()=>{Kt.current=k},[k]),o.useEffect(()=>{gt.current=!1;const t=Ae.current;t.forEach(a=>{window.clearTimeout(a.timer),a.reject(new Error("the live preview reloaded — read the page again before acting on it"))}),t.clear()},[he,V,k]),o.useEffect(()=>{function t(a){var E;if(a.source!==((E=$e.current)==null?void 0:E.contentWindow))return;const l=a.data;if(!l)return;if(l.type==="aero-dom-ready"){gt.current=!0;return}if(l.type==="aero-dom-op-result"&&typeof l.id=="number"){const b=Ae.current.get(l.id);if(!b)return;Ae.current.delete(l.id),window.clearTimeout(b.timer);const v=typeof l.generation=="number"?l.generation:null;b.resolve(l.ok?{ok:!0,result:l.result,generation:v}:{ok:!1,error:l.error||"the action failed",generation:v});return}if(l.type!=="aero-console"||typeof l.ts=="number"&&l.ts<Yt.current)return;const m=l.level==="info"||l.level==="warn"||l.level==="error"?l.level:"log",x=Ge.current;x.push({level:m,text:typeof l.text=="string"?l.text:"",ts:l.ts??Date.now()}),x.length>300&&x.splice(0,x.length-300)}return window.addEventListener("message",t),()=>window.removeEventListener("message",t)},[]);async function or(t,a,l){var v;Kt.current&&Ue(),Bt(!1);const m=Date.now()+1e4;for(;!gt.current||!((v=$e.current)!=null&&v.contentWindow);){if(Date.now()>m)return{ok:!1,error:"the live preview did not finish loading",generation:null};await new Promise(C=>setTimeout(C,50))}const x=$e.current.contentWindow,E=++ar.current,b=t==="screenshot"?3e4:15e3;return new Promise(C=>{const z=window.setTimeout(()=>{Ae.current.delete(E),C({ok:!1,error:"the live preview did not respond — read the page again and retry",generation:null})},b);Ae.current.set(E,{resolve:C,reject:le=>C({ok:!1,error:le.message,generation:null}),timer:z}),x.postMessage({type:"aero-dom-op",id:E,op:t,args:a,generation:l},"*")})}const I=o.useRef(h),Y=t=>{I.current=t,p(t)},K=o.useRef(be),Z=o.useRef(null),Ve=o.useRef(Ie),bt=o.useRef(null),Xt=o.useRef(null),Qt=o.useRef(null),ie=o.useRef(null),vt=o.useRef(Un);o.useEffect(()=>{let t=!0;return Vr().then(a=>jn(a).then(l=>{t&&(vt.current=l)})).catch(()=>{}),Wr().then(a=>jn(a).then(l=>{t&&(vt.current=l)})).catch(()=>{}),()=>{t=!1}},[]);const Re=!!S&&mn(S)==="zen",Le=Yr(S),ir=()=>{if(!re)return"Same as builder";const t=qn(re);return!$||ye(re)?t:`${t} — unavailable`};o.useEffect(()=>{let t=!1;return it(null),ue(null),Te(null),ht(!1),Qe(""),U.current=null,de.current=null,Z.current=null,(async()=>{const a=await vn(r).catch(()=>{});if(t)return;let l=Ie;if(a&&(Y(a.html),K.current=a.html,l=Kr(a.contents),g(l),Ve.current=l,He(wn(l)),a.model&&H(a.model),te(a.thinking,a.model??S),Rt(Xr(a.disabledTools,a.knownTools)),Qe(a.observerModel??""),U.current=a.zenSessionId??null),n)try{const m=await ve.getPage(n);if(t)return;ct(m.url),Ut(xr(m.visibility)),it(m.html),Z.current=m.updated_at;const{html:x,supersededLocal:E}=_a(a,m);Y(x),K.current=x,a&&E!==null&&(ue(E),Ye({...a,html:x,contents:l,basedOnUpdatedAt:m.updated_at,updatedAt:0}).catch(()=>{}))}catch{t||N("Failed to load page.")}t||u(!0)})(),()=>{t=!0}},[r]);const se=o.useRef(Date.now());o.useEffect(()=>{if(!T)return;se.current=Date.now(),Dt(0);const t=setInterval(()=>Dt(Math.round((Date.now()-se.current)/1e3)),1e3);return()=>clearInterval(t)},[T]);const Jt=()=>{if(Re)return U.current??(U.current=crypto.randomUUID()),U.current},X=(t,a=O,l=re)=>{const m=I.current;return Ye({key:r,pageId:n,html:m,contents:t,model:S||null,thinking:y.current,disabledTools:a,knownTools:Ct(),observerModel:l||void 0,zenSessionId:U.current??void 0,basedOnUpdatedAt:Z.current??void 0,updatedAt:0}).then(()=>{K.current=m,Ve.current=t}).catch(()=>{})},Zt={sessionKey:r,pageId:n,contents:f,model:S,thinking:P,disabledTools:O,observerModel:re,modelsSettled:$,modelOffered:ye,zenInfoFor:$n},B=o.useRef(Zt);B.current=Zt;const en=o.useRef(T);en.current=T,o.useEffect(()=>()=>{if(I.current===K.current&&B.current.contents===Ve.current)return;const{sessionKey:t,pageId:a,contents:l,model:m,thinking:x,disabledTools:E,observerModel:b}=B.current;Ye({key:t,pageId:a,html:I.current,contents:l,model:m||null,thinking:x,disabledTools:E,knownTools:Ct(),observerModel:b||void 0,zenSessionId:U.current??void 0,basedOnUpdatedAt:Z.current??void 0,updatedAt:0}).catch(()=>{})},[]);const wt=!Re,sr=wt&&(ae.length>0||f.some(t=>t.parts.some(a=>a.inlineData))),fe=o.useMemo(()=>Ln(f,ae,ke),[f,ae,ke]),lr=wt&&fe>ge,tn=fe/ge>=so,nn=Be/Le>=lo,rn=Math.max(0,100-Math.round(Be/Le*100)),an=Le>=1e6?`${Math.round(Le/1e6)}M`:`${Math.round(Le/1e3)}K`;async function on(t){var le;const a=t===void 0,l=(t??ke).trim(),m=a?ae:[];if(!l&&m.length===0||T||!_)return;const x=a?fe:Ln(f,m,l);if(wt&&x>ge){N(`This message is too large to send (~${ce(x)} — Gemini's inline-request limit is ~${ce(ge)}). `+(m.length>0?"Remove an attachment, or run /compact first.":"Run /compact first."));return}if(l.startsWith("/")){const Q=l.split(/\s+/)[0];if(!ha(Mn,Q)){N(`Unknown command: ${Q} — available: /compact`);return}}const E=fa(l);if(E){Je(""),await ur(E.instructions);return}const b=[_r()];for(const Q of m)b.push(pa(Q.name,Q.mimeType)),b.push(Q.kind==="inline"?{inlineData:{mimeType:Q.mimeType,data:Q.data??""}}:{text:Q.text??""});l&&b.push({text:l});const v=/\b(slides?|decks?|presentations?|powerpoint|pptx?|pitch(?:es)?)\b/i.test(l),C=/\bdeck-container\b|class="slide slide--/.test(I.current);I.current===be?b.push(St(`The HTML document is still the untouched blank starter template — it contains no user content. Do not call \`read\` on it. If this message is a change request, load the \`${v?"aero-slides":"aero-app-style"}\` skill, then write the first draft directly with \`write\`.`)):C?b.push(St("The current document is an aero slide deck. Load the `aero-slides` skill (if not already loaded in this conversation) and follow its layout catalogue and navigation engine when editing.")):v&&b.push(St("This request is about a slide deck / presentation. Load the `aero-slides` skill before making changes, and follow its layout catalogue and navigation engine."));const z=[...f,{role:"user",parts:b}];(le=bt.current)==null||le.followOutput(),g(z),a&&(Je(""),Ze([])),Ua(),await sn(z)}async function sn(t){const a=new AbortController;ie.current=a,Pe(!0),Se(""),Ce(""),N(null),It(!1),oe(null);const l=B.current.sessionKey;Te(null);const m=I.current,x=Date.now(),E=Jt();try{const b=await xa({model:S,contents:t,html:()=>I.current,skills:vt.current,pageId:n,consoleLogs:()=>Ge.current,domOp:or,browse:M,generationConfig:gn(P,S),thinking:P,zenModelInfo:ne,zenSession:E,hasGoogleProject:we,disabledTools:O,signal:a.signal,callbacks:{onText:v=>{se.current=Date.now(),oe(null),Se(C=>C+v)},onThought:v=>{se.current=Date.now(),oe(null),Ce(C=>C+v)},onUsage:v=>{const C=v.totalTokenCount??v.promptTokenCount;typeof C=="number"&&He(C)},onTool:(v,C)=>{se.current=Date.now(),oe(null),tt({name:v,detail:C})},onHtml:v=>Y(v),onContents:v=>{se.current=Date.now(),tt(null),g(v),Se(""),Ce("")},onStreamReset:()=>{Se(""),Ce(""),oe(null)},onRetry:(v,C,z)=>{se.current=Date.now(),oe({attempt:v,max:C,deadline:Date.now()+z*1e3})}}});g(b),await X(b),Date.now()-x>1e4&&En({ok:!0});try{await dr(b,m,l,a.signal)}catch{}}catch(b){if(b instanceof DOMException&&b.name==="AbortError")await X(B.current.contents);else{const v=b instanceof me?Or(b.body):null,C=b instanceof me?b.message==="reauth_required"?"Your Google credential has expired or is invalid. Sign out and sign in again to reconnect.":v?v.message:`AI request failed: ${b.message}`:"AI request failed.";v&&rt(v),N(C),It(!(b instanceof me&&b.message==="reauth_required")),En({ok:!1,error:C}),await X(t)}}finally{ie.current===a&&(ie.current=null),Pe(!1),Se(""),Ce(""),tt(null),oe(null)}}function cr(){var t;(t=ie.current)==null||t.abort()}async function We(){var t;T||!_||f.length===0||((t=bt.current)==null||t.followOutput(),await sn(f))}async function dr(t,a,l,m){if(B.current.sessionKey!==l||B.current.disabledTools.includes(Tt)||m.aborted||I.current===a||!xn(t))return;const{observerModel:x,model:E,modelsSettled:b,modelOffered:v,zenInfoFor:C}=B.current,z=x&&(!b||v(x))?x:E;ht(!0);try{const le=await Sa({model:z,request:Ca(t),html:I.current,consoleEntries:Ge.current,zenModelInfo:C(z),zenSession:Gn(z),signal:m});le&&B.current.sessionKey===l&&Te(le)}finally{ht(!1)}}async function ur(t){if(T||!_)return;if(f.length===0){N("Nothing to compact — the conversation is empty.");return}const a=new AbortController;ie.current=a,Pe(!0),qt(!0),N(null);try{const l=await ya({model:S,contents:f,instructions:t||void 0,generationConfig:gn("off",S),zenSession:Jt(),signal:a.signal});await pe(ka(l))}catch(l){l instanceof DOMException&&l.name==="AbortError"||N(l instanceof me?`Compaction failed: ${l.message}`:"Compaction failed.")}finally{ie.current===a&&(ie.current=null),Pe(!1),qt(!1)}}async function pe(t){g(t),He(wn(t)),await X(t)}async function hr(t){if(T)return;const a=f;if(!(!await c({title:"Delete from history?",body:t.kind==="tool"||t.kind==="grouped-search"?`Removes ${t.refs.length===1?"this tool call and its result":`these ${t.refs.length} tool calls and their results`} from the context sent to the model. The page itself is not affected.`:t.kind==="thought"?"Clears this reasoning from the context sent to the model. The page itself is not affected.":"Removes this record from the context sent to the model. The page itself is not affected.",confirmLabel:"Delete",variant:"danger"})||en.current||B.current.contents!==a))switch(t.kind){case"user":case"compact":await pe(va(f,t.contentIndex));break;case"thought":await pe(ba(f,t.refs));break;case"tool":case"grouped-search":await pe(ga(f,t.refs));break;case"assistant":await pe(ma(f,t.refs));break}}async function fr(t,a){T||t.kind!=="user"&&t.kind!=="assistant"||B.current.contents===f&&await pe(wa(f,t.refs,a))}const Me=Hr({mutationFn:async t=>{const a=I.current;if(n){const m=await ve.patchPage(n,{html:a});return{id:n,isNew:!1,url:null,html:a,visibility:Jn,updatedAt:m.updated_at}}const l=await ve.createPage(a,{alias:(t==null?void 0:t.alias)||null,visibility:(t==null?void 0:t.visibility)??"public",grants:(t==null?void 0:t.grants)??[]});return{id:l.id,isNew:!0,url:l.url,html:a,visibility:(t==null?void 0:t.visibility)??"public",updatedAt:l.updated_at}},onSuccess:async({id:t,isNew:a,url:l,html:m,visibility:x,updatedAt:E})=>{if(N(null),ut(!1),Ut(x),K.current=m,it(m),Z.current=E??Z.current,ue(null),i.invalidateQueries({queryKey:["pages"]}),i.invalidateQueries({queryKey:["page",t]}),i.invalidateQueries({queryKey:["page-history",t]}),a)await Ye({key:t,pageId:t,html:I.current,contents:f,model:S||null,thinking:P,disabledTools:O,knownTools:Ct(),observerModel:re||void 0,zenSessionId:U.current??void 0,basedOnUpdatedAt:Z.current??void 0,updatedAt:0}).catch(()=>{}),await jt("draft").catch(()=>{}),ct(l),dt({url:l??`/p/${t}`,id:t,isNew:!0,visibility:x});else{const b=lt??`/p/${t}`;ct(b),dt({url:b,id:t,isNew:!1,visibility:x})}},onError:t=>{t instanceof me&&t.body&&typeof t.body=="object"&&"reason"in t.body?N(`Publish failed: ${t.message} (${String(t.body.reason)})`):t instanceof me?N(`Publish failed: ${t.message}`):N("Publish failed.")}});async function pr(){if(await c({title:"Reset builder",body:n?"Clears the conversation and restores the HTML from the published page.":"Clears the conversation and the draft HTML. This cannot be undone.",confirmLabel:"Reset",variant:"danger"}))if(await jt(r).catch(()=>{}),g(Ie),Ve.current=Ie,He(0),N(null),Te(null),U.current=null,de.current=null,n)try{const a=await ve.getPage(n);Y(a.html),K.current=a.html,Z.current=a.updated_at,ue(null)}catch{N("Failed to reload page.")}else Y(be),K.current=be}async function mr(){if(I.current!==K.current){if(!await c({title:"Unpublished changes",body:"You have unpublished changes to this page. Publish them first, or discard them and start a new page.",confirmLabel:"Discard & start new",variant:"danger"}))return;K.current=I.current}const t=await vn("draft").catch(()=>{});t&&(t.contents.length>0||t.html!==be)&&await c({title:"Unfinished draft",body:"You have an unfinished draft. Start fresh and discard it, or resume where you left off?",confirmLabel:"Start fresh",cancelLabel:"Resume draft",variant:"danger"})&&await jt("draft").catch(()=>{}),s("/")}async function gr(t){var m;const a=(m=t.target.files)==null?void 0:m[0];if(t.target.value="",!a)return;const l=await a.text();Y(l),N(null),X(f)}async function xt(t){if(t.length===0)return;if(Re){N("Free models cannot read attachments. Switch to a Google model to attach files.");return}const a=[],l=[];for(const m of t){const x=await ja(m);"error"in x?l.push(x.error):a.push(x)}a.length>0&&Ze(m=>[...m,...a]),l.length>0&&N(l.join(" "))}function br(t){const a=Array.from(t.target.files??[]);t.target.value="",xt(a)}const yt=o.useMemo(()=>Qr(f),[f]),ln=zn&&F.length>0,De=f[f.length-1],vr=(De==null?void 0:De.role)==="user"&&De.parts.some(Jr),cn=!T&&!!De&&!xn(f)&&!vr,wr=((un=yt[yt.length-1])==null?void 0:un.kind)==="user";return d?e.jsxs("div",{className:"flex h-[calc(100vh-8.5rem)] min-h-[480px] flex-col gap-3",children:[e.jsxs("div",{className:"flex flex-wrap items-center gap-2",children:[e.jsx(Zr,{choice:L,disabled:T}),e.jsxs("button",{type:"button",onClick:()=>Bt(t=>!t),disabled:k,className:j("inline-flex h-8 items-center gap-1.5 rounded-md border border-border px-2.5 text-[12px] disabled:opacity-50",V?"bg-ink text-white":"bg-surface text-fg-2 hover:text-fg"),children:[e.jsx(Bn,{className:"h-3.5 w-3.5"})," Code"]}),e.jsxs("div",{className:j("flex items-center gap-1 rounded-md border border-border bg-surface p-0.5 text-[11px]",(V||k&&W!=="preview")&&"opacity-50"),children:[e.jsxs("button",{type:"button",onClick:()=>Ht("desktop"),disabled:V||k&&W!=="preview",title:"Preview at full width",className:j("inline-flex items-center gap-1 rounded-sm px-2 py-1",Fe==="desktop"?"bg-ink text-white":"text-fg-2 hover:text-fg"),children:[e.jsx(Sr,{className:"h-3.5 w-3.5"})," Desktop"]}),e.jsxs("button",{type:"button",onClick:()=>Ht("mobile"),disabled:V||k&&W!=="preview",title:"Preview at phone width",className:j("inline-flex items-center gap-1 rounded-sm px-2 py-1",Fe==="mobile"?"bg-ink text-white":"text-fg-2 hover:text-fg"),children:[e.jsx(Cr,{className:"h-3.5 w-3.5"})," Mobile"]})]}),e.jsxs("button",{type:"button",onClick:()=>nr(t=>t+1),disabled:V||k,title:"Reload the preview (recovers a broken or navigated-away preview)",className:"inline-flex h-8 items-center gap-1.5 rounded-md border border-border bg-surface px-2.5 text-[12px] text-fg-2 hover:text-fg disabled:opacity-50",children:[e.jsx(hn,{className:"h-3.5 w-3.5"})," Reload"]}),e.jsxs("button",{type:"button",onClick:()=>{var t;return(t=Xt.current)==null?void 0:t.click()},disabled:T||k,title:"Load an .html file into the builder (replaces the current document)",className:"inline-flex h-8 items-center gap-1.5 rounded-md border border-border bg-surface px-2.5 text-[12px] text-fg-2 hover:text-fg disabled:opacity-50",children:[e.jsx(jr,{className:"h-3.5 w-3.5"})," Upload"]}),e.jsx("input",{ref:Xt,type:"file",accept:".html,.htm,text/html",hidden:!0,onChange:gr}),e.jsxs("button",{type:"button",onClick:pr,disabled:T||k,className:"inline-flex h-8 items-center gap-1.5 rounded-md border border-border bg-surface px-2.5 text-[12px] text-fg-2 hover:text-fg disabled:opacity-50",children:[e.jsx(Tr,{className:"h-3.5 w-3.5"})," Reset"]}),n?e.jsxs("button",{type:"button",onClick:mr,disabled:T||k,title:"Start a new page in the draft builder",className:"inline-flex h-8 items-center gap-1.5 rounded-md border border-border bg-surface px-2.5 text-[12px] text-fg-2 hover:text-fg disabled:opacity-50",children:[e.jsx(Er,{className:"h-3.5 w-3.5"})," New"]}):null,n?e.jsxs("button",{type:"button",onClick:()=>k?Ue():$t(!0),title:"Browse previously published versions of this page",className:j("inline-flex h-8 items-center gap-1.5 rounded-md border border-border px-2.5 text-[12px]",k?"bg-ink text-white":"bg-surface text-fg-2 hover:text-fg"),children:[e.jsx(Fn,{className:"h-3.5 w-3.5"})," History"]}):null,e.jsxs("div",{className:"ml-auto flex items-center gap-2",children:[lt?e.jsxs("a",{href:lt,target:"_blank",rel:"noreferrer",className:"inline-flex items-center gap-1 text-[12px] text-fg-2 hover:text-fg",children:["View live ",e.jsx(Nr,{className:"h-3 w-3"})]}):null,e.jsxs(ee,{size:"sm",onClick:()=>n?Me.mutate(void 0):ut(!0),disabled:T||Me.isPending||k,children:[Me.isPending?e.jsx(Ar,{className:"h-3.5 w-3.5 animate-spin"}):e.jsx(Pn,{className:"h-3.5 w-3.5"}),n?"Publish update":"Publish"]})]})]}),nt&&!k?e.jsxs("div",{className:"flex items-center gap-2 rounded-md border border-no/30 bg-no-soft px-3 py-2 text-[12px] text-no-strong",children:[e.jsx("span",{className:"min-w-0 flex-1 break-words",children:nt}),Kn&&!T?e.jsxs("button",{type:"button",onClick:()=>void We(),className:"inline-flex shrink-0 items-center gap-1 rounded border border-no/30 bg-surface px-2 py-0.5 text-[11px] font-medium text-no-strong hover:bg-no-soft",children:[e.jsx(hn,{className:"h-3 w-3"})," Retry"]}):null]}):null,Ot!==null&&!k?e.jsxs("div",{className:"flex items-center gap-2 rounded-md border border-border bg-surface-muted px-3 py-2 text-[12px] text-fg-2",children:[e.jsx("span",{className:"min-w-0 flex-1 break-words",children:"This page was updated outside this browser — loaded the latest published version."}),e.jsxs("button",{type:"button",onClick:()=>{Y(Ot),ue(null),X(f)},className:"inline-flex shrink-0 items-center gap-1 rounded border border-border bg-surface px-2 py-0.5 text-[11px] font-medium text-fg hover:bg-surface-muted",children:[e.jsx(Rr,{className:"h-3 w-3"})," Keep my local copy"]}),e.jsx("button",{type:"button",onClick:()=>ue(null),"aria-label":"Dismiss",className:"shrink-0 rounded p-0.5 text-fg-3 hover:text-fg",children:e.jsx(kt,{className:"h-3 w-3"})})]}):null,(G||ln)&&!k?e.jsxs("div",{className:"space-y-2",children:[e.jsxs("div",{className:"rounded-md border border-border bg-surface-muted px-3 py-2 text-[12px] text-fg-2",children:[G?"AI is unavailable — ":"Google models are unavailable — ",Xe==="no_project"?e.jsxs(e.Fragment,{children:["no Code Assist project selected for your account."," ",e.jsx(Ia,{to:"/settings",className:"underline hover:text-fg",children:"Choose one in Settings"}),"."]}):Xe==="reauth_required"?"your Google credential has expired or is invalid. Sign out and sign in again to reconnect.":"could not load models. Try again later.",ln?" Free models are listed in the model picker and need no Google account.":null]}),Xe==="no_project"?e.jsx(Ta,{}):null]}):null,cn&&!nt&&!wr&&!k?e.jsxs("div",{className:"flex items-center gap-2 rounded-md border border-border bg-surface-muted px-3 py-2 text-[12px] text-fg-2",children:[e.jsx("span",{className:"min-w-0 flex-1",children:"Aero stopped before finishing — resume to keep going."}),e.jsxs("button",{type:"button",onClick:()=>void We(),disabled:G||!_,className:"inline-flex shrink-0 items-center gap-1 rounded border border-border bg-surface px-2 py-0.5 text-[11px] font-medium text-fg-2 hover:bg-surface-muted disabled:opacity-50",children:[e.jsx(fn,{className:"h-3 w-3"})," Resume"]})]}):null,e.jsxs("div",{className:"flex min-h-0 flex-1 gap-4",children:[e.jsx("div",{className:j("flex w-[380px] shrink-0 flex-col rounded-lg border border-border bg-surface",Vn&&"ring-2 ring-ink"),onDragOver:t=>{k||(t.preventDefault(),et(!0))},onDragLeave:()=>et(!1),onDrop:t=>{k||(t.preventDefault(),et(!1),xt(Array.from(t.dataTransfer.files)))},children:k?e.jsx(Ja,{entries:D.data,isLoading:D.isLoading,isError:D.isError,isFetching:D.isFetching||Vt,selectedSha:(A==null?void 0:A.sha)??null,onSelect:Oe,onRefresh:rr}):e.jsx(ea,{ref:bt,chat:yt,busy:T,streamText:Wn,streamThought:Yn,busyLabel:er?"compacting conversation…":tr?"reviewing the page…":co(Lt,Mt,Pt),toolActive:Lt!==null,retrying:Pt!==null,busyElapsed:Mt,emptyState:e.jsxs(e.Fragment,{children:["Describe the page you want to build.",e.jsx("br",{}),"Aero edits the HTML and you preview it live.",e.jsx("br",{}),"Or upload an existing .html file to start from."]}),renderToolItem:uo,afterMessages:q?e.jsxs("div",{className:"rounded-md border border-border bg-surface-muted px-3 py-2 text-[12px] text-fg-2",children:[e.jsxs("div",{className:"flex items-center gap-1.5",children:[q.kind==="issues"?e.jsx(Mr,{className:"h-3.5 w-3.5 shrink-0 text-warning"}):q.kind==="pass"?e.jsx(In,{className:"h-3.5 w-3.5 shrink-0 text-success"}):e.jsx(_n,{className:"h-3.5 w-3.5 shrink-0 text-fg-3"}),e.jsx("span",{className:"min-w-0 flex-1",children:q.kind==="issues"?e.jsxs("span",{className:"font-medium text-fg-2",children:["Review found"," ",q.findings.length===1?"1 thing":`${q.findings.length} things`," ","to check"]}):q.kind==="pass"?e.jsxs("span",{className:"text-fg-3",children:[e.jsx("span",{className:"font-medium text-fg-2",children:"Review passed"})," — nothing to flag on this change."]}):e.jsxs("span",{className:"text-fg-3",children:[e.jsx("span",{className:"font-medium text-fg-2",children:"Review didn’t run."})," The build finished normally — only the review failed."]})}),e.jsx("button",{type:"button",onClick:()=>Te(null),"aria-label":"Dismiss review",title:"Dismiss review",className:"shrink-0 rounded p-0.5 text-fg-3 hover:bg-surface hover:text-fg-2",children:e.jsx(kt,{className:"h-3 w-3"})})]}),q.kind==="issues"?e.jsxs(e.Fragment,{children:[e.jsx("ul",{className:"mt-1.5 space-y-1 pl-5",children:q.findings.map((t,a)=>e.jsx("li",{className:"list-disc text-fg-2",children:t},a))}),e.jsx("div",{className:"mt-2 pl-5",children:e.jsxs("button",{type:"button",onClick:()=>void on(ua(q.findings)),disabled:T||G||!_,className:"inline-flex shrink-0 items-center gap-1 rounded border border-border bg-surface px-2 py-0.5 text-[11px] font-medium text-fg-2 hover:bg-surface-muted disabled:opacity-50",children:[e.jsx(fn,{className:"h-3 w-3"})," Fix these"]})})]}):null]}):null,canResume:cn,resumeDisabled:G||!_,onResume:()=>void We(),onSaveItemEdit:(t,a)=>void fr(t,a),onDeleteItem:t=>void hr(t),input:ke,onInputChange:Je,onSend:()=>void on(),onStop:cr,composerDisabled:T||G||!_,sendDisabled:G||!_||!ke.trim()&&ae.length===0||lr,placeholder:G?"AI unavailable":!_&&$?"Pick a model to continue — the last one is no longer available":"Ask Aero to build or change something…",slashCommands:Mn,composerMeta:e.jsxs("div",{className:"flex min-w-0 items-center gap-2 text-[11px] text-fg-3",children:[sr?e.jsx("span",{className:j("tabular truncate",tn&&"font-medium text-no-strong"),title:`Estimated request size with attached files: ${ce(fe)} of ${ce(ge)} — Gemini rejects requests over ~20MB`,children:tn?`${ce(fe)} / ${ce(ge)}`:ce(fe)}):null,e.jsx("span",{className:j("tabular truncate",nn&&"font-medium text-no-strong"),title:`Approximate context window usage: ${Rn(Be)} of ${an} tokens (${rn}% left) — ${Re?"free models are held to a 200K-token context":"all Gemini models have a ~1M-token context"}`,children:nn?`${Rn(Be)} / ${an}`:`${rn}% left`})]}),attachmentsBar:ae.length>0?e.jsx("div",{className:"flex flex-wrap gap-1.5 px-3 pt-2.5",children:ae.map(t=>e.jsxs("div",{className:"flex items-center gap-1.5 overflow-hidden rounded-md border border-border bg-surface-muted pr-1.5 text-[11px]",children:[t.kind==="inline"&&t.mimeType.startsWith("image/")?e.jsx("img",{src:`data:${t.mimeType};base64,${t.data}`,alt:t.name,className:"h-7 w-7 shrink-0 object-cover"}):e.jsx("span",{className:"flex h-7 w-7 shrink-0 items-center justify-center text-fg-3",children:da(t.mimeType)}),e.jsx("span",{className:"max-w-[8rem] truncate text-fg-2",title:t.name,children:t.name}),e.jsx("button",{type:"button",onClick:()=>Ze(a=>a.filter(l=>l.id!==t.id)),title:"Remove",className:"text-fg-3 hover:text-fg",children:e.jsx(kt,{className:"h-3 w-3"})})]},t.id))}):void 0,composerLeading:e.jsxs("div",{className:"flex shrink-0 items-center gap-0.5",children:[e.jsxs(ta,{children:[e.jsx(na,{asChild:!0,children:e.jsxs(ee,{variant:"ghost",size:"sm","aria-label":"Which tools the agent may use",title:"Which tools the agent may use",className:j(yn,"relative"),children:[e.jsx(Hn,{className:"h-3.5 w-3.5"}),O.length>0?e.jsx("span",{className:"absolute right-1 top-1 h-1.5 w-1.5 rounded-full bg-status"}):null]})}),e.jsx(ra,{className:"w-60",children:aa.map(t=>e.jsxs(o.Fragment,{children:[e.jsx(oa,{checked:!t.names.some(a=>O.includes(a)),disabled:!!kn(t.names,{browseAvailable:w}),onCheckedChange:a=>{const l=a?O.filter(m=>!t.names.includes(m)):[...new Set([...O,...t.names])];Rt(l),X(f,l)},children:e.jsxs("span",{className:"flex flex-col",children:[e.jsx("span",{children:t.label}),e.jsx("span",{className:"text-[11px] text-fg-3",children:kn(t.names,{browseAvailable:w})??t.hint})]})}),t.names.includes(Tt)&&!O.includes(Tt)?e.jsxs(ia,{children:[e.jsx(sa,{children:e.jsxs("span",{className:"flex flex-col",children:[e.jsx("span",{children:"Reviewer model"}),e.jsx("span",{className:"text-[11px] text-fg-3",children:ir()})]})}),e.jsx(la,{className:"max-h-72 w-56 overflow-y-auto",children:e.jsxs(ca,{value:re,onValueChange:a=>{Qe(a),X(f,O,a)},children:[e.jsx(Et,{value:"",children:"Same as builder"}),xe.length>0?e.jsxs(e.Fragment,{children:[e.jsx(Sn,{children:"Google"}),xe.map(a=>e.jsx(Et,{value:a,children:a},a))]}):null,F.length>0?e.jsxs(e.Fragment,{children:[e.jsx(Sn,{children:"Free · opencode zen"}),F.map(a=>e.jsx(Et,{value:a.id,children:a.name},a.id))]}):null]})})]}):null]},t.id))})]}),Re?null:e.jsxs(e.Fragment,{children:[e.jsx(ee,{variant:"ghost",size:"sm",onClick:()=>{var t;return(t=Qt.current)==null?void 0:t.click()},disabled:T||G||!_,title:"Attach a file (image, PDF, audio, video, or text)",className:yn,children:e.jsx(Lr,{className:"h-3.5 w-3.5"})}),e.jsx("input",{ref:Qt,type:"file",multiple:!0,hidden:!0,onChange:br})]})]}),onPasteFiles:t=>void xt(t)})}),e.jsx("div",{className:"flex min-w-0 flex-1 flex-col overflow-hidden rounded-lg border border-border bg-surface",children:k?e.jsxs(e.Fragment,{children:[e.jsx(Za,{entry:A,canRestore:!!A&&R.data!==void 0,onRestore:()=>{R.data!==void 0&&(Y(R.data),X(f)),Ue()},onExit:Ue}),A?e.jsxs("div",{className:"flex items-center gap-2 border-b border-border px-3 py-1.5",children:[e.jsxs("div",{className:"flex items-center gap-1 rounded-md border border-border bg-surface p-0.5 text-[11px]",children:[e.jsx("button",{type:"button",onClick:()=>ft("preview"),className:j("rounded-sm px-2 py-1",W==="preview"?"bg-ink text-white":"text-fg-2 hover:text-fg"),children:"Preview"}),e.jsx("button",{type:"button",onClick:()=>ft("diff"),className:j("rounded-sm px-2 py-1",W==="diff"?"bg-ink text-white":"text-fg-2 hover:text-fg"),children:"Diff"})]}),W==="diff"?e.jsxs("div",{className:"flex items-center gap-1 rounded-md border border-border bg-surface p-0.5 text-[11px]",children:[e.jsx("button",{type:"button",onClick:()=>pt("previous"),className:j("rounded-sm px-2 py-1",J==="previous"?"bg-surface-muted text-fg":"text-fg-3 hover:text-fg-2"),children:"vs Previous version"}),e.jsx("button",{type:"button",onClick:()=>pt("draft"),className:j("rounded-sm px-2 py-1",J==="draft"?"bg-surface-muted text-fg":"text-fg-3 hover:text-fg-2"),children:"vs Current draft"})]}):null]}):null,W==="diff"&&A?J==="previous"&&!Ee?e.jsx("div",{className:"p-4 text-[12px] text-fg-3",children:"This is the first published version — nothing to compare it against."}):J==="previous"&&qe.isLoading||R.isLoading?e.jsx("div",{className:"p-4 text-[12px] text-fg-3",children:"Loading diff…"}):J==="previous"&&qe.isError||R.isError?e.jsx("div",{className:"p-4 text-[12px] text-no-strong",children:"Failed to load diff."}):J==="previous"&&qe.data!==void 0&&R.data!==void 0?e.jsx(At,{oldText:qe.data,newText:R.data,oldLabel:`Version from ${new Date(Ee.committed_at).toLocaleString()}`,newLabel:`Version from ${new Date(A.committed_at).toLocaleString()}`}):J==="draft"&&R.data!==void 0?e.jsx(At,{oldText:h,newText:R.data,oldLabel:"Current draft",newLabel:`Version from ${new Date(A.committed_at).toLocaleString()}`}):null:W==="preview"?R.isLoading?e.jsx("div",{className:"p-4 text-[12px] text-fg-3",children:"Loading version…"}):R.isError?e.jsx("div",{className:"p-4 text-[12px] text-no-strong",children:"Failed to load this version."}):Ne?e.jsx("div",{className:"flex h-full w-full justify-center overflow-auto bg-surface-muted",children:e.jsx("iframe",{title:"historic version preview",src:Ne,sandbox:"allow-scripts allow-modals allow-forms allow-popups",className:j("h-full bg-white",Fe==="mobile"?"w-[390px] shrink-0 border-x border-border":"w-full flex-1")})}):e.jsx("div",{className:"p-4 text-[12px] text-fg-3",children:"Select a version from the list to preview it."}):null]}):V?e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"flex items-center gap-2 border-b border-border px-3 py-1.5",children:e.jsxs("div",{className:"flex items-center gap-1 rounded-md border border-border bg-surface p-0.5 text-[11px]",children:[e.jsx("button",{type:"button",onClick:()=>ot("code"),className:j("rounded-sm px-2 py-1",at==="code"?"bg-ink text-white":"text-fg-2 hover:text-fg"),children:"Code"}),e.jsx("button",{type:"button",onClick:()=>ot("diff"),disabled:!st,title:st?void 0:"Diff becomes available once this page has been published",className:j("rounded-sm px-2 py-1 disabled:opacity-50",at==="diff"?"bg-ink text-white":"text-fg-2 hover:text-fg"),children:"Diff"})]})}),at==="diff"&&st?e.jsx(At,{oldText:_t,newText:h,oldLabel:"Last published version",newLabel:"Current draft"}):e.jsx(o.Suspense,{fallback:e.jsx("div",{className:"p-3 text-[12px] text-fg-3",children:"Loading editor…"}),children:e.jsx(io,{value:h,onChange:Y,language:"html",className:"flex-1 overflow-auto"})})]}):e.jsx("div",{className:"flex h-full w-full justify-center overflow-auto bg-surface-muted",children:e.jsx("iframe",{ref:$e,title:"preview",src:he,sandbox:"allow-scripts allow-modals allow-forms allow-popups",className:j("h-full bg-white",Fe==="mobile"?"w-[390px] shrink-0 border-x border-border":"w-full flex-1")},zt)})})]}),Zn?e.jsx(Xa,{initialAlias:Xn,busy:Me.isPending,onCancel:()=>ut(!1),onPublish:t=>{Qn(t.alias),Me.mutate(t)}}):null,je?e.jsx(Ka,{url:je.url,isNew:je.isNew,visibility:je.visibility,onClose:()=>{const t=je;dt(null),t.isNew&&s(`/builder/${t.id}`,{replace:!0,state:{publishContinuation:!0}})}}):null,Ft?e.jsx(Ra,{info:Ft,onEnabled:()=>{rt(null),N(null),We()},onClose:()=>rt(null)}):null]}):e.jsx("div",{className:"text-fg-3",children:"Loading…"})}export{Co as BuilderPage};
