...
`,$a=`# Aero HTML Slides Style Guide
...
})();<\/script>`;function An(n,r){const s=Za+Qa+Ja+(r!=null&&r.screenshot?eo:"")+to,a=n.match(/<head[^>]*>/i);if(!a)return s+n;const c=a.index+a[0].length;return n.slice(0,c)+s+n.slice(c)}function no({url:n,isNew:r,visibility:s,onClose:a}){const c=i.useRef(null),d=i.useRef(null);i.useEffect(()=>{const h=d.current;h&&!h.contains(document.activeElement)&&h.focus()},[]);function u(h){if(h.key==="Escape"){a();return}if(h.key!=="Tab")return;const p=c.current;if(!p)return;const f=p.querySelectorAll(["a[href]","button:not([disabled])","input:not([disabled])","select:not([disabled])","textarea:not([disabled])",'[contenteditable="true"]','[tabindex]:not([tabindex="-1"])'].join(", "));if(f.length===0)return;const g=f[0],M=f[f.length-1],L=document.activeElement;h.shiftKey&&(L===g||!p.contains(L))?(h.preventDefault(),M.focus()):!h.shiftKey&&(L===M||!p.contains(L))&&(h.preventDefault(),g.focus())}return e.jsx("div",{ref:d,tabIndex:-1,className:"fixed inset-0 z-50 grid place-items-center bg-ink/45 p-4 backdrop-blur-sm focus:outline-none",role:"dialog","aria-modal":"true","aria-labelledby":"publish-success-title",onKeyDown:u,onMouseDown:h=>{h.target===h.currentTarget&&a()},children:e.jsxs("div",{ref:c,className:"w-full max-w-md rounded-lg border border-border bg-surface shadow-lg",children:[e.jsxs("div",{className:"flex flex-col items-center gap-2 px-6 pt-6 text-center",children:[e.jsx(Pn,{className:"h-10 w-10 text-success"}),e.jsx("div",{id:"publish-success-title",className:"text-[15px] font-semibold text-fg",children:r?"Page published":"Update published"}),e.jsx("p",{className:"text-[12px] text-fg-2",children:r?s==="private"?"Your page is live. Only you and the people you added can open it.":"Your page is live. Anyone with the link can view it.":"The live page now shows your latest changes."})]}),e.jsx("div",{className:"px-6 py-4",children:e.jsx(Aa,{url:n})}),e.jsx("div",{className:"flex justify-end border-t border-border px-6 py-3",children:e.jsx(ee,{autoFocus:!0,onClick:a,children:"Done"})})]})})}function ro({initialAlias:n,busy:r,onCancel:s,onPublish:a}){const[c,d]=i.useState(n),[u,h]=i.useState("public"),[p,f]=i.useState([]),g=i.useRef(null),M=i.useRef(null);i.useEffect(()=>{const w=M.current;w&&!w.contains(document.activeElement)&&w.focus()},[]);function L(w){if(w.key==="Escape"){s();return}if(w.key!=="Tab")return;const S=g.current;if(!S)return;const _=S.querySelectorAll(["a[href]","button:not([disabled])","input:not([disabled])","select:not([disabled])","textarea:not([disabled])",'[contenteditable="true"]','[tabindex]:not([tabindex="-1"])'].join(", "));if(_.length===0)return;const P=_[0],te=_[_.length-1],y=document.activeElement;w.shiftKey&&(y===P||!S.contains(y))?(w.preventDefault(),te.focus()):!w.shiftKey&&(y===te||!S.contains(y))&&(w.preventDefault(),P.focus())}return e.jsx("div",{ref:M,tabIndex:-1,className:"fixed inset-0 z-50 grid place-items-center bg-ink/45 p-4 backdrop-blur-sm focus:outline-none",role:"dialog","aria-modal":"true","aria-labelledby":"pre-publish-title",onKeyDown:L,onMouseDown:w=>{w.target===w.currentTarget&&!r&&s()},children:e.jsxs("div",{ref:g,className:"w-full max-w-md rounded-lg border border-border bg-surface shadow-lg",children:[e.jsxs("div",{className:"border-b border-border px-6 py-4",children:[e.jsx("div",{id:"pre-publish-title",className:"text-[15px] font-semibold text-fg",children:"Publish app"}),e.jsx("p",{className:"mt-1 text-[12px] text-fg-2",children:"Choose the address and who can open it. You can change both later from Apps."})]}),e.jsxs("div",{className:"space-y-4 px-6 py-4",children:[e.jsxs("div",{children:[e.jsx(Cn,{htmlFor:"publish-alias",hint:"optional — leave blank for a UUID URL",children:"Alias"}),e.jsx(Ma,{id:"publish-alias",autoFocus:!0,value:c,disabled:r,onChange:w=>d(w.target.value.toLowerCase()),placeholder:"my-app"}),e.jsxs("div",{className:"mt-1 font-mono text-[11px] text-fg-3",children:["/p/",c.trim()||"<uuid>"]})]}),e.jsxs("div",{children:[e.jsx(Cn,{children:"Who can open it"}),e.jsx(Ra,{visibility:u,onVisibilityChange:h,grants:p,onGrantsChange:f,disabled:r})]})]}),e.jsxs("div",{className:"flex justify-end gap-2 border-t border-border px-6 py-3",children:[e.jsx(ee,{variant:"secondary",onClick:s,disabled:r,children:"Cancel"}),e.jsxs(ee,{onClick:()=>a({alias:c.trim(),visibility:u,grants:p}),disabled:r,children:[e.jsx(Fn,{className:"h-3.5 w-3.5"}),r?"Publishing…":"Publish"]})]})]})})}function ao(n,r){return Un({queryKey:["page-history",n],queryFn:()=>ve.getPageHistory(n).then(s=>s.versions),enabled:r,retry:!1})}function Rn(n,r){return Un({queryKey:["page-history-version",n,r],queryFn:()=>ve.getPageHistoryVersion(n,r).then(s=>s.html),enabled:r!==null,retry:!1})}function oo({entries:n,isLoading:r,isError:s,isFetching:a,selectedSha:c,onSelect:d,onRefresh:u}){return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"flex items-center gap-1.5 border-b border-border px-3 py-2.5 text-[12px] font-semibold text-fg",children:[e.jsx(Bn,{className:"h-3.5 w-3.5 text-fg-3"}),e.jsx("span",{className:"flex-1",children:"Version history"}),e.jsx("button",{type:"button",onClick:u,disabled:a,title:"Refresh — GitHub sync runs in the background, so a just-published version can take a moment to appear",className:"font-normal text-fg-3 hover:text-fg disabled:opacity-50",children:"Refresh"})]}),e.jsxs("div",{className:"scroll-slim flex-1 overflow-y-auto p-1.5",children:[r?e.jsx("div",{className:"px-2 py-2 text-[12px] text-fg-3",children:"Loading…"}):null,s?e.jsx("div",{className:"px-2 py-2 text-[12px] text-no-strong",children:"Failed to load history."}):null,n&&n.length===0?e.jsx("div",{className:"px-2 py-2 text-[12px] text-fg-3",children:"No published versions yet."}):null,(n??[]).map(h=>{const p=h.sha===c;return e.jsxs("button",{type:"button",onClick:()=>d(h),className:j("block w-full rounded-md px-2.5 py-2 text-left",p?"bg-ink":"hover:bg-surface-muted"),children:[e.jsx("div",{className:j("text-[12px] font-medium",p?"text-white":"text-fg"),children:new Date(h.committed_at).toLocaleString()}),e.jsxs("div",{className:j("truncate text-[11px]",p?"text-white/70":"text-fg-3"),children:[h.message,h.author_email?` — ${h.author_email}`:""]})]},h.sha)})]})]})}function io({entry:n,canRestore:r,onRestore:s,onExit:a}){const c=In();return e.jsxs("div",{className:"flex items-center gap-2 border-b border-border bg-surface-muted px-3 py-2 text-[12px]",children:[e.jsx("div",{className:"min-w-0 flex-1 truncate text-fg-2",children:n?e.jsxs(e.Fragment,{children:["Viewing version from ",new Date(n.committed_at).toLocaleString(),n.author_email?` (${n.author_email})`:""," — read-only"]}):"Select a version from the list to preview it"}),e.jsxs(ee,{variant:"secondary",size:"sm",onClick:a,children:[e.jsx(Cr,{className:"h-3.5 w-3.5"})," Back to current draft"]}),e.jsx(ee,{size:"sm",disabled:!r,onClick:async()=>{await c({title:"Restore this version",body:"This replaces your current editor content. Unsaved changes will be lost. The page stays unpublished until you publish again.",confirmLabel:"Restore",variant:"danger"})&&s()},children:"Restore this version"})]})}class so{diff(r,s,a={}){let c;typeof a=="function"?(c=a,a={}):"callback"in a&&(c=a.callback);const d=this.castInput(r,a),u=this.castInput(s,a),h=this.removeEmpty(this.tokenize(d,a)),p=this.removeEmpty(this.tokenize(u,a));return this.diffWithOptionsObj(h,p,a,c)}diffWithOptionsObj(r,s,a,c){var d;const u=y=>{if(y=this.postProcess(y,a),c){setTimeout(function(){c(y)},0);return}else return y},h=s.length,p=r.length;let f=1,g=h+p;a.maxEditLength!=null&&(g=Math.min(g,a.maxEditLength));const M=(d=a.timeout)!==null&&d!==void 0?d:1/0,L=Date.now()+M,w=[{oldPos:-1,lastComponent:void 0}];let S=this.extractCommon(w[0],s,r,0,a);if(w[0].oldPos+1>=p&&S+1>=h)return u(this.buildValues(w[0].lastComponent,s,r));let _=-1/0,P=1/0;const te=()=>{for(let y=Math.max(_,-f);y<=Math.min(P,f);y+=2){let F;const ne=w[y-1],$=w[y+1];ne&&(w[y-1]=void 0);let we=!1;if($){const ye=$.oldPos-y;we=$&&0<=ye&&ye<h}const xe=ne&&ne.oldPos+1<p;if(!we&&!xe){w[y]=void 0;continue}if(!xe||we&&ne.oldPos<$.oldPos?F=this.addToPath($,!0,!1,0,a):F=this.addToPath(ne,!1,!0,1,a),S=this.extractCommon(F,s,r,y,a),F.oldPos+1>=p&&S+1>=h)return u(this.buildValues(F.lastComponent,s,r))||!0;w[y]=F,F.oldPos+1>=p&&(P=Math.min(P,y-1)),S+1>=h&&(_=Math.max(_,y+1))}f++};if(c)(function y(){setTimeout(function(){if(f>g||Date.now()>L)return c(void 0);te()||y()},0)})();else for(;f<=g&&Date.now()<=L;){const y=te();if(y)return y}}addToPath(r,s,a,c,d){const u=r.lastComponent;return u&&!d.oneChangePerToken&&u.added===s&&u.removed===a?{oldPos:r.oldPos+c,lastComponent:{count:u.count+1,added:s,removed:a,previousComponent:u.previousComponent}}:{oldPos:r.oldPos+c,lastComponent:{count:1,added:s,removed:a,previousComponent:u}}}extractCommon(r,s,a,c,d){const u=s.length,h=a.length;let p=r.oldPos,f=p-c,g=0;for(;f+1<u&&p+1<h&&this.equals(a[p+1],s[f+1],d);)f++,p++,g++,d.oneChangePerToken&&(r.lastComponent={count:1,previousComponent:r.lastComponent,added:!1,removed:!1});return g&&!d.oneChangePerToken&&(r.lastComponent={count:g,previousComponent:r.lastComponent,added:!1,removed:!1}),r.oldPos=p,f}equals(r,s,a){return a.comparator?a.comparator(r,s):r===s||!!a.ignoreCase&&r.toLowerCase()===s.toLowerCase()}removeEmpty(r){const s=[];for(let a=0;a<r.length;a++)r[a]&&s.push(r[a]);return s}castInput(r,s){return r}tokenize(r,s){return Array.from(r)}join(r){return r.join("")}postProcess(r,s){return r}get useLongestToken(){return!1}buildValues(r,s,a){const c=[];let d;for(;r;)c.push(r),d=r.previousComponent,delete r.previousComponent,r=d;c.reverse();const u=c.length;let h=0,p=0,f=0;for(;h<u;h++){const g=c[h];if(g.removed)g.value=this.join(a.slice(f,f+g.count)),f+=g.count;else{if(!g.added&&this.useLongestToken){let M=s.slice(p,p+g.count);M=M.map(function(L,w){const S=a[f+w];return S.length>L.length?S:L}),g.value=this.join(M)}else g.value=this.join(s.slice(p,p+g.count));p+=g.count,g.added||(f+=g.count)}}return c}}class lo extends so{constructor(){super(...arguments),this.tokenize=ho}equals(r,s,a){return a.ignoreWhitespace?((!a.newlineIsToken||!r.includes(`
`))&&(r=r.trim()),(!a.newlineIsToken||!s.includes(`
`))&&(s=s.trim())):a.ignoreNewlineAtEof&&!a.newlineIsToken&&(r.endsWith(`
`)&&(r=r.slice(0,-1)),s.endsWith(`
`)&&(s=s.slice(0,-1))),super.equals(r,s,a)}}const co=new lo;function uo(n,r,s){return co.diff(n,r,s)}function ho(n,r){r.stripTrailingCr&&(n=n.replace(/\r\n/g,`
`));const s=[],a=n.split(/(\n|\r\n)/);a[a.length-1]||a.pop();for(let c=0;c<a.length;c++){const d=a[c];c%2&&!r.newlineIsToken?s[s.length-1]+=d:s.push(d)}return s}function fo(n,r){const s=[];let a=0;for(const c of uo(n,r)){const d=c.added?"added":c.removed?"removed":"context",u=c.value.split(`
`);u.length>0&&u[u.length-1]===""&&u.pop();for(const h of u)s.push({key:a++,kind:d,text:h})}return s}function At({oldText:n,newText:r,oldLabel:s,newLabel:a}){const c=i.useMemo(()=>fo(n,r),[n,r]),d=c.every(u=>u.kind==="context");return e.jsxs("div",{className:"flex h-full min-h-0 flex-col overflow-hidden",children:[e.jsxs("div",{className:"flex items-center gap-3 border-b border-border bg-surface-muted px-3 py-1.5 text-[11px]",children:[e.jsxs("span",{className:"text-no-strong",children:["− ",s]}),e.jsxs("span",{className:"text-success",children:["+ ",a]})]}),e.jsx("div",{className:"scroll-slim flex-1 overflow-auto",children:d?e.jsx("div",{className:"p-4 text-[12px] text-fg-3",children:"No differences."}):e.jsx("div",{className:"min-w-max font-mono text-[12px] leading-5",children:c.map(u=>e.jsxs("div",{className:j("flex whitespace-pre px-3",u.kind==="added"&&"bg-status-soft",u.kind==="removed"&&"bg-no-soft",u.kind==="context"&&"text-fg-2"),children:[e.jsx("span",{className:j("mr-2 shrink-0 select-none",u.kind==="added"&&"text-success",u.kind==="removed"&&"text-no-strong",u.kind==="context"&&"text-fg-3"),children:u.kind==="added"?"+":u.kind==="removed"?"−":" "}),e.jsx("span",{children:u.text||" "})]},u.key))})})]})}const po=i.lazy(()=>Sr(()=>import("./CodeEditor-EAtQZ3it.js"),__vite__mapDeps([0,1,2,3,4,5]),import.meta.url).then(n=>({default:n.CodeEditor}))),be=`<!doctype html>
<html lang="en">
<head>
<meta charset="utf-8">
...
`,Ie=[];function Mn(n){return n<1e3?String(n):n<1e6?`${(n/1e3).toFixed(n<1e4?1:0)}k`:`${(n/1e6).toFixed(2)}M`}function Ln(n,r,s){const a=JSON.stringify(n).length,c=r.reduce((d,u)=>{var h,p;return d+(u.kind==="inline"?((h=u.data)==null?void 0:h.length)??0:((p=u.text)==null?void 0:p.length)??0)},0);return a+c+s.length}const mo=.75,go=.85,Dn=[{name:"compact",aliases:["compress"],hint:"[focus instructions]",description:"Summarize the conversation to free up context"}];function bo(n,r,s){if(s){const a=Math.max(0,Math.ceil((s.deadline-Date.now())/1e3));return`rate-limited — retry ${s.attempt} of ${s.max} in ${a}s…`}if(n)switch(n.name){case"write":return"writing the page…";case"edit":return"editing the page…";case"read":return`reading the page${n.detail?` (${n.detail})`:""}…`;case"grep":return`searching the page${n.detail?` for “${n.detail}”`:""}…`;case"console":return"checking the console…";case"skill":return n.detail?`loading the ${n.detail} skill…`:"loading a skill…";case"action":return`running ${n.detail??"an action"}…`;case"web_search":return n.detail?`searching the web for “${n.detail}”…`:"searching the web…";case"database":return"updating the database…";default:return`using ${n.name}…`}return r>=10?`working… (${r}s — large edits can take a minute)`:r>=3?`working… (${r}s)`:"working…"}function vo(n){return e.jsxs("div",{children:[e.jsx("div",{className:"flex items-center gap-1.5 text-[11px] text-fg-3",children:n.name==="screenshot"?e.jsxs(e.Fragment,{children:[e.jsx(Pr,{className:"h-3 w-3 text-fg-3"}),e.jsx("span",{children:"looked at the page"})]}):n.name==="write"||n.name==="edit"?e.jsxs(e.Fragment,{children:[e.jsx(_n,{className:"h-3 w-3 text-fg-3"}),e.jsx("span",{children:"edited the page"})]}):n.name==="skill"?e.jsxs(e.Fragment,{children:[e.jsx(Fr,{className:"h-3 w-3 text-fg-3"}),e.jsxs("span",{children:["loaded the ",e.jsx("span",{className:"font-medium text-fg-2",children:n.detail??"unknown"})," skill"]})]}):n.name==="action"?e.jsxs(e.Fragment,{children:[e.jsx(pn,{className:"h-3 w-3 text-fg-3"}),e.jsxs("span",{children:["ran ",e.jsx("span",{className:"font-medium text-fg-2",children:n.detail??"an action"})]})]}):n.name==="console"?e.jsxs(e.Fragment,{children:[e.jsx(pn,{className:"h-3 w-3 text-fg-3"}),e.jsx("span",{children:"checked the console"})]}):n.name==="grep"?e.jsxs(e.Fragment,{children:[e.jsx(Br,{className:"h-3 w-3 text-fg-3"}),e.jsxs("span",{children:["searched the page",n.detail?e.jsxs(e.Fragment,{children:[" for ",e.jsx("span",{className:"max-w-[16rem] truncate font-medium text-fg-2",children:n.detail})]}):null]})]}):n.name==="database"?e.jsxs(e.Fragment,{children:[e.jsx(_r,{className:"h-3 w-3 text-fg-3"}),e.jsxs("span",{children:["updated the database",n.detail?` (${n.detail})`:""]})]}):n.name==="read"?e.jsxs(e.Fragment,{children:[e.jsx(On,{className:"h-3 w-3 text-fg-3"}),e.jsxs("span",{children:["read the page",n.detail?` (${n.detail})`:""]})]}):e.jsxs(e.Fragment,{children:[e.jsx(Hn,{className:"h-3 w-3"}),e.jsxs("span",{children:["used ",e.jsx("span",{className:"font-medium text-fg-2",children:n.name}),n.detail?` (${n.detail})`:""]})]})}),n.name==="screenshot"&&n.imageUrl?e.jsx("img",{src:n.imageUrl,alt:"screenshot of the live preview",className:"mt-1.5 max-h-48 max-w-full rounded-md border border-border"}):null]})}function No(){var d;const{id:n}=La(),s=((d=Da().state)==null?void 0:d.publishContinuation)===!0,a=i.useRef(0),c=i.useRef(n);return!s&&n!==c.current&&(a.current+=1),c.current=n,e.jsx(wo,{pageId:n??null},a.current)}function wo({pageId:n}){var dn,un;const r=n??"draft",s=Ia(),a=Hr(),c=In(),[d,u]=i.useState(!1),[h,p]=i.useState(be),[f,g]=i.useState(Ie),M=qr(),L=zr(),w=$r(),{model:S,setModel:_,thinking:P,restoreThinking:te,preferredThinkingRef:y,zenModels:F,zenModelInfo:ne,modelsSettled:$,hasGoogleProject:we,googleModels:xe,modelOffered:ye,modelLabel:$n,modelReady:H,aiUnavailable:G,googleOut:Gn,googleReason:Xe,zenInfoFor:Vn}=M,[O,Rt]=i.useState(()=>[...Gr]),[re,Qe]=i.useState(""),de=i.useRef(null),Wn=t=>{if(gn(t)==="zen")return de.current??(de.current=crypto.randomUUID()),de.current},U=i.useRef(null),[ke,Je]=i.useState(""),[ae,Ze]=i.useState([]),[Yn,et]=i.useState(!1),[T,Pe]=i.useState(!1),[Kn,Se]=i.useState(""),[Xn,Ce]=i.useState(""),[Mt,tt]=i.useState(null),[Lt,Dt]=i.useState(0),[nt,N]=i.useState(null),[Qn,It]=i.useState(!1),[Pt,oe]=i.useState(null),[Ft,rt]=i.useState(null),[V,Bt]=i.useState(!1),[Fe,_t]=i.useState("desktop"),[at,ot]=i.useState("code"),[Ht,it]=i.useState(null),st=n!=null&&Ht!=null,[Ot,ue]=i.useState(null);i.useEffect(()=>{V||ot("code")},[V]);const[Jn,Zn]=i.useState(""),[lt,ct]=i.useState(null),[er,Ut]=i.useState("public"),[je,dt]=i.useState(null),[tr,ut]=i.useState(!1),[nr,qt]=i.useState(!1),[q,Te]=i.useState(null),[rr,ht]=i.useState(!1),[Be,_e]=i.useState(0),[zt,ar]=i.useState(0),he=i.useMemo(()=>URL.createObjectURL(new Blob([An(h,{screenshot:!0})],{type:"text/html"})),[h,zt]),He=i.useRef(null);i.useEffect(()=>{He.current&&He.current!==he&&URL.revokeObjectURL(He.current),He.current=he},[he]);const[k,$t]=i.useState(!1),[A,Oe]=i.useState(null),D=ao(n??"",!!n),R=Rn(n??"",k?(A==null?void 0:A.sha)??null:null);i.useEffect(()=>{!k||!D.data||(A&&!D.data.some(t=>t.sha===A.sha)?Oe(D.data[0]??null):!A&&D.data.length>0&&Oe(D.data[0]))},[k,A,D.data]);function Ue(){$t(!1),Oe(null),ft("preview"),pt("previous")}const[W,ft]=i.useState("preview"),[J,pt]=i.useState("previous"),Gt=k&&A&&D.data?D.data.findIndex(t=>t.sha===A.sha):-1,Ee=Gt>=0?((dn=D.data)==null?void 0:dn[Gt+1])??null:null,qe=Rn(n??"",k&&W==="diff"&&J==="previous"?(Ee==null?void 0:Ee.sha)??null:null),[Vt,Wt]=i.useState(!1),mt=i.useRef(null);i.useEffect(()=>()=>{mt.current&&clearTimeout(mt.current)},[]);function or(){Vt||(Wt(!0),D.refetch().finally(()=>{mt.current=setTimeout(()=>Wt(!1),2e3)}))}const Ne=i.useMemo(()=>R.data===void 0?null:URL.createObjectURL(new Blob([An(R.data)],{type:"text/html"})),[R.data]),ze=i.useRef(null);i.useEffect(()=>{ze.current&&ze.current!==Ne&&URL.revokeObjectURL(ze.current),ze.current=Ne},[Ne]);const $e=i.useRef(null),Ge=i.useRef([]),Yt=i.useRef(0);i.useEffect(()=>{Ge.current=[],Yt.current=Date.now()},[he]);const ir=i.useRef(0),Ae=i.useRef(new Map),gt=i.useRef(!1),Kt=i.useRef(k);i.useEffect(()=>{Kt.current=k},[k]),i.useEffect(()=>{gt.current=!1;const t=Ae.current;t.forEach(o=>{window.clearTimeout(o.timer),o.reject(new Error("the live preview reloaded — read the page again before acting on it"))}),t.clear()},[he,V,k]),i.useEffect(()=>{function t(o){var E;if(o.source!==((E=$e.current)==null?void 0:E.contentWindow))return;const l=o.data;if(!l)return;if(l.type==="aero-dom-ready"){gt.current=!0;return}if(l.type==="aero-dom-op-result"&&typeof l.id=="number"){const b=Ae.current.get(l.id);if(!b)return;Ae.current.delete(l.id),window.clearTimeout(b.timer);const v=typeof l.generation=="number"?l.generation:null;b.resolve(l.ok?{ok:!0,result:l.result,generation:v}:{ok:!1,error:l.error||"the action failed",generation:v});return}if(l.type!=="aero-console"||typeof l.ts=="number"&&l.ts<Yt.current)return;const m=l.level==="info"||l.level==="warn"||l.level==="error"?l.level:"log",x=Ge.current;x.push({level:m,text:typeof l.text=="string"?l.text:"",ts:l.ts??Date.now()}),x.length>300&&x.splice(0,x.length-300)}return window.addEventListener("message",t),()=>window.removeEventListener("message",t)},[]);async function sr(t,o,l){var v;Kt.current&&Ue(),Bt(!1);const m=Date.now()+1e4;for(;!gt.current||!((v=$e.current)!=null&&v.contentWindow);){if(Date.now()>m)return{ok:!1,error:"the live preview did not finish loading",generation:null};await new Promise(C=>setTimeout(C,50))}const x=$e.current.contentWindow,E=++ir.current,b=t==="screenshot"?3e4:15e3;return new Promise(C=>{const z=window.setTimeout(()=>{Ae.current.delete(E),C({ok:!1,error:"the live preview did not respond — read the page again and retry",generation:null})},b);Ae.current.set(E,{resolve:C,reject:le=>C({ok:!1,error:le.message,generation:null}),timer:z}),x.postMessage({type:"aero-dom-op",id:E,op:t,args:o,generation:l},"*")})}const I=i.useRef(h),Y=t=>{I.current=t,p(t)},K=i.useRef(be),Z=i.useRef(null),Ve=i.useRef(Ie),bt=i.useRef(null),Xt=i.useRef(null),Qt=i.useRef(null),ie=i.useRef(null),vt=i.useRef(zn);i.useEffect(()=>{let t=!0;return Vr().then(o=>Tn(o).then(l=>{t&&(vt.current=l)})).catch(()=>{}),Wr().then(o=>Tn(o).then(l=>{t&&(vt.current=l)})).catch(()=>{}),()=>{t=!1}},[]);const Re=!!S&&gn(S)==="zen",Me=Yr(S),lr=()=>{if(!re)return"Same as builder";const t=$n(re);return!$||ye(re)?t:`${t} — unavailable`};i.useEffect(()=>{let t=!1;return it(null),ue(null),Te(null),ht(!1),Qe(""),U.current=null,de.current=null,Z.current=null,(async()=>{const o=await bn(r).catch(()=>{});if(t)return;let l=Ie;if(o&&(Y(o.html),K.current=o.html,l=Kr(o.contents),g(l),Ve.current=l,_e(vn(l)),o.model&&_(o.model),te(o.thinking,o.model??S),Rt(Xr(o.disabledTools,o.knownTools)),Qe(o.observerModel??""),U.current=o.zenSessionId??null),n)try{const m=await ve.getPage(n);if(t)return;ct(m.url),Ut(kr(m.visibility)),it(m.html),Z.current=m.updated_at;const{html:x,supersededLocal:E}=Va(o,m);Y(x),K.current=x,o&&E!==null&&(ue(E),Ye({...o,html:x,contents:l,basedOnUpdatedAt:m.updated_at,updatedAt:0}).catch(()=>{}))}catch{t||N("Failed to load page.")}t||u(!0)})(),()=>{t=!0}},[r]);const se=i.useRef(Date.now());i.useEffect(()=>{if(!T)return;se.current=Date.now(),Dt(0);const t=setInterval(()=>Dt(Math.round((Date.now()-se.current)/1e3)),1e3);return()=>clearInterval(t)},[T]);const Jt=()=>{if(Re)return U.current??(U.current=crypto.randomUUID()),U.current},X=(t,o=O,l=re)=>{const m=I.current;return Ye({key:r,pageId:n,html:m,contents:t,model:S||null,thinking:y.current,disabledTools:o,knownTools:St(),observerModel:l||void 0,zenSessionId:U.current??void 0,basedOnUpdatedAt:Z.current??void 0,updatedAt:0}).then(()=>{K.current=m,Ve.current=t}).catch(()=>{})},Zt={sessionKey:r,pageId:n,contents:f,model:S,thinking:P,disabledTools:O,observerModel:re,modelsSettled:$,modelOffered:ye,zenInfoFor:Vn},B=i.useRef(Zt);B.current=Zt;const en=i.useRef(T);en.current=T,i.useEffect(()=>()=>{if(I.current===K.current&&B.current.contents===Ve.current)return;const{sessionKey:t,pageId:o,contents:l,model:m,thinking:x,disabledTools:E,observerModel:b}=B.current;Ye({key:t,pageId:o,html:I.current,contents:l,model:m||null,thinking:x,disabledTools:E,knownTools:St(),observerModel:b||void 0,zenSessionId:U.current??void 0,basedOnUpdatedAt:Z.current??void 0,updatedAt:0}).catch(()=>{})},[]);const wt=!Re,cr=wt&&(ae.length>0||f.some(t=>t.parts.some(o=>o.inlineData))),fe=i.useMemo(()=>Ln(f,ae,ke),[f,ae,ke]),dr=wt&&fe>ge,tn=fe/ge>=mo,nn=Be/Me>=go,rn=Math.max(0,100-Math.round(Be/Me*100)),an=Me>=1e6?`${Math.round(Me/1e6)}M`:`${Math.round(Me/1e3)}K`;async function on(t){var le;const o=t===void 0,l=(t??ke).trim(),m=o?ae:[];if(!l&&m.length===0||T||!H)return;const x=o?fe:Ln(f,m,l);if(wt&&x>ge){N(`This message is too large to send (~${ce(x)} — Gemini's inline-request limit is ~${ce(ge)}). `+(m.length>0?"Remove an attachment, or run /compact first.":"Run /compact first."));return}if(l.startsWith("/")){const Q=l.split(/\s+/)[0];if(!ha(Dn,Q)){N(`Unknown command: ${Q} — available: /compact`);return}}const E=fa(l);if(E){Je(""),await fr(E.instructions);return}const b=[pa()];for(const Q of m)b.push(ma(Q.name,Q.mimeType)),b.push(Q.kind==="inline"?{inlineData:{mimeType:Q.mimeType,data:Q.data??""}}:{text:Q.text??""});l&&b.push({text:l});const v=/\b(slides?|decks?|presentations?|powerpoint|pptx?|pitch(?:es)?)\b/i.test(l),C=/\bdeck-container\b|class="slide slide--/.test(I.current);I.current===be?b.push(Et(`The HTML document is still the untouched blank starter template — it contains no user content. Do not call \`read\` on it. If this message is a change request, load the \`${v?"aero-slides":"aero-app-style"}\` skill, then write the first draft directly with \`write\`.`)):C?b.push(Et("The current document is an aero slide deck. Load the `aero-slides` skill (if not already loaded in this conversation) and follow its layout catalogue and navigation engine when editing.")):v&&b.push(Et("This request is about a slide deck / presentation. Load the `aero-slides` skill before making changes, and follow its layout catalogue and navigation engine."));const z=[...f,{role:"user",parts:b}];(le=bt.current)==null||le.followOutput(),g(z),o&&(Je(""),Ze([])),Ya(),await sn(z)}async function sn(t){const o=new AbortController;ie.current=o,Pe(!0),Se(""),Ce(""),N(null),It(!1),oe(null);const l=B.current.sessionKey;Te(null);const m=I.current,x=Date.now(),E=Jt();try{const b=await ya({model:S,contents:t,html:()=>I.current,skills:vt.current,pageId:n,consoleLogs:()=>Ge.current,domOp:sr,browse:L,generationConfig:Sn(P,S),thinking:P,zenModelInfo:ne,zenSession:E,hasGoogleProject:we,disabledTools:O,signal:o.signal,callbacks:{onText:v=>{se.current=Date.now(),oe(null),Se(C=>C+v)},onThought:v=>{se.current=Date.now(),oe(null),Ce(C=>C+v)},onUsage:v=>{const C=v.totalTokenCount??v.promptTokenCount;typeof C=="number"&&_e(C)},onTool:(v,C)=>{se.current=Date.now(),oe(null),tt({name:v,detail:C})},onHtml:v=>Y(v),onContents:v=>{se.current=Date.now(),tt(null),g(v),Se(""),Ce("")},onStreamReset:()=>{Se(""),Ce(""),oe(null)},onRetry:(v,C,z)=>{se.current=Date.now(),oe({attempt:v,max:C,deadline:Date.now()+z*1e3})}}});g(b),await X(b),Date.now()-x>1e4&&Nn({ok:!0});try{await hr(b,m,l,o.signal)}catch{}}catch(b){if(b instanceof DOMException&&b.name==="AbortError")await X(B.current.contents);else{const v=b instanceof me?ka(b.body):null,C=b instanceof me?b.message==="reauth_required"?"Your Google credential has expired or is invalid. Sign out and sign in again to reconnect.":v?v.message:`AI request failed: ${b.message}`:"AI request failed.";v&&rt(v),N(C),It(!(b instanceof me&&b.message==="reauth_required")),Nn({ok:!1,error:C}),await X(t)}}finally{ie.current===o&&(ie.current=null),Pe(!1),Se(""),Ce(""),tt(null),oe(null)}}function ur(){var t;(t=ie.current)==null||t.abort()}async function We(){var t;T||!H||f.length===0||((t=bt.current)==null||t.followOutput(),await sn(f))}async function hr(t,o,l,m){if(B.current.sessionKey!==l||B.current.disabledTools.includes(jt)||m.aborted||I.current===o||!wn(t))return;const{observerModel:x,model:E,modelsSettled:b,modelOffered:v,zenInfoFor:C}=B.current,z=x&&(!b||v(x))?x:E;ht(!0);try{const le=await ja({model:z,request:Ta(t),html:I.current,consoleEntries:Ge.current,zenModelInfo:C(z),zenSession:Wn(z),signal:m});le&&B.current.sessionKey===l&&Te(le)}finally{ht(!1)}}async function fr(t){if(T||!H)return;if(f.length===0){N("Nothing to compact — the conversation is empty.");return}const o=new AbortController;ie.current=o,Pe(!0),qt(!0),N(null);try{const l=await Sa({model:S,contents:f,instructions:t||void 0,generationConfig:Sn("off",S),zenSession:Jt(),signal:o.signal});await pe(Ca(l))}catch(l){l instanceof DOMException&&l.name==="AbortError"||N(l instanceof me?`Compaction failed: ${l.message}`:"Compaction failed.")}finally{ie.current===o&&(ie.current=null),Pe(!1),qt(!1)}}async function pe(t){g(t),_e(vn(t)),await X(t)}async function pr(t){if(T)return;const o=f;if(!(!await c({title:"Delete from history?",body:t.kind==="tool"||t.kind==="grouped-search"?`Removes ${t.refs.length===1?"this tool call and its result":`these ${t.refs.length} tool calls and their results`} from the context sent to the model. The page itself is not affected.`:t.kind==="thought"?"Clears this reasoning from the context sent to the model. The page itself is not affected.":"Removes this record from the context sent to the model. The page itself is not affected.",confirmLabel:"Delete",variant:"danger"})||en.current||B.current.contents!==o))switch(t.kind){case"user":case"compact":await pe(wa(f,t.contentIndex));break;case"thought":await pe(va(f,t.refs));break;case"tool":case"grouped-search":await pe(ba(f,t.refs));break;case"assistant":await pe(ga(f,t.refs));break}}async function mr(t,o){T||t.kind!=="user"&&t.kind!=="assistant"||B.current.contents===f&&await pe(xa(f,t.refs,o))}const Le=Or({mutationFn:async t=>{const o=I.current;if(n){const m=await ve.patchPage(n,{html:o});return{id:n,isNew:!1,url:null,html:o,visibility:er,updatedAt:m.updated_at}}const l=await ve.createPage(o,{alias:(t==null?void 0:t.alias)||null,visibility:(t==null?void 0:t.visibility)??"public",grants:(t==null?void 0:t.grants)??[]});return{id:l.id,isNew:!0,url:l.url,html:o,visibility:(t==null?void 0:t.visibility)??"public",updatedAt:l.updated_at}},onSuccess:async({id:t,isNew:o,url:l,html:m,visibility:x,updatedAt:E})=>{if(N(null),ut(!1),Ut(x),K.current=m,it(m),Z.current=E??Z.current,ue(null),a.invalidateQueries({queryKey:["pages"]}),a.invalidateQueries({queryKey:["page",t]}),a.invalidateQueries({queryKey:["page-history",t]}),o)await Ye({key:t,pageId:t,html:I.current,contents:f,model:S||null,thinking:P,disabledTools:O,knownTools:St(),observerModel:re||void 0,zenSessionId:U.current??void 0,basedOnUpdatedAt:Z.current??void 0,updatedAt:0}).catch(()=>{}),await Ct("draft").catch(()=>{}),ct(l),dt({url:l??`/p/${t}`,id:t,isNew:!0,visibility:x});else{const b=lt??`/p/${t}`;ct(b),dt({url:b,id:t,isNew:!1,visibility:x})}},onError:t=>{t instanceof me&&t.body&&typeof t.body=="object"&&"reason"in t.body?N(`Publish failed: ${t.message} (${String(t.body.reason)})`):t instanceof me?N(`Publish failed: ${t.message}`):N("Publish failed.")}});async function gr(){if(await c({title:"Reset builder",body:n?"Clears the conversation and restores the HTML from the published page.":"Clears the conversation and the draft HTML. This cannot be undone.",confirmLabel:"Reset",variant:"danger"}))if(await Ct(r).catch(()=>{}),g(Ie),Ve.current=Ie,_e(0),N(null),Te(null),U.current=null,de.current=null,n)try{const o=await ve.getPage(n);Y(o.html),K.current=o.html,Z.current=o.updated_at,ue(null)}catch{N("Failed to reload page.")}else Y(be),K.current=be}async function br(){if(I.current!==K.current){if(!await c({title:"Unpublished changes",body:"You have unpublished changes to this page. Publish them first, or discard them and start a new page.",confirmLabel:"Discard & start new",variant:"danger"}))return;K.current=I.current}const t=await bn("draft").catch(()=>{});t&&(t.contents.length>0||t.html!==be)&&await c({title:"Unfinished draft",body:"You have an unfinished draft. Start fresh and discard it, or resume where you left off?",confirmLabel:"Start fresh",cancelLabel:"Resume draft",variant:"danger"})&&await Ct("draft").catch(()=>{}),s("/")}async function vr(t){var m;const o=(m=t.target.files)==null?void 0:m[0];if(t.target.value="",!o)return;const l=await o.text();Y(l),N(null),X(f)}async function xt(t){if(t.length===0)return;if(Re){N("Free models cannot read attachments. Switch to a Google model to attach files.");return}const o=[],l=[];for(const m of t){const x=await Ua(m);"error"in x?l.push(x.error):o.push(x)}o.length>0&&Ze(m=>[...m,...o]),l.length>0&&N(l.join(" "))}function wr(t){const o=Array.from(t.target.files??[]);t.target.value="",xt(o)}const yt=i.useMemo(()=>Qr(f),[f]),ln=Gn&&F.length>0,De=f[f.length-1],xr=(De==null?void 0:De.role)==="user"&&De.parts.some(Jr),cn=!T&&!!De&&!wn(f)&&!xr,yr=((un=yt[yt.length-1])==null?void 0:un.kind)==="user";return d?e.jsxs("div",{className:"flex h-[calc(100vh-8.5rem)] min-h-[480px] flex-col gap-3",children:[e.jsxs("div",{className:"flex flex-wrap items-center gap-2",children:[e.jsx(Zr,{choice:M,disabled:T}),e.jsxs("button",{type:"button",onClick:()=>Bt(t=>!t),disabled:k,className:j("inline-flex h-8 items-center gap-1.5 rounded-md border border-border px-2.5 text-[12px] disabled:opacity-50",V?"bg-ink text-white":"bg-surface text-fg-2 hover:text-fg"),children:[e.jsx(_n,{className:"h-3.5 w-3.5"})," Code"]}),e.jsxs("div",{className:j("flex items-center gap-1 rounded-md border border-border bg-surface p-0.5 text-[11px]",(V||k&&W!=="preview")&&"opacity-50"),children:[e.jsxs("button",{type:"button",onClick:()=>_t("desktop"),disabled:V||k&&W!=="preview",title:"Preview at full width",className:j("inline-flex items-center gap-1 rounded-sm px-2 py-1",Fe==="desktop"?"bg-ink text-white":"text-fg-2 hover:text-fg"),children:[e.jsx(jr,{className:"h-3.5 w-3.5"})," Desktop"]}),e.jsxs("button",{type:"button",onClick:()=>_t("mobile"),disabled:V||k&&W!=="preview",title:"Preview at phone width",className:j("inline-flex items-center gap-1 rounded-sm px-2 py-1",Fe==="mobile"?"bg-ink text-white":"text-fg-2 hover:text-fg"),children:[e.jsx(Tr,{className:"h-3.5 w-3.5"})," Mobile"]})]}),e.jsxs("button",{type:"button",onClick:()=>ar(t=>t+1),disabled:V||k,title:"Reload the preview (recovers a broken or navigated-away preview)",className:"inline-flex h-8 items-center gap-1.5 rounded-md border border-border bg-surface px-2.5 text-[12px] text-fg-2 hover:text-fg disabled:opacity-50",children:[e.jsx(hn,{className:"h-3.5 w-3.5"})," Reload"]}),e.jsxs("button",{type:"button",onClick:()=>{var t;return(t=Xt.current)==null?void 0:t.click()},disabled:T||k,title:"Load an .html file into the builder (replaces the current document)",className:"inline-flex h-8 items-center gap-1.5 rounded-md border border-border bg-surface px-2.5 text-[12px] text-fg-2 hover:text-fg disabled:opacity-50",children:[e.jsx(Er,{className:"h-3.5 w-3.5"})," Upload"]}),e.jsx("input",{ref:Xt,type:"file",accept:".html,.htm,text/html",hidden:!0,onChange:vr}),e.jsxs("button",{type:"button",onClick:gr,disabled:T||k,className:"inline-flex h-8 items-center gap-1.5 rounded-md border border-border bg-surface px-2.5 text-[12px] text-fg-2 hover:text-fg disabled:opacity-50",children:[e.jsx(Nr,{className:"h-3.5 w-3.5"})," Reset"]}),n?e.jsxs("button",{type:"button",onClick:br,disabled:T||k,title:"Start a new page in the draft builder",className:"inline-flex h-8 items-center gap-1.5 rounded-md border border-border bg-surface px-2.5 text-[12px] text-fg-2 hover:text-fg disabled:opacity-50",children:[e.jsx(Ar,{className:"h-3.5 w-3.5"})," New"]}):null,n?e.jsxs("button",{type:"button",onClick:()=>k?Ue():$t(!0),title:"Browse previously published versions of this page",className:j("inline-flex h-8 items-center gap-1.5 rounded-md border border-border px-2.5 text-[12px]",k?"bg-ink text-white":"bg-surface text-fg-2 hover:text-fg"),children:[e.jsx(Bn,{className:"h-3.5 w-3.5"})," History"]}):null,e.jsxs("div",{className:"ml-auto flex items-center gap-2",children:[lt?e.jsxs("a",{href:lt,target:"_blank",rel:"noreferrer",className:"inline-flex items-center gap-1 text-[12px] text-fg-2 hover:text-fg",children:["View live ",e.jsx(Rr,{className:"h-3 w-3"})]}):null,e.jsxs(ee,{size:"sm",onClick:()=>n?Le.mutate(void 0):ut(!0),disabled:T||Le.isPending||k,children:[Le.isPending?e.jsx(Mr,{className:"h-3.5 w-3.5 animate-spin"}):e.jsx(Fn,{className:"h-3.5 w-3.5"}),n?"Publish update":"Publish"]})]})]}),nt&&!k?e.jsxs("div",{className:"flex items-center gap-2 rounded-md border border-no/30 bg-no-soft px-3 py-2 text-[12px] text-no-strong",children:[e.jsx("span",{className:"min-w-0 flex-1 break-words",children:nt}),Qn&&!T?e.jsxs("button",{type:"button",onClick:()=>void We(),className:"inline-flex shrink-0 items-center gap-1 rounded border border-no/30 bg-surface px-2 py-0.5 text-[11px] font-medium text-no-strong hover:bg-no-soft",children:[e.jsx(hn,{className:"h-3 w-3"})," Retry"]}):null]}):null,Ot!==null&&!k?e.jsxs("div",{className:"flex items-center gap-2 rounded-md border border-border bg-surface-muted px-3 py-2 text-[12px] text-fg-2",children:[e.jsx("span",{className:"min-w-0 flex-1 break-words",children:"This page was updated outside this browser — loaded the latest published version."}),e.jsxs("button",{type:"button",onClick:()=>{Y(Ot),ue(null),X(f)},className:"inline-flex shrink-0 items-center gap-1 rounded border border-border bg-surface px-2 py-0.5 text-[11px] font-medium text-fg hover:bg-surface-muted",children:[e.jsx(Lr,{className:"h-3 w-3"})," Keep my local copy"]}),e.jsx("button",{type:"button",onClick:()=>ue(null),"aria-label":"Dismiss",className:"shrink-0 rounded p-0.5 text-fg-3 hover:text-fg",children:e.jsx(kt,{className:"h-3 w-3"})})]}):null,(G||ln)&&!k?e.jsxs("div",{className:"space-y-2",children:[e.jsxs("div",{className:"rounded-md border border-border bg-surface-muted px-3 py-2 text-[12px] text-fg-2",children:[G?"AI is unavailable — ":"Google models are unavailable — ",Xe==="no_project"?e.jsxs(e.Fragment,{children:["no Code Assist project selected for your account."," ",e.jsx(Pa,{to:"/settings",className:"underline hover:text-fg",children:"Choose one in Settings"}),"."]}):Xe==="reauth_required"?"your Google credential has expired or is invalid. Sign out and sign in again to reconnect.":"could not load models. Try again later.",ln?" Free models are listed in the model picker and need no Google account.":null]}),Xe==="no_project"?e.jsx(Ea,{}):null]}):null,cn&&!nt&&!yr&&!k?e.jsxs("div",{className:"flex items-center gap-2 rounded-md border border-border bg-surface-muted px-3 py-2 text-[12px] text-fg-2",children:[e.jsx("span",{className:"min-w-0 flex-1",children:"Aero stopped before finishing — resume to keep going."}),e.jsxs("button",{type:"button",onClick:()=>void We(),disabled:G||!H,className:"inline-flex shrink-0 items-center gap-1 rounded border border-border bg-surface px-2 py-0.5 text-[11px] font-medium text-fg-2 hover:bg-surface-muted disabled:opacity-50",children:[e.jsx(fn,{className:"h-3 w-3"})," Resume"]})]}):null,e.jsxs("div",{className:"flex min-h-0 flex-1 gap-4",children:[e.jsx("div",{className:j("flex w-[380px] shrink-0 flex-col rounded-lg border border-border bg-surface",Yn&&"ring-2 ring-ink"),onDragOver:t=>{k||(t.preventDefault(),et(!0))},onDragLeave:()=>et(!1),onDrop:t=>{k||(t.preventDefault(),et(!1),xt(Array.from(t.dataTransfer.files)))},children:k?e.jsx(oo,{entries:D.data,isLoading:D.isLoading,isError:D.isError,isFetching:D.isFetching||Vt,selectedSha:(A==null?void 0:A.sha)??null,onSelect:Oe,onRefresh:or}):e.jsx(ea,{ref:bt,chat:yt,busy:T,streamText:Kn,streamThought:Xn,busyLabel:nr?"compacting conversation…":rr?"reviewing the page…":bo(Mt,Lt,Pt),toolActive:Mt!==null,retrying:Pt!==null,busyElapsed:Lt,emptyState:e.jsxs(e.Fragment,{children:["Describe the page you want to build.",e.jsx("br",{}),"Aero edits the HTML and you preview it live.",e.jsx("br",{}),"Or upload an existing .html file to start from."]}),renderToolItem:vo,afterMessages:q?e.jsxs("div",{className:"rounded-md border border-border bg-surface-muted px-3 py-2 text-[12px] text-fg-2",children:[e.jsxs("div",{className:"flex items-center gap-1.5",children:[q.kind==="issues"?e.jsx(Ir,{className:"h-3.5 w-3.5 shrink-0 text-warning"}):q.kind==="pass"?e.jsx(Pn,{className:"h-3.5 w-3.5 shrink-0 text-success"}):e.jsx(On,{className:"h-3.5 w-3.5 shrink-0 text-fg-3"}),e.jsx("span",{className:"min-w-0 flex-1",children:q.kind==="issues"?e.jsxs("span",{className:"font-medium text-fg-2",children:["Review found"," ",q.findings.length===1?"1 thing":`${q.findings.length} things`," ","to check"]}):q.kind==="pass"?e.jsxs("span",{className:"text-fg-3",children:[e.jsx("span",{className:"font-medium text-fg-2",children:"Review passed"})," — nothing to flag on this change."]}):e.jsxs("span",{className:"text-fg-3",children:[e.jsx("span",{className:"font-medium text-fg-2",children:"Review didn’t run."})," The build finished normally — only the review failed."]})}),e.jsx("button",{type:"button",onClick:()=>Te(null),"aria-label":"Dismiss review",title:"Dismiss review",className:"shrink-0 rounded p-0.5 text-fg-3 hover:bg-surface hover:text-fg-2",children:e.jsx(kt,{className:"h-3 w-3"})})]}),q.kind==="issues"?e.jsxs(e.Fragment,{children:[e.jsx("ul",{className:"mt-1.5 space-y-1 pl-5",children:q.findings.map((t,o)=>e.jsx("li",{className:"list-disc text-fg-2",children:t},o))}),e.jsx("div",{className:"mt-2 pl-5",children:e.jsxs("button",{type:"button",onClick:()=>void on(ua(q.findings)),disabled:T||G||!H,className:"inline-flex shrink-0 items-center gap-1 rounded border border-border bg-surface px-2 py-0.5 text-[11px] font-medium text-fg-2 hover:bg-surface-muted disabled:opacity-50",children:[e.jsx(fn,{className:"h-3 w-3"})," Fix these"]})})]}):null]}):null,canResume:cn,resumeDisabled:G||!H,onResume:()=>void We(),onSaveItemEdit:(t,o)=>void mr(t,o),onDeleteItem:t=>void pr(t),input:ke,onInputChange:Je,onSend:()=>void on(),onStop:ur,composerDisabled:T||G||!H,sendDisabled:G||!H||!ke.trim()&&ae.length===0||dr,placeholder:G?"AI unavailable":!H&&$?"Pick a model to continue — the last one is no longer available":"Ask Aero to build or change something…",slashCommands:Dn,composerMeta:e.jsxs("div",{className:"flex min-w-0 items-center gap-2 text-[11px] text-fg-3",children:[cr?e.jsx("span",{className:j("tabular truncate",tn&&"font-medium text-no-strong"),title:`Estimated request size with attached files: ${ce(fe)} of ${ce(ge)} — Gemini rejects requests over ~20MB`,children:tn?`${ce(fe)} / ${ce(ge)}`:ce(fe)}):null,e.jsx("span",{className:j("tabular truncate",nn&&"font-medium text-no-strong"),title:`Approximate context window usage: ${Mn(Be)} of ${an} tokens (${rn}% left) — ${Re?"free models are held to a 200K-token context":"all Gemini models have a ~1M-token context"}`,children:nn?`${Mn(Be)} / ${an}`:`${rn}% left`})]}),attachmentsBar:ae.length>0?e.jsx("div",{className:"flex flex-wrap gap-1.5 px-3 pt-2.5",children:ae.map(t=>e.jsxs("div",{className:"flex items-center gap-1.5 overflow-hidden rounded-md border border-border bg-surface-muted pr-1.5 text-[11px]",children:[t.kind==="inline"&&t.mimeType.startsWith("image/")?e.jsx("img",{src:`data:${t.mimeType};base64,${t.data}`,alt:t.name,className:"h-7 w-7 shrink-0 object-cover"}):e.jsx("span",{className:"flex h-7 w-7 shrink-0 items-center justify-center text-fg-3",children:da(t.mimeType)}),e.jsx("span",{className:"max-w-[8rem] truncate text-fg-2",title:t.name,children:t.name}),e.jsx("button",{type:"button",onClick:()=>Ze(o=>o.filter(l=>l.id!==t.id)),title:"Remove",className:"text-fg-3 hover:text-fg",children:e.jsx(kt,{className:"h-3 w-3"})})]},t.id))}):void 0,composerLeading:e.jsxs("div",{className:"flex shrink-0 items-center gap-0.5",children:[e.jsxs(ta,{children:[e.jsx(na,{asChild:!0,children:e.jsxs(ee,{variant:"ghost",size:"sm","aria-label":"Which tools the agent may use",title:"Which tools the agent may use",className:j(xn,"relative"),children:[e.jsx(Hn,{className:"h-3.5 w-3.5"}),O.length>0?e.jsx("span",{className:"absolute right-1 top-1 h-1.5 w-1.5 rounded-full bg-status"}):null]})}),e.jsx(ra,{className:"w-60",children:aa.map(t=>e.jsxs(i.Fragment,{children:[e.jsx(oa,{checked:!t.names.some(o=>O.includes(o)),disabled:!!yn(t.names,{browseAvailable:w}),onCheckedChange:o=>{const l=o?O.filter(m=>!t.names.includes(m)):[...new Set([...O,...t.names])];Rt(l),X(f,l)},children:e.jsxs("span",{className:"flex flex-col",children:[e.jsx("span",{children:t.label}),e.jsx("span",{className:"text-[11px] text-fg-3",children:yn(t.names,{browseAvailable:w})??t.hint})]})}),t.names.includes(jt)&&!O.includes(jt)?e.jsxs(ia,{children:[e.jsx(sa,{children:e.jsxs("span",{className:"flex flex-col",children:[e.jsx("span",{children:"Reviewer model"}),e.jsx("span",{className:"text-[11px] text-fg-3",children:lr()})]})}),e.jsx(la,{className:"max-h-72 w-56 overflow-y-auto",children:e.jsxs(ca,{value:re,onValueChange:o=>{Qe(o),X(f,O,o)},children:[e.jsx(Tt,{value:"",children:"Same as builder"}),xe.length>0?e.jsxs(e.Fragment,{children:[e.jsx(kn,{children:"Google"}),xe.map(o=>e.jsx(Tt,{value:o,children:o},o))]}):null,F.length>0?e.jsxs(e.Fragment,{children:[e.jsx(kn,{children:"Free · opencode zen"}),F.map(o=>e.jsx(Tt,{value:o.id,children:o.name},o.id))]}):null]})})]}):null]},t.id))})]}),Re?null:e.jsxs(e.Fragment,{children:[e.jsx(ee,{variant:"ghost",size:"sm",onClick:()=>{var t;return(t=Qt.current)==null?void 0:t.click()},disabled:T||G||!H,title:"Attach a file (image, PDF, audio, video, or text)",className:xn,children:e.jsx(Dr,{className:"h-3.5 w-3.5"})}),e.jsx("input",{ref:Qt,type:"file",multiple:!0,hidden:!0,onChange:wr})]})]}),onPasteFiles:t=>void xt(t)})}),e.jsx("div",{className:"flex min-w-0 flex-1 flex-col overflow-hidden rounded-lg border border-border bg-surface",children:k?e.jsxs(e.Fragment,{children:[e.jsx(io,{entry:A,canRestore:!!A&&R.data!==void 0,onRestore:()=>{R.data!==void 0&&(Y(R.data),X(f)),Ue()},onExit:Ue}),A?e.jsxs("div",{className:"flex items-center gap-2 border-b border-border px-3 py-1.5",children:[e.jsxs("div",{className:"flex items-center gap-1 rounded-md border border-border bg-surface p-0.5 text-[11px]",children:[e.jsx("button",{type:"button",onClick:()=>ft("preview"),className:j("rounded-sm px-2 py-1",W==="preview"?"bg-ink text-white":"text-fg-2 hover:text-fg"),children:"Preview"}),e.jsx("button",{type:"button",onClick:()=>ft("diff"),className:j("rounded-sm px-2 py-1",W==="diff"?"bg-ink text-white":"text-fg-2 hover:text-fg"),children:"Diff"})]}),W==="diff"?e.jsxs("div",{className:"flex items-center gap-1 rounded-md border border-border bg-surface p-0.5 text-[11px]",children:[e.jsx("button",{type:"button",onClick:()=>pt("previous"),className:j("rounded-sm px-2 py-1",J==="previous"?"bg-surface-muted text-fg":"text-fg-3 hover:text-fg-2"),children:"vs Previous version"}),e.jsx("button",{type:"button",onClick:()=>pt("draft"),className:j("rounded-sm px-2 py-1",J==="draft"?"bg-surface-muted text-fg":"text-fg-3 hover:text-fg-2"),children:"vs Current draft"})]}):null]}):null,W==="diff"&&A?J==="previous"&&!Ee?e.jsx("div",{className:"p-4 text-[12px] text-fg-3",children:"This is the first published version — nothing to compare it against."}):J==="previous"&&qe.isLoading||R.isLoading?e.jsx("div",{className:"p-4 text-[12px] text-fg-3",children:"Loading diff…"}):J==="previous"&&qe.isError||R.isError?e.jsx("div",{className:"p-4 text-[12px] text-no-strong",children:"Failed to load diff."}):J==="previous"&&qe.data!==void 0&&R.data!==void 0?e.jsx(At,{oldText:qe.data,newText:R.data,oldLabel:`Version from ${new Date(Ee.committed_at).toLocaleString()}`,newLabel:`Version from ${new Date(A.committed_at).toLocaleString()}`}):J==="draft"&&R.data!==void 0?e.jsx(At,{oldText:h,newText:R.data,oldLabel:"Current draft",newLabel:`Version from ${new Date(A.committed_at).toLocaleString()}`}):null:W==="preview"?R.isLoading?e.jsx("div",{className:"p-4 text-[12px] text-fg-3",children:"Loading version…"}):R.isError?e.jsx("div",{className:"p-4 text-[12px] text-no-strong",children:"Failed to load this version."}):Ne?e.jsx("div",{className:"flex h-full w-full justify-center overflow-auto bg-surface-muted",children:e.jsx("iframe",{title:"historic version preview",src:Ne,sandbox:"allow-scripts allow-modals allow-forms allow-popups",className:j("h-full bg-white",Fe==="mobile"?"w-[390px] shrink-0 border-x border-border":"w-full flex-1")})}):e.jsx("div",{className:"p-4 text-[12px] text-fg-3",children:"Select a version from the list to preview it."}):null]}):V?e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"flex items-center gap-2 border-b border-border px-3 py-1.5",children:e.jsxs("div",{className:"flex items-center gap-1 rounded-md border border-border bg-surface p-0.5 text-[11px]",children:[e.jsx("button",{type:"button",onClick:()=>ot("code"),className:j("rounded-sm px-2 py-1",at==="code"?"bg-ink text-white":"text-fg-2 hover:text-fg"),children:"Code"}),e.jsx("button",{type:"button",onClick:()=>ot("diff"),disabled:!st,title:st?void 0:"Diff becomes available once this page has been published",className:j("rounded-sm px-2 py-1 disabled:opacity-50",at==="diff"?"bg-ink text-white":"text-fg-2 hover:text-fg"),children:"Diff"})]})}),at==="diff"&&st?e.jsx(At,{oldText:Ht,newText:h,oldLabel:"Last published version",newLabel:"Current draft"}):e.jsx(i.Suspense,{fallback:e.jsx("div",{className:"p-3 text-[12px] text-fg-3",children:"Loading editor…"}),children:e.jsx(po,{value:h,onChange:Y,language:"html",className:"flex-1 overflow-auto"})})]}):e.jsx("div",{className:"flex h-full w-full justify-center overflow-auto bg-surface-muted",children:e.jsx("iframe",{ref:$e,title:"preview",src:he,sandbox:"allow-scripts allow-modals allow-forms allow-popups",className:j("h-full bg-white",Fe==="mobile"?"w-[390px] shrink-0 border-x border-border":"w-full flex-1")},zt)})})]}),tr?e.jsx(ro,{initialAlias:Jn,busy:Le.isPending,onCancel:()=>ut(!1),onPublish:t=>{Zn(t.alias),Le.mutate(t)}}):null,je?e.jsx(no,{url:je.url,isNew:je.isNew,visibility:je.visibility,onClose:()=>{const t=je;dt(null),t.isNew&&s(`/builder/${t.id}`,{replace:!0,state:{publishContinuation:!0}})}}):null,Ft?e.jsx(Na,{info:Ft,onEnabled:()=>{rt(null),N(null),We()},onClose:()=>rt(null)}):null]}):e.jsx("div",{className:"text-fg-3",children:"Loading…"})}export{No as BuilderPage};
