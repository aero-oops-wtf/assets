...
`,Ga=`# Aero HTML Slides Style Guide
...
`,Wa=`# aero-ai: calling Gemini from inside an aero page
...
`,Yt=[];function po(e){return e<1e3?String(e):e<1e6?`${(e/1e3).toFixed(e<1e4?1:0)}k`:`${(e/1e6).toFixed(2)}M`}function Yu(e,t,n){const r=JSON.stringify(e).length,o=t.reduce((i,l)=>{var c,u;return i+(l.kind==="inline"?((c=l.data)==null?void 0:c.length)??0:((u=l.text)==null?void 0:u.length)??0)},0);return r+o+n.length}const Xu=["off","low","medium","high"],es="medium",mo={off:0,low:4096,medium:12288,high:24576};function go(e,t){let n=mo[e]??mo[es];return e==="off"&&t.includes("pro")&&(n=128),{thinkingConfig:{thinkingBudget:n,...e==="off"?{}:{includeThoughts:!0}}}}const Qu=.75,Zu=.85,vo=[{name:"compact",aliases:["compress"],hint:"[focus instructions]",description:"Summarize the conversation to free up context"}];function Ju(e,t,n){if(n){const r=Math.max(0,Math.ceil((n.deadline-Date.now())/1e3));return`rate-limited — retry ${n.attempt} of ${n.max} in ${r}s…`}if(e)switch(e.name){case"write":return"writing the page…";case"edit":return"editing the page…";case"read":return`reading the page${e.detail?` (${e.detail})`:""}…`;case"grep":return`searching the page${e.detail?` for “${e.detail}”`:""}…`;case"console":return"checking the console…";case"skill":return e.detail?`loading the ${e.detail} skill…`:"loading a skill…";case"action":return`running ${e.detail??"an action"}…`;case"web_search":return e.detail?`searching the web for “${e.detail}”…`:"searching the web…";case"database":return"updating the database…";default:return`using ${e.name}…`}return t>=10?`working… (${t}s — large edits can take a minute)`:t>=3?`working… (${t}s)`:"working…"}function ed(e){return a.jsxs("div",{children:[a.jsx("div",{className:"flex items-center gap-1.5 text-[11px] text-fg-3",children:e.name==="screenshot"?a.jsxs(a.Fragment,{children:[a.jsx(Ws,{className:"h-3 w-3 text-fg-3"}),a.jsx("span",{children:"looked at the page"})]}):e.name==="write"||e.name==="edit"?a.jsxs(a.Fragment,{children:[a.jsx(ko,{className:"h-3 w-3 text-fg-3"}),a.jsx("span",{children:"edited the page"})]}):e.name==="skill"?a.jsxs(a.Fragment,{children:[a.jsx(So,{className:"h-3 w-3 text-fg-3"}),a.jsxs("span",{children:["loaded the ",a.jsx("span",{className:"font-medium text-fg-2",children:e.detail??"unknown"})," skill"]})]}):e.name==="action"?a.jsxs(a.Fragment,{children:[a.jsx($r,{className:"h-3 w-3 text-fg-3"}),a.jsxs("span",{children:["ran ",a.jsx("span",{className:"font-medium text-fg-2",children:e.detail??"an action"})]})]}):e.name==="console"?a.jsxs(a.Fragment,{children:[a.jsx($r,{className:"h-3 w-3 text-fg-3"}),a.jsx("span",{children:"checked the console"})]}):e.name==="grep"?a.jsxs(a.Fragment,{children:[a.jsx(qs,{className:"h-3 w-3 text-fg-3"}),a.jsxs("span",{children:["searched the page",e.detail?a.jsxs(a.Fragment,{children:[" for ",a.jsx("span",{className:"max-w-[16rem] truncate font-medium text-fg-2",children:e.detail})]}):null]})]}):e.name==="database"?a.jsxs(a.Fragment,{children:[a.jsx(Ks,{className:"h-3 w-3 text-fg-3"}),a.jsxs("span",{children:["updated the database",e.detail?` (${e.detail})`:""]})]}):e.name==="read"?a.jsxs(a.Fragment,{children:[a.jsx(Ys,{className:"h-3 w-3 text-fg-3"}),a.jsxs("span",{children:["read the page",e.detail?` (${e.detail})`:""]})]}):a.jsxs(a.Fragment,{children:[a.jsx(Co,{className:"h-3 w-3"}),a.jsxs("span",{children:["used ",a.jsx("span",{className:"font-medium text-fg-2",children:e.name}),e.detail?` (${e.detail})`:""]})]})}),e.name==="screenshot"&&e.imageUrl?a.jsx("img",{src:e.imageUrl,alt:"screenshot of the live preview",className:"mt-1.5 max-h-48 max-w-full rounded-md border border-border"}):null]})}function vd(){var i;const{id:e}=Na(),n=((i=Da().state)==null?void 0:i.publishContinuation)===!0,r=s.useRef(0),o=s.useRef(e);return!n&&e!==o.current&&(r.current+=1),o.current=e,a.jsx(td,{pageId:e??null},r.current)}function td({pageId:e}){var Mr,Ar,jr,Nr,Dr,_r;const t=e??"draft",n=_a(),r=Xs(),o=bo(),[i,l]=s.useState(!1),[c,u]=s.useState(dt),[f,g]=s.useState(Yt),[h,p]=s.useState(""),[v,m]=s.useState(es),[b,y]=s.useState([]),k=s.useRef(null),[x,w]=s.useState(""),[S,R]=s.useState([]),[P,A]=s.useState(!1),[I,T]=s.useState(!1),[q,H]=s.useState(""),[j,L]=s.useState(""),[U,Z]=s.useState(null),[ae,N]=s.useState(0),[we,_]=s.useState(null),[M,J]=s.useState(!1),[ie,K]=s.useState(null),[De,Re]=s.useState(null),[me,Se]=s.useState(!1),[he,Pe]=s.useState("code"),[le,Ie]=s.useState(null),rt=e!=null&&le!=null;s.useEffect(()=>{me||Pe("code")},[me]);const[Mt,At]=s.useState(""),[ot,Ge]=s.useState(null),[jt,Nt]=s.useState("public"),[We,vt]=s.useState(null),[sn,_e]=s.useState(!1),[ts,lr]=s.useState(!1),[Dt,_t]=s.useState(0),[cr,ns]=s.useState(0),it=s.useMemo(()=>URL.createObjectURL(new Blob([to(c,{screenshot:!0})],{type:"text/html"})),[c,cr]),Lt=s.useRef(null);s.useEffect(()=>{Lt.current&&Lt.current!==it&&URL.revokeObjectURL(Lt.current),Lt.current=it},[it]);const[z,ur]=s.useState(!1),[ee,Ot]=s.useState(null),ue=$u(e??"",!!e),se=ho(e??"",z?(ee==null?void 0:ee.sha)??null:null);s.useEffect(()=>{!z||!ue.data||(ee&&!ue.data.some(d=>d.sha===ee.sha)?Ot(ue.data[0]??null):!ee&&ue.data.length>0&&Ot(ue.data[0]))},[z,ee,ue.data]);function Ft(){ur(!1),Ot(null),an("preview"),ln("previous")}const[st,an]=s.useState("preview"),[Le,ln]=s.useState("previous"),dr=z&&ee&&ue.data?ue.data.findIndex(d=>d.sha===ee.sha):-1,bt=dr>=0?((Mr=ue.data)==null?void 0:Mr[dr+1])??null:null,$t=ho(e??"",z&&st==="diff"&&Le==="previous"?(bt==null?void 0:bt.sha)??null:null),[fr,hr]=s.useState(!1),cn=s.useRef(null);s.useEffect(()=>()=>{cn.current&&clearTimeout(cn.current)},[]);function rs(){fr||(hr(!0),ue.refetch().finally(()=>{cn.current=setTimeout(()=>hr(!1),2e3)}))}const xt=s.useMemo(()=>se.data===void 0?null:URL.createObjectURL(new Blob([to(se.data)],{type:"text/html"})),[se.data]),Bt=s.useRef(null);s.useEffect(()=>{Bt.current&&Bt.current!==xt&&URL.revokeObjectURL(Bt.current),Bt.current=xt},[xt]);const Ht=s.useRef(null),un=s.useRef([]),pr=s.useRef(0);s.useEffect(()=>{un.current=[],pr.current=Date.now()},[it]);const os=s.useRef(0),yt=s.useRef(new Map),dn=s.useRef(!1),mr=s.useRef(z);s.useEffect(()=>{mr.current=z},[z]),s.useEffect(()=>{dn.current=!1;const d=yt.current;d.forEach(E=>{window.clearTimeout(E.timer),E.reject(new Error("the live preview reloaded — read the page again before acting on it"))}),d.clear()},[it,me,z]),s.useEffect(()=>{function d(E){var D;if(E.source!==((D=Ht.current)==null?void 0:D.contentWindow))return;const C=E.data;if(!C)return;if(C.type==="aero-dom-ready"){dn.current=!0;return}if(C.type==="aero-dom-op-result"&&typeof C.id=="number"){const W=yt.current.get(C.id);if(!W)return;yt.current.delete(C.id),window.clearTimeout(W.timer);const oe=typeof C.generation=="number"?C.generation:null;W.resolve(C.ok?{ok:!0,result:C.result,generation:oe}:{ok:!1,error:C.error||"the action failed",generation:oe});return}if(C.type!=="aero-console"||typeof C.ts=="number"&&C.ts<pr.current)return;const G=C.level==="info"||C.level==="warn"||C.level==="error"?C.level:"log",O=un.current;O.push({level:G,text:typeof C.text=="string"?C.text:"",ts:C.ts??Date.now()}),O.length>300&&O.splice(0,O.length-300)}return window.addEventListener("message",d),()=>window.removeEventListener("message",d)},[]);async function is(d,E,C){var oe;mr.current&&Ft(),Se(!1);const G=Date.now()+1e4;for(;!dn.current||!((oe=Ht.current)!=null&&oe.contentWindow);){if(Date.now()>G)return{ok:!1,error:"the live preview did not finish loading",generation:null};await new Promise(kt=>setTimeout(kt,50))}const O=Ht.current.contentWindow,D=++os.current,W=d==="screenshot"?3e4:15e3;return new Promise(kt=>{const Ss=window.setTimeout(()=>{yt.current.delete(D),kt({ok:!1,error:"the live preview did not respond — read the page again and retry",generation:null})},W);yt.current.set(D,{resolve:kt,reject:ks=>kt({ok:!1,error:ks.message,generation:null}),timer:Ss}),O.postMessage({type:"aero-dom-op",id:D,op:d,args:E,generation:C},"*")})}const ge=s.useRef(c),Oe=d=>{ge.current=d,u(d)},Te=s.useRef(dt),Ut=s.useRef(Yt),fn=s.useRef(null),gr=s.useRef(null),vr=s.useRef(null),qe=s.useRef(null),hn=s.useRef(Ro);s.useEffect(()=>{let d=!0;return Js().then(E=>Zr(E).then(C=>{d&&(hn.current=C)})).catch(()=>{}),ea().then(E=>Zr(E).then(C=>{d&&(hn.current=C)})).catch(()=>{}),()=>{d=!1}},[]);const ve=Jt({queryKey:["ai-models"],queryFn:Ca,staleTime:300*1e3,retry:!1}),br=Jt({queryKey:["zen-models"],queryFn:Ea,staleTime:300*1e3,retry:!1}),Ke=br.data??[],Fe=!ve.isPending&&!br.isPending,ss=!!((Ar=ve.data)!=null&&Ar.project_id),Ye=Ke.find(d=>d.id===h),at=!!h&&ta(h)==="zen",wt=na(h),Xe=at?ra((Ye==null?void 0:Ye.reasoning_efforts)??[]):[...Xu],as=Xe.join(",");s.useEffect(()=>{!Fe||Xe.length===0||Xe.includes(v)||m("off")},[as,v,Fe]),s.useEffect(()=>{var d;!Fe||h||p(oa(((d=ve.data)==null?void 0:d.models)??[],Ke))},[Fe,h]);const ke=!!h&&(!Fe||(((jr=ve.data)==null?void 0:jr.models)??[]).includes(h)||Ke.some(d=>d.id===h));s.useEffect(()=>{let d=!1;return Ie(null),k.current=null,(async()=>{const E=await Hr(t).catch(()=>{});if(!d){if(E){Oe(E.html),Te.current=E.html;const C=ia(E.contents);g(C),Ut.current=C,_t(Ur(C)),E.model&&p(E.model),E.thinking&&m(E.thinking),y(E.disabledTools??[]),k.current=E.zenSessionId??null}if(e)try{const C=await ht.getPage(e);if(d)return;Ge(C.url),Nt(Cs(C.visibility)),Ie(C.html),E||(Oe(C.html),Te.current=C.html)}catch{d||_("Failed to load page.")}d||l(!0)}})(),()=>{d=!0}},[t]);const Qe=s.useRef(Date.now());s.useEffect(()=>{if(!I)return;Qe.current=Date.now(),N(0);const d=setInterval(()=>N(Math.round((Date.now()-Qe.current)/1e3)),1e3);return()=>clearInterval(d)},[I]);const xr=()=>{if(at)return k.current??(k.current=crypto.randomUUID()),k.current},Ze=(d,E=b)=>{const C=ge.current;return xn({key:t,pageId:e,html:C,contents:d,model:h||null,thinking:v,disabledTools:E,zenSessionId:k.current??void 0,updatedAt:0}).then(()=>{Te.current=C,Ut.current=d}).catch(()=>{})},lt=s.useRef({sessionKey:t,pageId:e,contents:f,model:h,thinking:v,disabledTools:b});lt.current={sessionKey:t,pageId:e,contents:f,model:h,thinking:v,disabledTools:b};const yr=s.useRef(I);yr.current=I,s.useEffect(()=>()=>{if(ge.current===Te.current&&lt.current.contents===Ut.current)return;const{sessionKey:d,pageId:E,contents:C,model:G,thinking:O,disabledTools:D}=lt.current;xn({key:d,pageId:E,html:ge.current,contents:C,model:G||null,thinking:O,disabledTools:D,zenSessionId:k.current??void 0,updatedAt:0}).catch(()=>{})},[]);const wr=!at,ls=wr&&(S.length>0||f.some(d=>d.parts.some(E=>E.inlineData))),ct=s.useMemo(()=>Yu(f,S,x),[f,S,x]),Sr=wr&&ct>Et,kr=ct/Et>=Qu,Cr=Dt/wt>=Zu,Er=Math.max(0,100-Math.round(Dt/wt*100)),Rr=wt>=1e6?`${Math.round(wt/1e6)}M`:`${Math.round(wt/1e3)}K`;async function cs(){var W;const d=x.trim();if(!d&&S.length===0||I||!ke)return;if(Sr){_(`This message is too large to send (~${et(ct)} — Gemini's inline-request limit is ~${et(Et)}). Remove an attachment, or run /compact first.`);return}if(d.startsWith("/")){const oe=d.split(/\s+/)[0];if(!da(vo,oe)){_(`Unknown command: ${oe} — available: /compact`);return}}const E=fa(d);if(E){w(""),await ds(E.instructions);return}const C=[ha()];for(const oe of S)C.push(pa(oe.name,oe.mimeType)),C.push(oe.kind==="inline"?{inlineData:{mimeType:oe.mimeType,data:oe.data??""}}:{text:oe.text??""});d&&C.push({text:d});const G=/\b(slides?|decks?|presentations?|powerpoint|pptx?|pitch(?:es)?)\b/i.test(d),O=/\bdeck-container\b|class="slide slide--/.test(ge.current);ge.current===dt?C.push(wn(`The HTML document is still the untouched blank starter template — it contains no user content. Do not call \`read\` on it. If this message is a change request, load the \`${G?"aero-slides":"aero-app-style"}\` skill, then write the first draft directly with \`write\`.`)):O?C.push(wn("The current document is an aero slide deck. Load the `aero-slides` skill (if not already loaded in this conversation) and follow its layout catalogue and navigation engine when editing.")):G&&C.push(wn("This request is about a slide deck / presentation. Load the `aero-slides` skill before making changes, and follow its layout catalogue and navigation engine."));const D=[...f,{role:"user",parts:C}];(W=fn.current)==null||W.followOutput(),g(D),w(""),R([]),Ka(),await Pr(D)}async function Pr(d){const E=new AbortController;qe.current=E,T(!0),H(""),L(""),_(null),J(!1),K(null);const C=Date.now(),G=xr();try{const O=await ya({model:h,contents:d,html:()=>ge.current,skills:hn.current,pageId:e,consoleLogs:()=>un.current,domOp:is,generationConfig:go(v,h),thinking:v,zenModelInfo:Ye,zenSession:G,hasGoogleProject:ss,disabledTools:b,signal:E.signal,callbacks:{onText:D=>{Qe.current=Date.now(),K(null),H(W=>W+D)},onThought:D=>{Qe.current=Date.now(),K(null),L(W=>W+D)},onUsage:D=>{const W=D.totalTokenCount??D.promptTokenCount;typeof W=="number"&&_t(W)},onTool:(D,W)=>{Qe.current=Date.now(),K(null),Z({name:D,detail:W})},onHtml:D=>Oe(D),onContents:D=>{Qe.current=Date.now(),Z(null),g(D),H(""),L("")},onRetry:(D,W,oe)=>{Qe.current=Date.now(),K({attempt:D,max:W,deadline:Date.now()+oe*1e3})}}});g(O),await Ze(O),Date.now()-C>1e4&&eo({ok:!0})}catch(O){if(O instanceof DOMException&&O.name==="AbortError")await Ze(lt.current.contents);else{const D=O instanceof Je?wa(O.body):null,W=O instanceof Je?O.message==="reauth_required"?"Your Google credential has expired or is invalid. Sign out and sign in again to reconnect.":D?D.message:`AI request failed: ${O.message}`:"AI request failed.";D&&Re(D),_(W),J(!(O instanceof Je&&O.message==="reauth_required")),eo({ok:!1,error:W}),await Ze(d)}}finally{qe.current===E&&(qe.current=null),T(!1),H(""),L(""),Z(null),K(null)}}function us(){var d;(d=qe.current)==null||d.abort()}async function zt(){var d;I||!ke||f.length===0||((d=fn.current)==null||d.followOutput(),await Pr(f))}async function ds(d){if(I||!ke)return;if(f.length===0){_("Nothing to compact — the conversation is empty.");return}const E=new AbortController;qe.current=E,T(!0),lr(!0),_(null);try{const C=await Sa({model:h,contents:f,instructions:d||void 0,generationConfig:go("off",h),zenSession:xr(),signal:E.signal});await ut(ka(C))}catch(C){C instanceof DOMException&&C.name==="AbortError"||_(C instanceof Je?`Compaction failed: ${C.message}`:"Compaction failed.")}finally{qe.current===E&&(qe.current=null),T(!1),lr(!1)}}async function ut(d){g(d),_t(Ur(d)),await Ze(d)}async function fs(d){if(I)return;const E=f;if(!(!await o({title:"Delete from history?",body:d.kind==="tool"||d.kind==="grouped-search"?`Removes ${d.refs.length===1?"this tool call and its result":`these ${d.refs.length} tool calls and their results`} from the context sent to the model. The page itself is not affected.`:d.kind==="thought"?"Clears this reasoning from the context sent to the model. The page itself is not affected.":"Removes this record from the context sent to the model. The page itself is not affected.",confirmLabel:"Delete",variant:"danger"})||yr.current||lt.current.contents!==E))switch(d.kind){case"user":case"compact":await ut(ba(f,d.contentIndex));break;case"thought":await ut(va(f,d.refs));break;case"tool":case"grouped-search":await ut(ga(f,d.refs));break;case"assistant":await ut(ma(f,d.refs));break}}async function hs(d,E){I||d.kind!=="user"&&d.kind!=="assistant"||lt.current.contents===f&&await ut(xa(f,d.refs,E))}const St=Qs({mutationFn:async d=>{const E=ge.current;if(e)return await ht.patchPage(e,{html:E}),{id:e,isNew:!1,url:null,html:E,visibility:jt};const C=await ht.createPage(E,{alias:(d==null?void 0:d.alias)||null,visibility:(d==null?void 0:d.visibility)??"public",grants:(d==null?void 0:d.grants)??[]});return{id:C.id,isNew:!0,url:C.url,html:E,visibility:(d==null?void 0:d.visibility)??"public"}},onSuccess:async({id:d,isNew:E,url:C,html:G,visibility:O})=>{if(_(null),_e(!1),Nt(O),Te.current=G,Ie(G),r.invalidateQueries({queryKey:["pages"]}),r.invalidateQueries({queryKey:["page",d]}),r.invalidateQueries({queryKey:["page-history",d]}),E)await xn({key:d,pageId:d,html:ge.current,contents:f,model:h||null,updatedAt:0}).catch(()=>{}),await yn("draft").catch(()=>{}),Ge(C),vt({url:C??`/p/${d}`,id:d,isNew:!0,visibility:O});else{const D=ot??`/p/${d}`;Ge(D),vt({url:D,id:d,isNew:!1,visibility:O})}},onError:d=>{d instanceof Je&&d.body&&typeof d.body=="object"&&"reason"in d.body?_(`Publish failed: ${d.message} (${String(d.body.reason)})`):d instanceof Je?_(`Publish failed: ${d.message}`):_("Publish failed.")}});async function ps(){if(await o({title:"Reset builder",body:e?"Clears the conversation and restores the HTML from the published page.":"Clears the conversation and the draft HTML. This cannot be undone.",confirmLabel:"Reset",variant:"danger"}))if(await yn(t).catch(()=>{}),g(Yt),Ut.current=Yt,_t(0),_(null),k.current=null,e)try{const E=await ht.getPage(e);Oe(E.html),Te.current=E.html}catch{_("Failed to reload page.")}else Oe(dt),Te.current=dt}async function ms(){if(ge.current!==Te.current){if(!await o({title:"Unpublished changes",body:"You have unpublished changes to this page. Publish them first, or discard them and start a new page.",confirmLabel:"Discard & start new",variant:"danger"}))return;Te.current=ge.current}const d=await Hr("draft").catch(()=>{});d&&(d.contents.length>0||d.html!==dt)&&await o({title:"Unfinished draft",body:"You have an unfinished draft. Start fresh and discard it, or resume where you left off?",confirmLabel:"Start fresh",cancelLabel:"Resume draft",variant:"danger"})&&await yn("draft").catch(()=>{}),n("/")}async function gs(d){var G;const E=(G=d.target.files)==null?void 0:G[0];if(d.target.value="",!E)return;const C=await E.text();Oe(C),_(null),Ze(f)}async function pn(d){if(d.length===0)return;if(at){_("Free models cannot read attachments. Switch to a Google model to attach files.");return}const E=[],C=[];for(const G of d){const O=await Ua(G);"error"in O?C.push(O.error):E.push(O)}E.length>0&&R(G=>[...G,...E]),C.length>0&&_(C.join(" "))}function vs(d){const E=Array.from(d.target.files??[]);d.target.value="",pn(E)}const mn=s.useMemo(()=>sa(f),[f]),gn=((Nr=ve.data)==null?void 0:Nr.models.length)??0,bs=ve.isError||!!ve.data&&gn===0,$e=Fe&&gn===0&&Ke.length===0,Ir=bs&&Ke.length>0,vn=ve.error instanceof Je?ve.error.message:void 0,Me=f[f.length-1],xs=(Me==null?void 0:Me.role)==="model"&&!Me.parts.some(d=>d.functionCall),ys=(Me==null?void 0:Me.role)==="user"&&Me.parts.some(aa),Tr=!I&&!!Me&&!xs&&!ys,ws=((Dr=mn[mn.length-1])==null?void 0:Dr.kind)==="user";return i?a.jsxs("div",{className:"flex h-[calc(100vh-8.5rem)] min-h-[480px] flex-col gap-3",children:[a.jsxs("div",{className:"flex flex-wrap items-center gap-2",children:[a.jsxs(Gr,{value:ke?h:"",onValueChange:p,disabled:I||!Fe,children:[a.jsx(Wr,{className:"h-8 w-auto min-w-[9rem] text-[13px]",children:a.jsx(qr,{placeholder:Fe?"select a model":"loading models…"})}),a.jsxs(Kr,{children:[gn>0?a.jsxs(Yr,{children:[a.jsx(Xr,{children:"Google"}),(_r=ve.data)==null?void 0:_r.models.map(d=>a.jsx(Sn,{value:d,children:d},d))]}):null,Ke.length>0?a.jsxs(Yr,{children:[a.jsx(Xr,{children:"Free · opencode zen"}),Ke.map(d=>a.jsx(Sn,{value:d.id,children:d.name},d.id))]}):null]})]}),a.jsxs(Gr,{value:Xe.includes(v)?v:"off",onValueChange:m,disabled:I||Xe.length===0,children:[a.jsxs(Wr,{className:"h-8 w-auto text-[13px]",title:Xe.length>0?"Thinking level — how much the model reasons before answering":Ye!=null&&Ye.reasoning?"This model reasons but offers no thinking-level control":"This model does not support thinking",children:[a.jsx(So,{className:"h-3.5 w-3.5 shrink-0 text-fg-3"}),a.jsx(qr,{})]}),a.jsx(Kr,{children:Xe.map(d=>a.jsx(Sn,{value:d,children:d},d))})]}),a.jsxs("button",{type:"button",onClick:()=>Se(d=>!d),disabled:z,className:Q("inline-flex h-8 items-center gap-1.5 rounded-md border border-border px-2.5 text-[12px] disabled:opacity-50",me?"bg-ink text-white":"bg-surface text-fg-2 hover:text-fg"),children:[a.jsx(ko,{className:"h-3.5 w-3.5"})," Code"]}),a.jsxs("button",{type:"button",onClick:()=>ns(d=>d+1),disabled:me||z,title:"Reload the preview (recovers a broken or navigated-away preview)",className:"inline-flex h-8 items-center gap-1.5 rounded-md border border-border bg-surface px-2.5 text-[12px] text-fg-2 hover:text-fg disabled:opacity-50",children:[a.jsx(Fr,{className:"h-3.5 w-3.5"})," Reload"]}),a.jsxs("button",{type:"button",onClick:()=>{var d;return(d=gr.current)==null?void 0:d.click()},disabled:I||z,title:"Load an .html file into the builder (replaces the current document)",className:"inline-flex h-8 items-center gap-1.5 rounded-md border border-border bg-surface px-2.5 text-[12px] text-fg-2 hover:text-fg disabled:opacity-50",children:[a.jsx(Fs,{className:"h-3.5 w-3.5"})," Upload"]}),a.jsx("input",{ref:gr,type:"file",accept:".html,.htm,text/html",hidden:!0,onChange:gs}),a.jsxs("button",{type:"button",onClick:ps,disabled:I||z,className:"inline-flex h-8 items-center gap-1.5 rounded-md border border-border bg-surface px-2.5 text-[12px] text-fg-2 hover:text-fg disabled:opacity-50",children:[a.jsx($s,{className:"h-3.5 w-3.5"})," Reset"]}),e?a.jsxs("button",{type:"button",onClick:ms,disabled:I||z,title:"Start a new page in the draft builder",className:"inline-flex h-8 items-center gap-1.5 rounded-md border border-border bg-surface px-2.5 text-[12px] text-fg-2 hover:text-fg disabled:opacity-50",children:[a.jsx(Bs,{className:"h-3.5 w-3.5"})," New"]}):null,e?a.jsxs("button",{type:"button",onClick:()=>z?Ft():ur(!0),title:"Browse previously published versions of this page",className:Q("inline-flex h-8 items-center gap-1.5 rounded-md border border-border px-2.5 text-[12px]",z?"bg-ink text-white":"bg-surface text-fg-2 hover:text-fg"),children:[a.jsx(wo,{className:"h-3.5 w-3.5"})," History"]}):null,a.jsxs("div",{className:"ml-auto flex items-center gap-2",children:[ot?a.jsxs("a",{href:ot,target:"_blank",rel:"noreferrer",className:"inline-flex items-center gap-1 text-[12px] text-fg-2 hover:text-fg",children:["View live ",a.jsx(Hs,{className:"h-3 w-3"})]}):null,a.jsxs(Be,{size:"sm",onClick:()=>e?St.mutate(void 0):_e(!0),disabled:I||St.isPending||z,children:[St.isPending?a.jsx(Us,{className:"h-3.5 w-3.5 animate-spin"}):a.jsx(yo,{className:"h-3.5 w-3.5"}),e?"Publish update":"Publish"]})]})]}),we&&!z?a.jsxs("div",{className:"flex items-center gap-2 rounded-md border border-no/30 bg-no-soft px-3 py-2 text-[12px] text-no-strong",children:[a.jsx("span",{className:"min-w-0 flex-1 break-words",children:we}),M&&!I?a.jsxs("button",{type:"button",onClick:()=>void zt(),className:"inline-flex shrink-0 items-center gap-1 rounded border border-no/30 bg-surface px-2 py-0.5 text-[11px] font-medium text-no-strong hover:bg-no-soft",children:[a.jsx(Fr,{className:"h-3 w-3"})," Retry"]}):null]}):null,($e||Ir)&&!z?a.jsxs("div",{className:"space-y-2",children:[a.jsxs("div",{className:"rounded-md border border-border bg-surface-muted px-3 py-2 text-[12px] text-fg-2",children:[$e?"AI is unavailable — ":"Google models are unavailable — ",vn==="no_project"?a.jsxs(a.Fragment,{children:["no Code Assist project selected for your account."," ",a.jsx(La,{to:"/settings",className:"underline hover:text-fg",children:"Choose one in Settings"}),"."]}):vn==="reauth_required"?"your Google credential has expired or is invalid. Sign out and sign in again to reconnect.":"could not load models. Try again later.",Ir?" Free models are listed in the model picker and need no Google account.":null]}),vn==="no_project"?a.jsx(Ra,{}):null]}):null,Tr&&!we&&!ws&&!z?a.jsxs("div",{className:"flex items-center gap-2 rounded-md border border-border bg-surface-muted px-3 py-2 text-[12px] text-fg-2",children:[a.jsx("span",{className:"min-w-0 flex-1",children:"Aero stopped before finishing — resume to keep going."}),a.jsxs("button",{type:"button",onClick:()=>void zt(),disabled:$e||!ke,className:"inline-flex shrink-0 items-center gap-1 rounded border border-border bg-surface px-2 py-0.5 text-[11px] font-medium text-fg-2 hover:bg-surface-muted disabled:opacity-50",children:[a.jsx(zs,{className:"h-3 w-3"})," Resume"]})]}):null,a.jsxs("div",{className:"flex min-h-0 flex-1 gap-4",children:[a.jsx("div",{className:Q("flex w-[380px] shrink-0 flex-col rounded-lg border border-border bg-surface",P&&"ring-2 ring-ink"),onDragOver:d=>{z||(d.preventDefault(),A(!0))},onDragLeave:()=>A(!1),onDrop:d=>{z||(d.preventDefault(),A(!1),pn(Array.from(d.dataTransfer.files)))},children:z?a.jsx(Bu,{entries:ue.data,isLoading:ue.isLoading,isError:ue.isError,isFetching:ue.isFetching||fr,selectedSha:(ee==null?void 0:ee.sha)??null,onSelect:Ot,onRefresh:rs}):a.jsx(la,{ref:fn,chat:mn,busy:I,streamText:q,streamThought:j,busyLabel:ts?"compacting conversation…":Ju(U,ae,ie),toolActive:U!==null,retrying:ie!==null,busyElapsed:ae,emptyState:a.jsxs(a.Fragment,{children:["Describe the page you want to build.",a.jsx("br",{}),"Aero edits the HTML and you preview it live.",a.jsx("br",{}),"Or upload an existing .html file to start from."]}),renderToolItem:ed,canResume:Tr,resumeDisabled:$e||!ke,onResume:()=>void zt(),onSaveItemEdit:(d,E)=>void hs(d,E),onDeleteItem:d=>void fs(d),input:x,onInputChange:w,onSend:()=>void cs(),onStop:us,composerDisabled:I||$e||!ke,sendDisabled:$e||!ke||!x.trim()&&S.length===0||Sr,placeholder:$e?"AI unavailable":!ke&&ve.data?"Pick a model to continue — the last one is no longer available":"Ask Aero to build or change something…",slashCommands:vo,composerMeta:a.jsxs("div",{className:"flex min-w-0 items-center gap-2 text-[11px] text-fg-3",children:[ls?a.jsx("span",{className:Q("tabular truncate",kr&&"font-medium text-no-strong"),title:`Estimated request size with attached files: ${et(ct)} of ${et(Et)} — Gemini rejects requests over ~20MB`,children:kr?`${et(ct)} / ${et(Et)}`:et(ct)}):null,a.jsx("span",{className:Q("tabular truncate",Cr&&"font-medium text-no-strong"),title:`Approximate context window usage: ${po(Dt)} of ${Rr} tokens (${Er}% left) — ${at?"free models are held to a 200K-token context":"all Gemini models have a ~1M-token context"}`,children:Cr?`${po(Dt)} / ${Rr}`:`${Er}% left`})]}),attachmentsBar:S.length>0?a.jsx("div",{className:"flex flex-wrap gap-1.5 px-3 pt-2.5",children:S.map(d=>a.jsxs("div",{className:"flex items-center gap-1.5 overflow-hidden rounded-md border border-border bg-surface-muted pr-1.5 text-[11px]",children:[d.kind==="inline"&&d.mimeType.startsWith("image/")?a.jsx("img",{src:`data:${d.mimeType};base64,${d.data}`,alt:d.name,className:"h-7 w-7 shrink-0 object-cover"}):a.jsx("span",{className:"flex h-7 w-7 shrink-0 items-center justify-center text-fg-3",children:ua(d.mimeType)}),a.jsx("span",{className:"max-w-[8rem] truncate text-fg-2",title:d.name,children:d.name}),a.jsx("button",{type:"button",onClick:()=>R(E=>E.filter(C=>C.id!==d.id)),title:"Remove",className:"text-fg-3 hover:text-fg",children:a.jsx(Gs,{className:"h-3 w-3"})})]},d.id))}):void 0,composerLeading:a.jsxs("div",{className:"flex shrink-0 items-center gap-0.5",children:[a.jsxs(Du,{children:[a.jsx(_u,{asChild:!0,children:a.jsxs(Be,{variant:"ghost",size:"sm","aria-label":"Which tools the agent may use",title:"Which tools the agent may use",className:Q(zr,"relative"),children:[a.jsx(Co,{className:"h-3.5 w-3.5"}),b.length>0?a.jsx("span",{className:"absolute right-1 top-1 h-1.5 w-1.5 rounded-full bg-status"}):null]})}),a.jsx(Zi,{className:"w-60",children:ca.map(d=>a.jsx(Ji,{checked:!d.names.some(E=>b.includes(E)),onCheckedChange:E=>{const C=E?b.filter(G=>!d.names.includes(G)):[...new Set([...b,...d.names])];y(C),Ze(f,C)},children:a.jsxs("span",{className:"flex flex-col",children:[a.jsx("span",{children:d.label}),a.jsx("span",{className:"text-[11px] text-fg-3",children:d.hint})]})},d.id))})]}),at?null:a.jsxs(a.Fragment,{children:[a.jsx(Be,{variant:"ghost",size:"sm",onClick:()=>{var d;return(d=vr.current)==null?void 0:d.click()},disabled:I||$e||!ke,title:"Attach a file (image, PDF, audio, video, or text)",className:zr,children:a.jsx(Vs,{className:"h-3.5 w-3.5"})}),a.jsx("input",{ref:vr,type:"file",multiple:!0,hidden:!0,onChange:vs})]})]}),onPasteFiles:d=>void pn(d)})}),a.jsx("div",{className:"flex min-w-0 flex-1 flex-col overflow-hidden rounded-lg border border-border bg-surface",children:z?a.jsxs(a.Fragment,{children:[a.jsx(Hu,{entry:ee,canRestore:!!ee&&se.data!==void 0,onRestore:()=>{se.data!==void 0&&(Oe(se.data),Ze(f)),Ft()},onExit:Ft}),ee?a.jsxs("div",{className:"flex items-center gap-2 border-b border-border px-3 py-1.5",children:[a.jsxs("div",{className:"flex items-center gap-1 rounded-md border border-border bg-surface p-0.5 text-[11px]",children:[a.jsx("button",{type:"button",onClick:()=>an("preview"),className:Q("rounded-sm px-2 py-1",st==="preview"?"bg-ink text-white":"text-fg-2 hover:text-fg"),children:"Preview"}),a.jsx("button",{type:"button",onClick:()=>an("diff"),className:Q("rounded-sm px-2 py-1",st==="diff"?"bg-ink text-white":"text-fg-2 hover:text-fg"),children:"Diff"})]}),st==="diff"?a.jsxs("div",{className:"flex items-center gap-1 rounded-md border border-border bg-surface p-0.5 text-[11px]",children:[a.jsx("button",{type:"button",onClick:()=>ln("previous"),className:Q("rounded-sm px-2 py-1",Le==="previous"?"bg-surface-muted text-fg":"text-fg-3 hover:text-fg-2"),children:"vs Previous version"}),a.jsx("button",{type:"button",onClick:()=>ln("draft"),className:Q("rounded-sm px-2 py-1",Le==="draft"?"bg-surface-muted text-fg":"text-fg-3 hover:text-fg-2"),children:"vs Current draft"})]}):null]}):null,st==="diff"&&ee?Le==="previous"&&!bt?a.jsx("div",{className:"p-4 text-[12px] text-fg-3",children:"This is the first published version — nothing to compare it against."}):Le==="previous"&&$t.isLoading||se.isLoading?a.jsx("div",{className:"p-4 text-[12px] text-fg-3",children:"Loading diff…"}):Le==="previous"&&$t.isError||se.isError?a.jsx("div",{className:"p-4 text-[12px] text-no-strong",children:"Failed to load diff."}):Le==="previous"&&$t.data!==void 0&&se.data!==void 0?a.jsx(Mn,{oldText:$t.data,newText:se.data,oldLabel:`Version from ${new Date(bt.committed_at).toLocaleString()}`,newLabel:`Version from ${new Date(ee.committed_at).toLocaleString()}`}):Le==="draft"&&se.data!==void 0?a.jsx(Mn,{oldText:c,newText:se.data,oldLabel:"Current draft",newLabel:`Version from ${new Date(ee.committed_at).toLocaleString()}`}):null:st==="preview"?se.isLoading?a.jsx("div",{className:"p-4 text-[12px] text-fg-3",children:"Loading version…"}):se.isError?a.jsx("div",{className:"p-4 text-[12px] text-no-strong",children:"Failed to load this version."}):xt?a.jsx("iframe",{title:"historic version preview",src:xt,sandbox:"allow-scripts allow-modals allow-forms allow-popups",className:"h-full w-full flex-1 bg-white"}):a.jsx("div",{className:"p-4 text-[12px] text-fg-3",children:"Select a version from the list to preview it."}):null]}):me?a.jsxs(a.Fragment,{children:[a.jsx("div",{className:"flex items-center gap-2 border-b border-border px-3 py-1.5",children:a.jsxs("div",{className:"flex items-center gap-1 rounded-md border border-border bg-surface p-0.5 text-[11px]",children:[a.jsx("button",{type:"button",onClick:()=>Pe("code"),className:Q("rounded-sm px-2 py-1",he==="code"?"bg-ink text-white":"text-fg-2 hover:text-fg"),children:"Code"}),a.jsx("button",{type:"button",onClick:()=>Pe("diff"),disabled:!rt,title:rt?void 0:"Diff becomes available once this page has been published",className:Q("rounded-sm px-2 py-1 disabled:opacity-50",he==="diff"?"bg-ink text-white":"text-fg-2 hover:text-fg"),children:"Diff"})]})}),he==="diff"&&rt?a.jsx(Mn,{oldText:le,newText:c,oldLabel:"Last published version",newLabel:"Current draft"}):a.jsx(s.Suspense,{fallback:a.jsx("div",{className:"p-3 text-[12px] text-fg-3",children:"Loading editor…"}),children:a.jsx(Ku,{value:c,onChange:Oe,language:"html",className:"flex-1 overflow-auto"})})]}):a.jsx("iframe",{ref:Ht,title:"preview",src:it,sandbox:"allow-scripts allow-modals allow-forms allow-popups",className:"h-full w-full flex-1 bg-white"},cr)})]}),sn?a.jsx(Fu,{initialAlias:Mt,busy:St.isPending,onCancel:()=>_e(!1),onPublish:d=>{At(d.alias),St.mutate(d)}}):null,We?a.jsx(Ou,{url:We.url,isNew:We.isNew,visibility:We.visibility,onClose:()=>{const d=We;vt(null),d.isNew&&n(`/builder/${d.id}`,{replace:!0,state:{publishContinuation:!0}})}}):null,De?a.jsx(Pa,{info:De,onEnabled:()=>{Re(null),_(null),zt()},onClose:()=>Re(null)}):null]}):a.jsx("div",{className:"text-fg-3",children:"Loading…"})}export{vd as BuilderPage};
