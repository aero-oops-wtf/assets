const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./CodeEditor-BMwkgQq4.js","./vendor-react-CjNwZt0H.js","./index-CQ6SFRql.js","./vendor-query-Cw1ReDmF.js","./vendor-router-DD5LKX3A.js","./index-BFH2yGzB.css"])))=>i.map(i=>d[i]);
import{_ as Gn,B as te,e as E,u as Vn,a as xe,d as Pr,A as ve}from"./index-CQ6SFRql.js";import{r as l,j as e,k as Wn,G as Yn,H as Xn,A as Ir,n as Kn,M as Fr,o as Br,R as wn,p as _r,l as Hr,q as Or,E as $r,e as xn,s as Ur,X as jt,t as yn,W as Qn,u as qr,v as zr,w as Jn,x as Gr,B as Vr,y as kn,z as Wr,D as Yr}from"./vendor-react-CjNwZt0H.js";import{a as Zn,c as Xr,u as Kr}from"./vendor-query-Cw1ReDmF.js";import{g as Qr,u as Jr,D as Zr,p as Sn,z as ea,c as ta,l as Cn,r as na,e as jn,a as ra,s as Ke,b as Tt,d as Et,t as aa,i as oa,f as Tn,M as sa,C as ia,h as En,O as la,j as Nn,k as Nt,m as ca,n as An,o as da,q as ua,Z as ha,v as fa,w as pa,x as ma,y as ga,A as At,B as ba,E as va,F as wa,G as xa,H as ya,I as ka,J as Ln,K as Sa,L as Ca,N as Rn,P as ja,Q as Ta,R as Ea}from"./ChatPanel-CqtFWoEz.js";import{i as Mn,u as Na,a as Aa,l as La,s as Ra,D as Ma,b as Da,c as Pa,d as Ia,e as Fa,f as Ba,g as _a,h as Ha,j as Lt,k as Dn}from"./DropdownMenu-vQfGWWZk.js";import{f as de,s as Oa,G as $a}from"./attachments-Cy_niY_k.js";import{C as Ua}from"./CloudShellHint-CFNsjI7Z.js";import{P as qa,a as za}from"./PublicUrlRow-DtrZrUwx.js";import{L as Pn,I as Ga}from"./Select-BBkuCnPA.js";import{S as Va}from"./ServiceDisabledModal-DcynaqsG.js";import{e as Wa,u as Ya,c as Xa,L as Ka}from"./vendor-router-DD5LKX3A.js";const Qa=/\.(pptx|ppsx|pptm|potx)$/i,Ja=/^application\/vnd\.openxmlformats-officedocument\.presentationml\./,Za=/\.(ppt|pps|pot)$/i,eo="application/vnd.ms-powerpoint";function er(n){return Qa.test(n.name)||Ja.test(n.type)}function to(n){return Za.test(n.name)||n.type===eo&&!er(n)}async function no(n){const{parse:r}=await Gn(async()=>{const{parse:s}=await import("./index-BOZyaZjj.js");return{parse:s}},[],import.meta.url);let o;try{o=await r(await n.arrayBuffer(),{imageMode:"none",videoMode:"none",audioMode:"none"})}catch(s){throw new Error(`"${n.name}" couldn't be read as a PowerPoint file.`,{cause:s})}if(o.slides.length===0)throw new Error(`"${n.name}" has no slides.`);let a;try{a=ro(o,n.name)}catch(s){throw new Error(`"${n.name}" couldn't be converted to text.`,{cause:s})}return new File([a],`${n.name}.md`,{type:"text/markdown"})}function ro(n,r){const{width:o,height:a}=n.size,s=n.slides.length,h=[`# ${r}`,"",`${s} slide${s===1?"":"s"}, ${Math.round(o)}×${Math.round(a)} pt. Text extracted from PowerPoint in reading order; images are noted by name and size only.`],f={images:new Set,titled:!1};return n.slides.forEach((d,m)=>{h.push("",`## Slide ${m+1}`,""),f.titled=!1;const c=Pt(d.elements,f);h.push(c.length>0?c.map(T=>T.join(`
`)).join(`
