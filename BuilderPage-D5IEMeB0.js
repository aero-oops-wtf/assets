const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./CodeEditor-CXT6wtnR.js","./vendor-react-WQxmj3K2.js","./index-C81W2jXo.js","./vendor-query-B3dj3kF_.js","./vendor-router-C5eOWq4b.js","./index-BxNYGaB2.css"])))=>i.map(i=>d[i]);
import{_ as Vn,B as te,e as E,u as Gn,a as xe,d as Pr,A as ve}from"./index-C81W2jXo.js";import{r as l,j as e,l as Wn,G as Yn,H as Xn,A as Ir,o as Kn,M as Fr,p as Br,R as wn,q as _r,m as Hr,s as Or,E as $r,e as xn,t as Ur,X as jt,u as yn,W as Qn,v as qr,h as zr,w as Jn,x as Vr,B as Gr,y as kn,z as Wr,D as Yr}from"./vendor-react-WQxmj3K2.js";import{a as Zn,c as Xr,u as Kr}from"./vendor-query-B3dj3kF_.js";import{g as Qr,u as Jr,D as Zr,p as Sn,z as ea,c as ta,l as Cn,r as na,e as jn,a as ra,s as Ke,b as Tt,d as Et,t as aa,i as oa,f as Tn,M as sa,C as ia,h as la,j as ca,k as En,m as da,O as ua,n as ha,o as Nn,q as Nt,v as fa,w as pa,x as ma,y as ga,A as At,B as An,E as ba,F as Ln,G as va,H as wa,Z as xa,I as ya,J as ka,K as Sa,L as Ca,N as Lt,P as ja,Q as Ta,R as Ea,S as Na,T as Aa,U as La,V as Rn,W as Ra,X as Ma,Y as Mn,_ as Da,$ as Pa,a0 as Ia}from"./DropdownMenu-BUPbwGdS.js";import{i as Dn,u as Fa,a as Ba,l as _a,s as Ha}from"./skillStore-BXffjFtw.js";import{f as de,s as Oa,G as $a}from"./attachments-Cy_niY_k.js";import{C as Ua}from"./CloudShellHint-aCOOlJF6.js";import{P as qa,a as za}from"./PublicUrlRow-AMOVZ0Ek.js";import{L as Pn,I as Va}from"./Select-BLAN05Co.js";import{S as Ga}from"./ServiceDisabledModal-BVbgZA1W.js";import{e as Wa,u as Ya,c as Xa,L as Ka}from"./vendor-router-C5eOWq4b.js";const Qa=/\.(pptx|ppsx|pptm|potx)$/i,Ja=/^application\/vnd\.openxmlformats-officedocument\.presentationml\./,Za=/\.(ppt|pps|pot)$/i,eo="application/vnd.ms-powerpoint";function er(n){return Qa.test(n.name)||Ja.test(n.type)}function to(n){return Za.test(n.name)||n.type===eo&&!er(n)}async function no(n){const{parse:r}=await Vn(async()=>{const{parse:s}=await import("./index-BOZyaZjj.js");return{parse:s}},[],import.meta.url);let o;try{o=await r(await n.arrayBuffer(),{imageMode:"none",videoMode:"none",audioMode:"none"})}catch(s){throw new Error(`"${n.name}" couldn't be read as a PowerPoint file.`,{cause:s})}if(o.slides.length===0)throw new Error(`"${n.name}" has no slides.`);let a;try{a=ro(o,n.name)}catch(s){throw new Error(`"${n.name}" couldn't be converted to text.`,{cause:s})}return new File([a],`${n.name}.md`,{type:"text/markdown"})}function ro(n,r){const{width:o,height:a}=n.size,s=n.slides.length,h=[`# ${r}`,"",`${s} slide${s===1?"":"s"}, ${Math.round(o)}×${Math.round(a)} pt. Text extracted from PowerPoint in reading order; images are noted by name and size only.`],f={images:new Set,titled:!1};return n.slides.forEach((d,m)=>{h.push("",`## Slide ${m+1}`,""),f.titled=!1;const c=Pt(d.elements,f);h.push(c.length>0?c.map(T=>T.join(`
`)).join(`
